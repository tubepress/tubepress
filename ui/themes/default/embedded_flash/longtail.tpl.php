 ...
 */
?>
<object type="application/x-shockwave-flash" data="<?php echo ${org_tubepress_api_const_template_Variable::TUBEPRESS_BASE_URL}; ?>/ui/lib/embedded_flash/longtail/lib/player.swf" style="width: <?php echo ${org_tubepress_api_const_template_Variable::EMBEDDED_WIDTH}; ?>px; height: <?php echo ${org_tubepress_api_const_template_Variable::EMBEDDED_HEIGHT}; ?>px" >
  
        <param name="AllowScriptAccess" value="never" />
        <param name="wmode" value="opaque" />
        <param name="movie" value="<?php echo ${org_tubepress_api_const_template_Variable::TUBEPRESS_BASE_URL}; ?>/ui/lib/embedded_flash/longtail/lib/player.swf" />
