...
<div class="tubepress_container" id="tubepress_gallery_<?php echo ${org_tubepress_template_Template::GALLERY_ID}; ?>">
  ...
  <div class="tubepress_embedded_wrapper" style="width: <?php echo ${org_tubepress_template_Template::EMBEDDED_WIDTH}; ?>px">
  
    <div id="tubepress_embedded_title_<?php echo ${org_tubepress_template_Template::GALLERY_ID}; ?>" class="tubepress_embedded_title">
      <?php echo ${org_tubepress_template_Template::VIDEO_ARRAY}[0]->getTitle(); ?>
    
    </div>
    <div id="tubepress_embedded_object_<?php echo ${org_tubepress_template_Template::GALLERY_ID}; ?>">
