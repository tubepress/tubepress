    ...
    <div class="tubepress_thumbs">
      ...
      <div class="tubepress_thumb">
        ...
        <dl class="tubepress_meta_group">
          ...
          <dt class="tubepress_meta tubepress_meta_keywords"><?php echo ${org_tubepress_template_Template::META_LABELS}[org_tubepress_options_category_Meta::TAGS]; ?></dt><dd class="tubepress_meta tubepress_meta_keywords"><?php echo htmlspecialchars(implode(" ", $video->getKeywords()), ENT_QUOTES, "UTF-8"); ?></a></dd>
          <?php endif; ?>
