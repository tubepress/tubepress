...
<div class="tubepress_single_video">
    ...
    <dl class="tubepress_meta_group" style="width: <?php echo ${org_tubepress_template_Template::EMBEDDED_WIDTH}; ?>px">
    ...
    <dt class="tubepress_meta tubepress_meta_keywords"><?php echo ${org_tubepress_template_Template::META_LABELS}[org_tubepress_options_category_Meta::TAGS]; ?></dt><dd class="tubepress_meta tubepress_meta_keywords"><?php echo $raw = htmlspecialchars(implode(" ", $video->getKeywords()), ENT_QUOTES, "UTF-8"); ?></a></dd>
    <?php endif; ?>
