 ...
 */
?>
<object type="application/x-shockwave-flash" data="<?php echo ${org_tubepress_template_Template::TUBEPRESS_BASE_URL}; ?>/ui/embedded/longtail/lib/player.swf" style="width: <?php echo ${org_tubepress_template_Template::EMBEDDED_WIDTH}; ?>px; height: <?php echo ${org_tubepress_template_Template::EMBEDDED_HEIGHT}; ?>px" >
