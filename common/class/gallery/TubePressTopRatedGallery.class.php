...
/**
 * A gallery with the top-rated videos from YouTube
 *
 */
class TubePressTopRatedGallery extends TubePressGallery implements TubePressHasValue
{
    ...
    public function __construct()
    {
        ...
        $this->_timeFrame = new TubePressTimeValue(TubePressGalleryValue::top_rated);
    }
    ...
    /**
     * Get the time frame for the gallery
     *
     * @return TubePressTimeValue The time frame for the gallery
     */
