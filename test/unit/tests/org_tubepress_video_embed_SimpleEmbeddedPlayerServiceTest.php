...
class org_tubepress_video_embed_SimpleEmbeddedPlayerServiceTest extends PHPUnit_Framework_TestCase {
	...
	function testToString()
	{
		...
		$this->_tpom->expects($this->exactly(11))
			 ->method("get")
			 ->will($this->returnCallback('callback'));
			 
		$this->_sut->applyOptions($vid, $this->_tpom);
		
		$link = "http://www.youtube.com/v/FAKEID&amp;color1=0x777777&amp;color2=0x111111&amp;rel=1&amp;autoplay=0&amp;loop=1&amp;egm=0&amp;border=1&amp;fs=1";
...
function callback() {
   	...
   	$vals = array(
		...
		org_tubepress_options_category_Embedded::PLAYER_COLOR => "111111",
		...
		org_tubepress_options_category_Embedded::PLAYER_HIGHLIGHT => "777777"
