...
require_once dirname(__FILE__) . '/../../../../../../classes/org/tubepress/impl/feed/VimeoUrlBuilder.class.php';

class org_tubepress_impl_feed_VimeoUrlBuilderTest extends TubePressUnitTest {
	...
	{
		$this->initFakeIoc();
		$this->_sut = new org_tubepress_impl_feed_VimeoUrlBuilder();
	}
	...
	{
		$pattern = org_tubepress_impl_feed_VimeoUrlBuilderTest::PRE . $url . org_tubepress_impl_feed_VimeoUrlBuilderTest::POST;
