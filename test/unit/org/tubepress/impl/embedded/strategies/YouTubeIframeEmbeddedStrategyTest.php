...
class org_tubepress_impl_embedded_YouTubeIframeEmbeddedStrategyTest extends org_tubepress_impl_embedded_AbstractEmbeddedStrategyTest {
    ...
    {
        return <<<EOT
<iframe class="youtube-player" type="text/html" width="425" height="350" src="http://www.youtube.com/embed/videoid?rel=1&amp;autoplay=0&amp;loop=0&amp;fs=1&amp;showinfo=0" frameborder="0"></iframe>
