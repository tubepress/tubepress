...
class org_tubepress_impl_http_clientimpl_strategies_FsockOpenStrategyTest extends TubePressUnitTest {
    ...
    {
        $this->initFakeIoc();
        $this->_sut = new org_tubepress_impl_http_clientimpl_strategies_FsockOpenStrategy();
        $this->_args = array(
            'method'       => 'GET',
            'timeout'      => 5,
            'httpversion' => '1.0',
