...
class org_tubepress_impl_options_OptionsReferenceTest extends TubePressUnitTest {
	...
	self::assertArrayEquality($expected, org_tubepress_impl_options_OptionsReference::getAllOptionNames());
    }
    ...
    function testGetDisplayOptionNames()
    {
         ...
         self::assertArrayEquality($expectedNames, org_tubepress_impl_options_OptionsReference::getOptionNamesForCategory(org_tubepress_api_const_options_CategoryName::DISPLAY));
    }
    ...
    function testGetFeedOptionNames()
    {
         ...
         self::assertArrayEquality($expectedNames, org_tubepress_impl_options_OptionsReference::getOptionNamesForCategory(org_tubepress_api_const_options_CategoryName::FEED));
    }
    ...
    function testGetOutputOptionNames()
    {
        ...
        self::assertArrayEquality($expectedNames, org_tubepress_impl_options_OptionsReference::getOptionNamesForCategory(org_tubepress_api_const_options_CategoryName::OUTPUT));
    }
    ...
    function testGetMetaOptionNames()
    {
        ...
        self::assertArrayEquality($expectedNames, org_tubepress_impl_options_OptionsReference::getOptionNamesForCategory(org_tubepress_api_const_options_CategoryName::META));
    }
    ...
    function testGetWidgetOptionNames()
    {
        ...
        self::assertArrayEquality($expectedNames, org_tubepress_impl_options_OptionsReference::getOptionNamesForCategory(org_tubepress_api_const_options_CategoryName::WIDGET));
    }
    ...
    function testGetOptionCategoryNames()
    {
        ...
        self::assertArrayEquality($expected, org_tubepress_impl_options_OptionsReference::getOptionCategoryNames());
    }
    ...
    function testMostViewedEnumValues()
    {
        ...
        self::assertArrayEquality($expected, org_tubepress_impl_options_OptionsReference::getValidEnumValues(org_tubepress_api_const_options_Type::TIME_FRAME));
    }
    function testOrderEnumValues()
    {
        ...
        self::assertArrayEquality($expected, org_tubepress_impl_options_OptionsReference::getValidEnumValues(org_tubepress_api_const_options_Type::ORDER));
    }
    ...
    function testGalleryEnumValues()
    {
        ...
        self::assertArrayEquality($expected, org_tubepress_impl_options_OptionsReference::getValidEnumValues(org_tubepress_api_const_options_Type::MODE));
    }
}
