...
require_once BASE . '/sys/classes/org/tubepress/impl/options/ui/widgets/MetaMultiSelectInput.class.php';

class org_tubepress_impl_options_ui_widgets_MetaMultiSelectInputTest extends org_tubepress_impl_options_ui_widgets_AbstractWidgetTest {
    ...
    public function setUp()
    {
        ...
        $this->_sut = new org_tubepress_impl_options_ui_widgets_MetaMultiSelectInput($this->_ods, 'crazy');
    }
    ...
    public function testGetHtml()
    {
        ...
        $template->shouldReceive('setVariable')->once()->with(org_tubepress_impl_options_ui_widgets_AbstractMultiSelectInput::TEMPLATE_VAR_NAME, 'metadropdown');
        $template->shouldReceive('setVariable')->once()->with(org_tubepress_impl_options_ui_widgets_AbstractMultiSelectInput::TEMPLATE_VAR_DESCRIPTORS, $this->_ods);
        $template->shouldReceive('setVariable')->once()->with(org_tubepress_impl_options_ui_widgets_AbstractMultiSelectInput::TEMPLATE_VAR_CURRENTVALUES, $this->_getOdNames());
    ...
    protected function _getOdNames()
    {
        return array(
            ...
            org_tubepress_api_const_options_names_Meta::TAGS,
