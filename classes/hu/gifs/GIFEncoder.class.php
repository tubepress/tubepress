...
Class hu_gifs_GIFEncoder {
	...
	*/
	function GIFEncoder	(
		...
		hu_gifs_GIFEncoder::GIFAddHeader ( );
		for ( $i = 0; $i < count ( $this->BUF ); $i++ ) {
			hu_gifs_GIFEncoder::GIFAddFrames ( $i, $GIF_dly [ $i ] );
		}
		hu_gifs_GIFEncoder::GIFAddFooter ( );
	}
	/*
	:::::::::::::::::::::::::::::::::::::::::::::::::::
	::
	...
	*/
	function GIFAddHeader ( ) {
		...
		if ( ord ( $this->BUF [ 0 ] { 10 } ) & 0x80 ) {
			...
			$this->GIF .= "!\377\13NETSCAPE2.0\3\1" . hu_gifs_GIFEncoder::GIFWord ( $this->LOP ) . "\0";
		}
	}
	/*
	:::::::::::::::::::::::::::::::::::::::::::::::::::
	...
	function GIFAddFrames ( $i, $d ) {
		...
		if ( ord ( $this->BUF [ $i ] { 10 } ) & 0x80 && $this->IMG > -1 ) {
			if ( $Global_len == $Locals_len ) {
				if ( hu_gifs_GIFEncoder::GIFBlockCompare ( $Global_rgb, $Locals_rgb, $Global_len ) ) {
