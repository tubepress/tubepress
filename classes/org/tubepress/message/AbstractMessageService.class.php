...
abstract class org_tubepress_message_AbstractMessageService implements org_tubepress_message_MessageService
{
    private $_msgs = array(
        ...
        "options-category-title-feed"	  => "YouTube Feed Options", 
        ...
        "options-advanced-title-keyword"              => "Shortcode keyword", 
        ...
        "options-feed-title-filter_racy"          => "Filter \"racy\" content", 
        "options-feed-desc-filter_racy"           => "Don't show videos that may not be suitable for minors.", 
        "options-feed-title-clientKey"            => "YouTube API Client ID", 
        "options-feed-desc-clientKey"             => "YouTube will use this client ID for logging and debugging purposes if you experience a service problem on their end. You can register a new client ID <a href=\"http://code.google.com/apis/youtube/dashboard/\">here</a>. Don't change this unless you know what you're doing.", 
        "options-feed-title-developerKey"         => "YouTube API Developer Key", 
        "options-feed-desc-developerKey"          => "YouTube will use this developer key for logging and debugging purposes if you experience a service problem on their end. You can register a new client ID and developer key <a href=\"http://code.google.com/apis/youtube/dashboard/\">here</a>. Don't change this unless you know what you're doing.", 
        "options-feed-title-cacheEnabled"         => "Enable request cache", 
        "options-feed-desc-cacheEnabled"          => "Store YouTube responses locally for 1 hour. Each response is on the order of a few hundred KB, so leaving the cache enabled will significantly reduce load times for your galleries at the slight expense of freshness.",
        "options-feed-title-embeddableOnly"       => "Only retrieve embeddable videos",
        "options-feed-desc-embeddableOnly"	      => "Some videos have embedding disabled. Checking this option will exclude these videos from your galleries.",
