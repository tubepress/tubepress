...
class tubepress_wordpress_ioc_WordPressExtension implements tubepress_platform_api_ioc_ContainerExtensionInterface
{
    ...
    public function load(tubepress_platform_api_ioc_ContainerBuilderInterface $containerBuilder)
    {
        ...
        $containerBuilder->register(
         ...
         ->addArgument(new tubepress_platform_api_ioc_Reference(tubepress_app_html_api_HtmlGeneratorInterface::_))
         ->addArgument(new tubepress_platform_api_ioc_Reference(tubepress_app_http_api_AjaxCommandInterface::_))
         ->addArgument(new tubepress_platform_api_ioc_Reference(tubepress_app_http_api_RequestParametersInterface::_))
        ...
        $containerBuilder->register(
         ...
         ->addArgument(tubepress_app_shortcode_api_Constants::OPTION_KEYWORD)
         ->addArgument('text');
        ...
        $containerBuilder->register(
            ...
            'tubepress_wordpress_impl_wp_OptionsPage'
        )->addArgument(new tubepress_platform_api_ioc_Reference(tubepress_app_options_ui_api_FormInterface::_))
         ->addArgument(new tubepress_platform_api_ioc_Reference(tubepress_app_http_api_RequestParametersInterface::_))
         ->addTag(tubepress_lib_ioc_api_Constants::TAG_EVENT_LISTENER, array(
        ...
        )->setFactoryService(tubepress_lib_template_api_TemplateFactoryInterface::_)
         ->setFactoryMethod('fromFilesystem')
         ->addArgument(array(TUBEPRESS_ROOT . '/src/core/integration/wordpress/resources/templates/options_page.tpl.php'))
         ->addTag(tubepress_app_options_ui_api_Constants::IOC_TAG_OPTIONS_PAGE_TEMPLATE);

        $containerBuilder->setParameter(tubepress_app_options_api_Constants::IOC_PARAM_EASY_REFERENCE . '_wordpress', array(
