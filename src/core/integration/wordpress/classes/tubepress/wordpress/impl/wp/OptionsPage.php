...
{
    /**
     * @var tubepress_app_options_ui_api_FormInterface
     */
    private $_form;
    ...
    public function __construct(tubepress_app_options_ui_api_FormInterface        $form,
    ...
    public function run(tubepress_lib_event_api_EventInterface $event)
    {
        $errors        = array();
        $justSubmitted = false;
