...
class tubepress_wordpress_impl_listeners_wp_PublicActionsAndFilters
{
    ...
    /**
     * @var tubepress_app_http_api_AjaxCommandInterface
     */
    ...
    public function __construct(tubepress_wordpress_impl_wp_WpFunctions            $wpFunctions,
                                ...
                                tubepress_app_http_api_AjaxCommandInterface       $ajaxHandler,
    ...
    public function onAction_widgets_init(tubepress_lib_event_api_EventInterface $event)
    {
    ...
    public function onAction_init(tubepress_lib_event_api_EventInterface $event)
    {
    ...
    public function onAction_wp_head(tubepress_lib_event_api_EventInterface $event)
    {
    ...
    public function onAction_ajax(tubepress_lib_event_api_EventInterface $event)
    {
     ...
     */
    public function onFilter_the_content(tubepress_lib_event_api_EventInterface $event)
    {
        $content = $event->getSubject();

        /* do as little work as possible here 'cause we might not even run */
        $trigger = $this->_persistence->fetch(tubepress_app_shortcode_api_Constants::OPTION_KEYWORD);
