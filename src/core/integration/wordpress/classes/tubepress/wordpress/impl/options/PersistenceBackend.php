...
/**
 * Implementation of tubepress_app_options_api_PersistenceInterface that uses the
 * regular WordPress options API.
 */
class tubepress_wordpress_impl_options_PersistenceBackend implements tubepress_app_options_api_PersistenceBackendInterface
{
    /*
