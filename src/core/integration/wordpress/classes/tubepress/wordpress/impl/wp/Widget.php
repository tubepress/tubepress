...
class tubepress_wordpress_impl_wp_Widget
{
    ...
    /**
     * @var tubepress_app_html_api_HtmlGeneratorInterface
     */
    private $_htmlGenerator;

    /**
     * @var tubepress_app_shortcode_api_ParserInterface
     */
    ...
    public function __construct(tubepress_app_options_api_ContextInterface          $context,
                                ...
                                tubepress_app_html_api_HtmlGeneratorInterface       $htmlGenerator,
                                tubepress_app_shortcode_api_ParserInterface         $parser,
                                tubepress_wordpress_impl_wp_WpFunctions              $wpFunctions,
                                tubepress_platform_api_util_StringUtilsInterface              $stringUtils,
                                tubepress_app_http_api_RequestParametersInterface   $requestParameters,
     ...
     * @return void
     */
    public function printWidgetHtml(tubepress_lib_event_api_EventInterface $event)
    {
        ...
        $defaultWidgetOptions = array(
            tubepress_app_media_provider_api_Constants::OPTION_RESULTS_PER_PAGE     => 3,
            tubepress_app_media_item_api_Constants::OPTION_VIEWS            => false,
            tubepress_app_media_item_api_Constants::OPTION_DESCRIPTION      => true,
            tubepress_app_media_item_api_Constants::OPTION_DESC_LIMIT       => 50,
            tubepress_app_player_api_Constants::OPTION_PLAYER_LOCATION        => 'shadowbox',
            tubepress_app_feature_gallery_api_Constants::OPTION_THUMB_HEIGHT    => 105,
            tubepress_app_feature_gallery_api_Constants::OPTION_THUMB_WIDTH     => 135,
            tubepress_app_feature_gallery_api_Constants::OPTION_PAGINATE_ABOVE  => false,
            tubepress_app_feature_gallery_api_Constants::OPTION_PAGINATE_BELOW  => false,
            tubepress_app_theme_api_Constants::OPTION_THEME                   => 'tubepress/legacy-sidebar',
        ...
        if ($this->_context->get(tubepress_app_theme_api_Constants::OPTION_THEME) === '') {

            $this->_context->setEphemeralOption(tubepress_app_theme_api_Constants::OPTION_THEME, 'tubepress/legacy-sidebar');
        }
    ...
    public function printControlHtml()
    {
        ...
        $templatePath = TUBEPRESS_ROOT . '/src/core/integration/wordpress/resources/templates/widget_controls.tpl.php';
