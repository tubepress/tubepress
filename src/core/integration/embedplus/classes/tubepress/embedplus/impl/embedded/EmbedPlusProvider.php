 ...
 */
class tubepress_embedplus_impl_embedded_EmbedPlusProvider implements tubepress_app_embedded_api_EmbeddedProviderInterface
{
    /**
    ...
    public function getPathsForTemplateFactory()
    {
        return array(
            ...
            TUBEPRESS_ROOT . '/src/core/integration/embedplus/resources/templates/embedded/embedplus.tpl.php'
        );
    }
