 ...
 *
 */
class tubepress_jwplayer_ioc_JwPlayerExtension implements tubepress_platform_api_ioc_ContainerExtensionInterface
{
    /**
    ...
    public function load(tubepress_platform_api_ioc_ContainerBuilderInterface $containerBuilder)
    {
        ...
        $containerBuilder->setParameter(tubepress_app_options_api_Constants::IOC_PARAM_EASY_REFERENCE . '_jwplayer', array(
        ...
        $containerBuilder->setParameter(tubepress_app_options_api_Constants::IOC_PARAM_EASY_VALIDATION . '_jwplayer', array(
            'priority' => 3000,
            'map' => array(
                'hexColor' => array(
        ...
        $containerBuilder->setParameter(tubepress_app_options_api_Constants::IOC_PARAM_EASY_TRIMMER . '_jwplayer', array(
