 ...
 */
class tubepress_youtube_ioc_YouTubeExtension implements tubepress_platform_api_ioc_ContainerExtensionInterface
{
    /**
    ...
    public function load(tubepress_platform_api_ioc_ContainerBuilderInterface $containerBuilder)
    {
        ...
        $containerBuilder->register(
         ...
         ->addTag(tubepress_lib_ioc_api_Constants::TAG_EVENT_LISTENER, array(
            'event'    => tubepress_app_options_api_Constants::EVENT_OPTION_SET . '.' . tubepress_youtube_api_Constants::OPTION_YOUTUBE_PLAYLIST_VALUE,
        ...
        $containerBuilder->register(
         ...
         ->addArgument(new tubepress_platform_api_ioc_Reference(tubepress_lib_util_api_TimeUtilsInterface::_))
         ->addTag(tubepress_lib_ioc_api_Constants::TAG_EVENT_LISTENER, array(
        ...
        foreach ($gallerySourceMap as $gallerySourceFieldArray) {
            ...
            $containerBuilder->register(
             ...
             ->addArgument(array('additionalField' => new tubepress_platform_api_ioc_Reference('youtube_options_subfield_' . $fieldIndex++)));
        }
        ...
        $containerBuilder->setParameter(tubepress_app_media_item_api_Constants::IOC_PARAM_EASY_ATTRIBUTE_FORMATTER . '_youtube', array(
            ...
            'map'          => array(
                ...
                array(
                    tubepress_app_media_item_api_Constants::ATTRIBUTE_RATING_COUNT,
                    tubepress_app_media_item_api_Constants::ATTRIBUTE_RATING_COUNT,
                    'number',
                    0,
                ),
                ...
                array(
                    tubepress_app_media_item_api_Constants::ATTRIBUTE_RATING_AVERAGE,
                    tubepress_app_media_item_api_Constants::ATTRIBUTE_RATING_AVERAGE,
                    'number',
                    2,
                ),
        ...
        $containerBuilder->setParameter(tubepress_app_options_api_Constants::IOC_PARAM_EASY_REFERENCE . '_youtube', array(
        ...
        $containerBuilder->setParameter(tubepress_app_options_api_Constants::IOC_PARAM_EASY_ACCEPTABLE_VALUES . '_' . tubepress_youtube_api_Constants::OPTION_AUTOHIDE, array(
        ...
        $containerBuilder->setParameter(tubepress_app_options_api_Constants::IOC_PARAM_EASY_ACCEPTABLE_VALUES . '_' . tubepress_youtube_api_Constants::OPTION_SHOW_CONTROLS, array(
        ...
        $containerBuilder->setParameter(tubepress_app_options_api_Constants::IOC_PARAM_EASY_ACCEPTABLE_VALUES . '_' . tubepress_youtube_api_Constants::OPTION_THEME, array(
        ...
        $containerBuilder->setParameter(tubepress_app_options_api_Constants::IOC_PARAM_EASY_ACCEPTABLE_VALUES . '_' . tubepress_youtube_api_Constants::OPTION_FILTER, array(
        ...
        $containerBuilder->setParameter(tubepress_app_options_api_Constants::IOC_PARAM_EASY_ACCEPTABLE_VALUES . '_' . tubepress_youtube_api_Constants::OPTION_YOUTUBE_MOST_POPULAR_VALUE, array(
        ...
        $containerBuilder->setParameter(tubepress_app_options_api_Constants::IOC_PARAM_EASY_VALIDATION . '_youtube', array(
