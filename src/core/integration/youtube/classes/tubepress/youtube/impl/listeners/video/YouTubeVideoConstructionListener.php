...
class tubepress_youtube_impl_listeners_video_YouTubeVideoConstructionListener
{
    ...
    public function __construct(tubepress_app_options_api_ContextInterface $context,
                                tubepress_lib_util_api_TimeUtilsInterface  $timeUtils)
    {
    ...
    public function onVideoConstruction(tubepress_lib_event_api_EventInterface $event)
    {
         ...
         */
        $provider = $mediaItem->getAttribute(tubepress_app_media_item_api_Constants::ATTRIBUTE_PROVIDER);
    ...
    protected function buildAttributeMap(tubepress_lib_event_api_EventInterface $event)
    {
        ...
        $toReturn[tubepress_app_media_item_api_Constants::ATTRIBUTE_CATEGORY_DISPLAY_NAME] =
        ...
        /* Keywords. */
        $toReturn[tubepress_app_media_item_api_Constants::ATTRIBUTE_KEYWORD_ARRAY] = array();

        /* Rating */
        $toReturn[tubepress_app_media_item_api_Constants::ATTRIBUTE_RATING_AVERAGE] = $this->_getRatingAverage($xpath, $index);
        $toReturn[tubepress_app_media_item_api_Constants::ATTRIBUTE_RATING_COUNT] = $this->_getRatingCount($xpath, $index);
    ...
    protected function pickThumbnailUrl($urls)
    {
        ...
        $random = $this->_context->get(tubepress_app_feature_gallery_api_Constants::OPTION_RANDOM_THUMBS);
