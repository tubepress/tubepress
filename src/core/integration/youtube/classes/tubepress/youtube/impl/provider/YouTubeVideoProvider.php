 ...
 */
class tubepress_youtube_impl_provider_YouTubeVideoProvider implements tubepress_app_media_provider_api_HttpProviderInterface
{
    ...
    {
        switch ($this->_context->get(tubepress_app_media_provider_api_Constants::OPTION_GALLERY_SOURCE)) {
            ...
            case tubepress_youtube_api_Constants::GALLERYSOURCE_YOUTUBE_SEARCH:
                ...
                $filter = $this->_context->get(tubepress_app_feature_search_api_Constants::OPTION_SEARCH_ONLY_USER);
     ...
     *
     * @return tubepress_lib_url_api_UrlInterface The URL for the single video given.
     *
     * @api
     * @since 4.0.0
     */
     ...
     * @since 4.0.0
     */
    public function onPreFireNewMediaItemEvent(tubepress_lib_event_api_EventInterface $event)
    {
    ...
    private function _urlPostProcessingCommon(tubepress_lib_url_api_UrlInterface $url)
    {
        $query = $url->getQuery();
    ...
    private function _urlPostProcessingGallery(tubepress_lib_url_api_UrlInterface $url, $currentPage)
    {
        $perPage = $this->_context->get(tubepress_app_media_provider_api_Constants::OPTION_RESULTS_PER_PAGE);
    ...
    private function _urlProcessingOrderBy(tubepress_lib_url_api_UrlInterface $url)
    {
        /*
        ...
        $requestedSortOrder   = $this->_context->get(tubepress_app_media_provider_api_Constants::OPTION_ORDER_BY);
        $currentGallerySource = $this->_context->get(tubepress_app_media_provider_api_Constants::OPTION_GALLERY_SOURCE);
        $query                = $url->getQuery();

        if ($requestedSortOrder === tubepress_app_media_provider_api_Constants::ORDER_BY_DEFAULT) {
    ...
    private static function _makeSureNumeric($result)
    {
        if (is_numeric($result) === false) {
            ...
            throw new tubepress_app_media_provider_api_exception_ProviderException("YouTube returned a non-numeric result count: $result");
        }
    }
    ...
    private function _createDomDocument($feed)
    {
        ...
        if (! class_exists('DOMDocument')) {
            ...
            throw new tubepress_app_media_provider_api_exception_ProviderException('DOMDocument class not found');
        }
        ...
        if ($doc->loadXML($feed) === false) {
            ...
            throw new tubepress_app_media_provider_api_exception_ProviderException('Could not parse XML from YouTube');
        }
     ...
     *
     * @throws tubepress_app_media_provider_api_exception_ProviderException
     *
     * @api
     * @since 4.0.0
     */
    ...
    public function getMapOfMetaOptionNamesToAttributeDisplayNames()
    {
        return array(
            ...
            tubepress_app_media_item_api_Constants::OPTION_TITLE       => tubepress_app_media_item_api_Constants::ATTRIBUTE_TITLE,
            tubepress_app_media_item_api_Constants::OPTION_LENGTH      => tubepress_app_media_item_api_Constants::ATTRIBUTE_DURATION_FORMATTED,
            tubepress_app_media_item_api_Constants::OPTION_AUTHOR      => tubepress_app_media_item_api_Constants::ATTRIBUTE_AUTHOR_DISPLAY_NAME,
            tubepress_app_media_item_api_Constants::OPTION_KEYWORDS    => tubepress_app_media_item_api_Constants::ATTRIBUTE_KEYWORDS_FORMATTED,
            tubepress_app_media_item_api_Constants::OPTION_URL         => tubepress_app_media_item_api_Constants::ATTRIBUTE_HOME_URL,
            tubepress_app_media_item_api_Constants::OPTION_CATEGORY    => tubepress_app_media_item_api_Constants::ATTRIBUTE_CATEGORY_DISPLAY_NAME,

            tubepress_youtube_api_Constants::OPTION_RATINGS             => tubepress_app_media_item_api_Constants::ATTRIBUTE_RATING_COUNT,
            tubepress_youtube_api_Constants::OPTION_RATING              => tubepress_app_media_item_api_Constants::ATTRIBUTE_RATING_AVERAGE,

            tubepress_app_media_item_api_Constants::OPTION_ID          => tubepress_app_media_item_api_Constants::ATTRIBUTE_ID,
            tubepress_app_media_item_api_Constants::OPTION_VIEWS       => tubepress_app_media_item_api_Constants::ATTRIBUTE_VIEW_COUNT,
            tubepress_app_media_item_api_Constants::OPTION_UPLOADED    => tubepress_app_media_item_api_Constants::ATTRIBUTE_TIME_PUBLISHED_FORMATTED,
            tubepress_app_media_item_api_Constants::OPTION_DESCRIPTION => tubepress_app_media_item_api_Constants::ATTRIBUTE_DESCRIPTION,
     ...
     * @return int
     */
    public function compareForPerPageSort(tubepress_app_media_item_api_MediaItem $first,
    ...
    private function _checkForError()
    {
        ...
        if ($reason->length > 0) {
            ...
            throw new tubepress_app_media_provider_api_exception_ProviderException($reason->item(0)->nodeValue);
        }
    }
}