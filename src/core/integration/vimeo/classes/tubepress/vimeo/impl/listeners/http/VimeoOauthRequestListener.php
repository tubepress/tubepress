...
{
    /**
     * @var tubepress_lib_http_api_oauth_v1_ClientInterface
     */
    ...
    public function __construct(tubepress_lib_http_api_oauth_v1_ClientInterface $oauthClient,
    ...
    {
        /**
         * @var $request tubepress_lib_http_api_message_RequestInterface
         */
        ...
        $clientCredentials = new tubepress_lib_http_api_oauth_v1_Credentials($clientId, $clientSecret);
