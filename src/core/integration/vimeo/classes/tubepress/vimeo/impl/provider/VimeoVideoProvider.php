 ...
 */
class tubepress_vimeo_impl_provider_VimeoVideoProvider implements tubepress_app_media_provider_api_HttpProviderInterface
{
    ...
    /**
     * @var tubepress_app_media_provider_api_ItemSorterInterface
     */
    private $_itemSorter;
    ...
    public function __construct(tubepress_platform_api_log_LoggerInterface                 $logger,
                                ...
                                tubepress_app_media_provider_api_ItemSorterInterface   $itemSorter)
    {
        $this->_logger          = $logger;
    ...
    {
        $params = array();
        $mode   = $this->_context->get(tubepress_app_media_provider_api_Constants::OPTION_GALLERY_SOURCE);
        ...
        $params[self::$_URL_PARAM_PER_PAGE]      = $this->_context->get(tubepress_app_media_provider_api_Constants::OPTION_RESULTS_PER_PAGE);
...
es for the "mode" option.
    ...
    public function onAnalysisStart($feed)
    {
        ...
        if ($this->_unserialized === false) {
            ...
            throw new tubepress_app_media_provider_api_exception_ProviderException('Unable to unserialize PHP from Vimeo');
        }
        ...
        if ($this->_unserialized->stat !== 'ok') {
            ...
            throw new tubepress_app_media_provider_api_exception_ProviderException($this->_getErrorMessageFromVimeo());
        }
    ...
    public function getMapOfFeedSortNamesToUntranslatedLabels()
    {
        return array(
            ...
            tubepress_vimeo_api_Constants::ORDER_BY_DEFAULT       => 'default',                         //>(translatable)<
    ...
    public function compareForPerPageSort(tubepress_app_media_item_api_MediaItem $first, tubepress_app_media_item_api_MediaItem $second, $perPageSort)
    {
        ...
        switch ($perPageSort) {
            ...
            case tubepress_vimeo_api_Constants::PER_PAGE_SORT_COMMENT_COUNT:
                $attributeName = tubepress_app_media_item_api_Constants::ATTRIBUTE_COMMENT_COUNT;
                break;

            case tubepress_vimeo_api_Constants::PER_PAGE_SORT_DURATION:
                $attributeName = tubepress_app_media_item_api_Constants::ATTRIBUTE_DURATION_SECONDS;
                break;

            case tubepress_vimeo_api_Constants::PER_PAGE_SORT_NEWEST:
                $attributeName = tubepress_app_media_item_api_Constants::ATTRIBUTE_TIME_PUBLISHED_UNIXTIME;
                break;
            ...
            case tubepress_vimeo_api_Constants::PER_PAGE_SORT_RATING:
                $attributeName = tubepress_app_media_item_api_Constants::ATTRIBUTE_RATING_AVERAGE;
                break;
    ...
    private function _getSort($mode)
    {
        ...
        $order = $this->_context->get(tubepress_app_media_provider_api_Constants::OPTION_ORDER_BY);

        if ($order === tubepress_app_media_provider_api_Constants::ORDER_BY_DEFAULT) {
