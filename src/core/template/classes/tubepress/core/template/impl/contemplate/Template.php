 ...
 */
class tubepress_core_template_impl_contemplate_Template implements tubepress_core_template_api_TemplateInterface
{
    /**
     * @var array
     */
    ...
    public function setVariables(array $context)
    {
        if (!$this->_langUtils->isAssociativeArray($context)) {
            ...
            throw new InvalidArgumentException('tubepress_core_template_api_TemplateInterface::setContext() requires an associative array.');
        }
