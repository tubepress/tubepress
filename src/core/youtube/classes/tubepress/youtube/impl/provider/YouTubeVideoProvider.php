...
class tubepress_youtube_impl_provider_YouTubeVideoProvider implements tubepress_core_media_provider_api_HttpProviderInterface
{
    ...
    public function getMapOfMetaOptionNamesToAttributeDisplayNames()
    {
        return array(
            ...
            tubepress_youtube_api_Constants::OPTION_RATINGS             => tubepress_core_media_item_api_Constants::ATTRIBUTE_RATING_COUNT,
            tubepress_youtube_api_Constants::OPTION_RATING              => tubepress_core_media_item_api_Constants::ATTRIBUTE_RATING_AVERAGE,
