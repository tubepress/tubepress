...
class tubepress_youtube_ioc_YouTubeExtension implements tubepress_api_ioc_ContainerExtensionInterface
{
    ...
    public function load(tubepress_api_ioc_ContainerBuilderInterface $containerBuilder)
    {
        ...
        $containerBuilder->setParameter(tubepress_core_options_api_Constants::IOC_PARAM_EASY_REFERENCE . '_youtube', array(
        ...
        $containerBuilder->setParameter(tubepress_core_options_api_Constants::IOC_PARAM_EASY_ACCEPTABLE_VALUES . '_' . tubepress_youtube_api_Constants::OPTION_AUTOHIDE, array(
        ...
        $containerBuilder->setParameter(tubepress_core_options_api_Constants::IOC_PARAM_EASY_ACCEPTABLE_VALUES . '_' . tubepress_youtube_api_Constants::OPTION_SHOW_CONTROLS, array(
        ...
        $containerBuilder->setParameter(tubepress_core_options_api_Constants::IOC_PARAM_EASY_ACCEPTABLE_VALUES . '_' . tubepress_youtube_api_Constants::OPTION_THEME, array(
        ...
        $containerBuilder->setParameter(tubepress_core_options_api_Constants::IOC_PARAM_EASY_ACCEPTABLE_VALUES . '_' . tubepress_youtube_api_Constants::OPTION_FILTER, array(
        ...
        $containerBuilder->setParameter(tubepress_core_options_api_Constants::IOC_PARAM_EASY_ACCEPTABLE_VALUES . '_' . tubepress_youtube_api_Constants::OPTION_YOUTUBE_MOST_POPULAR_VALUE, array(
        ...
        $containerBuilder->setParameter(tubepress_core_options_api_Constants::IOC_PARAM_EASY_VALIDATION . '_youtube', array(
