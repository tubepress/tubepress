 ...
 * @since 4.0.0
 */
interface tubepress_core_media_provider_api_Constants
{
    /**
     * This event is fired when a TubePress collects a new media item.
     *
     * @subject {@link tubepress_core_media_item_api_MediaItem} The media item.
     *
     * @argument <var>provider</var> (`tubepress_core_media_provider_api_MediaProviderInterface`) The media provider that collected the item.
     *
     * @api
     * @since 4.0.0
     */
    ...
    /**
     * This event is fired when a TubePress collects a new tubepress_core_media_provider_api_Page.
     *
     * @subject {@tubepress_core_media_provider_api_Page} The page being built.
     *
