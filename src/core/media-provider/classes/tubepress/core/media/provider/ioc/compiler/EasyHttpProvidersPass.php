 ...
 *
 */
class tubepress_core_media_provider_ioc_compiler_EasyHttpProvidersPass implements tubepress_api_ioc_CompilerPassInterface
{
    /**
    ...
    {
        $simpleProviderIds = $containerBuilder->findTaggedServiceIds('tubepress_core_media_provider_api_HttpProviderInterface');
        ...
        foreach ($simpleProviderIds as $simpleProviderId => $tags) {
            ...
            $containerBuilder->register(
             ...
             ->addArgument(new tubepress_api_ioc_Reference(tubepress_core_http_api_HttpClientInterface::_))
             ->addTag(tubepress_core_media_provider_api_MediaProviderInterface::_);
        }
    }
}