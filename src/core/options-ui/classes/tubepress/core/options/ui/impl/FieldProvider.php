...
/**
 */
class tubepress_core_options_ui_impl_FieldProvider implements tubepress_core_options_ui_api_FieldProviderInterface
{
    /**
    ...
    public function __construct(array $categories, array $fields)
    {
    ...
    {
        return 'tubepress-core-core-options-ui-field-provider';
    }
