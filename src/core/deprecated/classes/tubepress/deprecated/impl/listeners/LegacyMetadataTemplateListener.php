...
class tubepress_deprecated_impl_listeners_LegacyMetadataTemplateListener
{
    ...
    public function onSingleTemplate(tubepress_lib_event_api_EventInterface $event)
    {
        /**
    ...
    private function _setLegacyVariables(tubepress_lib_template_api_TemplateInterface $template)
    {
