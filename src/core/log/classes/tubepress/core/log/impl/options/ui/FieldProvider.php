...
/**
 */
class tubepress_core_log_impl_options_ui_FieldProvider implements tubepress_core_options_ui_api_FieldProviderInterface
{
    /**
    ...
    {
        return 'tubepress-core-log-field-provider';
    }
