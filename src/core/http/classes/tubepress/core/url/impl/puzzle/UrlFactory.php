 ...
 */
class tubepress_core_url_impl_puzzle_UrlFactory implements tubepress_core_url_api_UrlFactoryInterface
{
    ...
    public function fromString($url)
    {
        if (!is_string($url)) {
            ...
            throw new InvalidArgumentException('tubepress_core_url_impl_puzzle_UrlFactory::fromString() can only accept strings.');
        }

        return new tubepress_core_url_impl_puzzle_PuzzleBasedUrl(puzzle_Url::fromString($url));
    }
