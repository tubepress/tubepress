 ...
 * Delegating stream.
 */
class tubepress_core_stream_impl_puzzle_FlexibleStream implements puzzle_stream_StreamInterface, tubepress_core_stream_api_StreamInterface
{
    /**
     * @var puzzle_stream_StreamInterface|tubepress_core_stream_api_StreamInterface
     */
    private $_delegate;

    public function __construct($delegate)
    {
        if (!($delegate instanceof puzzle_stream_StreamInterface || $delegate instanceof tubepress_core_stream_api_StreamInterface)) {
