 ...
 */
class tubepress_core_http_impl_puzzle_PuzzleBasedResponse extends tubepress_core_http_impl_puzzle_AbstractMessage implements tubepress_core_http_api_message_ResponseInterface
{
    /**
    ...
    public function __construct(puzzle_message_ResponseInterface $delegate)
    {
        ...
        if ($urlString !== null) {
            ...
            $this->_effectiveUrl = new tubepress_core_url_impl_puzzle_PuzzleBasedUrl($puzzleUrl);
        }
     ...
     * redirect URL).
     *
     * @param tubepress_core_url_api_UrlInterface $url Effective URL
     *
     * @return tubepress_core_http_api_message_ResponseInterface Self.
     *
     * @api
     * @since 4.0.0
     */
    public function setEffectiveUrl(tubepress_core_url_api_UrlInterface $url)
    {
