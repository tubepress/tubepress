 ...
 */
class tubepress_core_http_impl_PrimaryAjaxHandler implements tubepress_core_http_api_AjaxCommandInterface
{
    /**
    ...
    public function handle()
    {
        ...
        /**
         * @var $commandHandler tubepress_core_http_api_AjaxCommandInterface
         */
