 ...
 *
 */
class tubepress_core_http_impl_oauth_v1_Client implements tubepress_core_http_api_oauth_v1_ClientInterface
{
    /**
     * @param tubepress_core_http_api_message_RequestInterface $request
     * @param tubepress_core_http_api_oauth_v1_Credentials       $clientCredentials
     * @param tubepress_core_http_api_oauth_v1_Credentials       $tokenCredentials
     *
     * @return void
     *
     * @api
     * @since 4.0.0
     */
    public function signRequest(tubepress_core_http_api_message_RequestInterface     $request,
                                tubepress_core_http_api_oauth_v1_Credentials $clientCredentials,
                                tubepress_core_http_api_oauth_v1_Credentials $tokenCredentials = null)
    {
    ...
    private function _getBaseOAuthParams(tubepress_core_http_api_oauth_v1_Credentials $clientCredentials)
    {
        return array(
    ...
    private function _sign(tubepress_core_http_api_message_RequestInterface     $httpRequest,
                           array                                        $oauthParams,
                           tubepress_core_http_api_oauth_v1_Credentials $clientCredentials,
                           tubepress_core_http_api_oauth_v1_Credentials $tokenCredentials = null)
    {
    ...
    private function _getSignature(tubepress_core_http_api_message_RequestInterface     $request,
    ...
    private function _getNormalizedAuthority(tubepress_core_url_api_UrlInterface $url)
    {
