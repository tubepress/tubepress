 ...
 * @since 4.0.0
 */
interface tubepress_core_http_api_Constants
{
    /**
     * This event is fired when TubePress encounters an HTTP exception.
     *
     * @subject `tubepress_core_http_api_exception_RequestException` The HTTP request exception.
     *
     * @argument <var>response</var> (`tubepress_core_http_api_message_ResponseInterface`): Initially null, listeners
     ...
     *
     * @subject `tubepress_core_http_api_message_RequestInterface` The HTTP request.
     *
     * @argument <var>response</var> (`tubepress_core_http_api_message_ResponseInterface`): Initially null, listeners can
     ...
     *
     * @subject `tubepress_core_http_api_message_ResponseInterface` The HTTP response.
     *
     * @argument <var>request</var> (`tubepress_core_http_api_message_RequestInterface`):  The HTTP request.
     *
     * @api
     * @since 4.0.0
     */
