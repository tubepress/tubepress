...
/**
 */
class tubepress_core_media_item_impl_options_ui_FieldProvider implements tubepress_core_options_ui_api_FieldProviderInterface
{
    /**
    ...
    {
        return 'media-item-field-provider';
    }
