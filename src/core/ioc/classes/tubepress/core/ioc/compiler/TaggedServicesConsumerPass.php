 ...
 */
class tubepress_core_ioc_compiler_TaggedServicesConsumerPass implements tubepress_api_ioc_CompilerPassInterface
{
    /**
    ...
    {
        $consumerIds = $containerBuilder->findTaggedServiceIds(tubepress_core_ioc_api_Constants::TAG_TAGGED_SERVICES_CONSUMER);
