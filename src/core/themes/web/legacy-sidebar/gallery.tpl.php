...
<div class="tubepress_container tubepress_sidebar" id="tubepress_gallery_<?php echo ${tubepress_core_html_api_Constants::TEMPLATE_VAR_GALLERY_ID}; ?>">
                ...
                <div class="tubepress_thumb">
                    ...
                    <dl class="tubepress_meta_group" style="width: 100%">
                        ...
                        <?php if (${tubepress_core_html_gallery_api_Constants::TEMPLATE_VAR_META_SHOULD_SHOW}[tubepress_core_media_item_api_Constants::OPTION_AUTHOR]): ?>
                            ...
                            <dt class="tubepress_meta tubepress_meta_author"><?php echo ${tubepress_core_html_gallery_api_Constants::TEMPLATE_VAR_META_LABELS}[tubepress_core_media_item_api_Constants::OPTION_AUTHOR]; ?></dt><dd class="tubepress_meta tubepress_meta_author"><?php echo $mediaItem->getAttribute(tubepress_core_media_item_api_Constants::ATTRIBUTE_AUTHOR_DISPLAY_NAME); ?></dd>
                        <?php endif; ?>
                        ...
                        <?php if (${tubepress_core_html_gallery_api_Constants::TEMPLATE_VAR_META_SHOULD_SHOW}[tubepress_core_media_item_api_Constants::OPTION_KEYWORDS]): ?>
                            ...
                            <dt class="tubepress_meta tubepress_meta_keywords"><?php echo ${tubepress_core_html_gallery_api_Constants::TEMPLATE_VAR_META_LABELS}[tubepress_core_media_item_api_Constants::OPTION_KEYWORDS]; ?></dt><dd class="tubepress_meta tubepress_meta_keywords"><?php echo $raw = htmlspecialchars(implode(" ", $mediaItem->getAttribute(tubepress_core_media_item_api_Constants::ATTRIBUTE_KEYWORD_ARRAY)), ENT_QUOTES, "UTF-8"); ?></dd>
                        <?php endif; ?>
