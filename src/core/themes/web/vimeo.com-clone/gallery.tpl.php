            ...
            <div class="tubepress_thumb">
                ...
                <dl class="tubepress_meta_group" style="width: <?php echo ${tubepress_core_html_gallery_api_Constants::TEMPLATE_VAR_THUMBNAIL_WIDTH}; ?>px">
                    ...
                    <dt class="tubepress_meta tubepress_meta_runtime">
                        <?php echo ${tubepress_core_media_item_api_Constants::TEMPLATE_VAR_META_LABELS}[tubepress_core_media_item_api_Constants::OPTION_LENGTH]; ?>
                    </dt>
                    ...
                    <dt class="tubepress_meta tubepress_meta_author">
                        <?php echo ${tubepress_core_media_item_api_Constants::TEMPLATE_VAR_META_LABELS}[tubepress_core_media_item_api_Constants::OPTION_AUTHOR]; ?>
                    </dt>
