    ...
    <div class="tubepress_thumbs">
      ...
      <div class="tubepress_thumb">
        ...
        <dl class="tubepress_meta_group" style="width: <?php echo ${tubepress_core_html_gallery_api_Constants::TEMPLATE_VAR_THUMBNAIL_WIDTH}; ?>px">
          ...
          <dt class="tubepress_meta tubepress_meta_views"></dt><dd class="tubepress_meta tubepress_meta_views"><?php echo $mediaItem->getAttribute(tubepress_core_media_item_api_Constants::ATTRIBUTE_VIEW_COUNT); ?> views</dd>
          <?php endif; ?>
          ...
          <dt class="tubepress_meta tubepress_meta_uploaddate"></dt><dd class="tubepress_meta tubepress_meta_uploaddate"><?php echo $mediaItem->getAttribute(tubepress_core_media_item_api_Constants::ATTRIBUTE_TIME_PUBLISHED_FORMATTED); ?></dd>
          <?php endif; ?>
