 ...
 *
 */
abstract class tubepress_core_cache_impl_listeners_http_AbstractApiCacheListener
{
    /**
    ...
    public function onEvent(tubepress_core_event_api_EventInterface $event)
    {
    ...
    protected abstract function execute(tubepress_core_event_api_EventInterface $event);
     ...
     */
    protected abstract function getRequestFromEvent(tubepress_core_event_api_EventInterface $event);
     ...
     */
    protected function getItem(tubepress_core_url_api_UrlInterface $url)
    {
        $key = str_replace('/', '~', "$url");
