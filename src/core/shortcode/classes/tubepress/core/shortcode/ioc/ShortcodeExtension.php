 ...
 *
 */
class tubepress_core_shortcode_ioc_ShortcodeExtension implements tubepress_api_ioc_ContainerExtensionInterface
{
    ...
    public function load(tubepress_api_ioc_ContainerBuilderInterface $containerBuilder)
    {
        ...
        $containerBuilder->setParameter(tubepress_core_options_api_Constants::IOC_PARAM_EASY_REFERENCE . '_shortcode', array(
        ...
        $containerBuilder->setParameter(tubepress_core_options_api_Constants::IOC_PARAM_EASY_VALIDATION . '_shortcode', array(
