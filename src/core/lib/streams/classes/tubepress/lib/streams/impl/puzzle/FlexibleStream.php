 ...
 * Delegating stream.
 */
class tubepress_lib_streams_impl_puzzle_FlexibleStream implements puzzle_stream_StreamInterface, tubepress_lib_streams_api_StreamInterface
{
    /**
     * @var puzzle_stream_StreamInterface|tubepress_lib_streams_api_StreamInterface
     */
    private $_delegate;

    public function __construct($delegate)
    {
        if (!($delegate instanceof puzzle_stream_StreamInterface || $delegate instanceof tubepress_lib_streams_api_StreamInterface)) {

            throw new InvalidArgumentException(sprintf('%s must be constructed with instance of either %s or %s',

                'tubepress_lib_streams_impl_puzzle_FlexibleStream',
                'puzzle_stream_StreamInterface',
                'tubepress_lib_streams_api_StreamInterface'
            ));
        }
