 ...
 * @since 4.0.0
 */
interface tubepress_lib_event_api_EventDispatcherInterface
{
    /**
     * @ignore
     */
    const _ = 'tubepress_lib_event_api_EventDispatcherInterface';
     ...
     * @since 4.0.0
     */
    function dispatch($eventName, tubepress_lib_event_api_EventInterface $event = null);
