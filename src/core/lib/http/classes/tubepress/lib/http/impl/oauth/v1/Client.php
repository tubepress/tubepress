 ...
 *
 */
class tubepress_lib_http_impl_oauth_v1_Client implements tubepress_lib_http_api_oauth_v1_ClientInterface
{
    /**
     * @param tubepress_lib_http_api_message_RequestInterface $request
     * @param tubepress_lib_http_api_oauth_v1_Credentials       $clientCredentials
     * @param tubepress_lib_http_api_oauth_v1_Credentials       $tokenCredentials
     *
     * @return void
     *
     * @api
     * @since 4.0.0
     */
    public function signRequest(tubepress_lib_http_api_message_RequestInterface     $request,
                                tubepress_lib_http_api_oauth_v1_Credentials $clientCredentials,
                                tubepress_lib_http_api_oauth_v1_Credentials $tokenCredentials = null)
    {
    ...
    private function _getBaseOAuthParams(tubepress_lib_http_api_oauth_v1_Credentials $clientCredentials)
    {
        return array(
    ...
    private function _sign(tubepress_lib_http_api_message_RequestInterface     $httpRequest,
                           array                                        $oauthParams,
                           tubepress_lib_http_api_oauth_v1_Credentials $clientCredentials,
                           tubepress_lib_http_api_oauth_v1_Credentials $tokenCredentials = null)
    {
    ...
    private function _getSignature(tubepress_lib_http_api_message_RequestInterface     $request,
    ...
    private function _getNormalizedAuthority(tubepress_lib_url_api_UrlInterface $url)
    {
