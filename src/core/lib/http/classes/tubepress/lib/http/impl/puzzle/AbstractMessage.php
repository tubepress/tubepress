 ...
 * Puzzle-based stream.
 */
abstract class tubepress_lib_http_impl_puzzle_AbstractMessage implements tubepress_lib_http_api_message_MessageInterface
{
    /**
     ...
     *
     * @return tubepress_lib_http_api_message_MessageInterface Self.
     *
     * @api
     * @since 4.0.0
     */
     ...
     *
     * @return tubepress_lib_streams_api_StreamInterface|null
     *
     * @api
     * @since 4.0.0
     */
    public function getBody()
    {
        ...
        if ($fromDelegate && !($fromDelegate instanceof tubepress_lib_streams_impl_puzzle_FlexibleStream)) {

            $fromDelegate = new tubepress_lib_streams_impl_puzzle_FlexibleStream($fromDelegate);
        }
     ...
     *
     * The body MUST be a tubepress_lib_streams_api_StreamInterface object. Setting the body to null MUST
     * remove the existing body.
     *
     * @param tubepress_lib_streams_api_StreamInterface|null $body Body.
     *
     * @return tubepress_lib_http_api_message_MessageInterface Self.
     *
     * @api
     * @since 4.0.0
     */
    public function setBody(tubepress_lib_streams_api_StreamInterface $body = null)
    {
        if ($body !== null && (!($body instanceof tubepress_lib_streams_impl_puzzle_FlexibleStream))) {

            $body = new tubepress_lib_streams_impl_puzzle_FlexibleStream($body);
        }
