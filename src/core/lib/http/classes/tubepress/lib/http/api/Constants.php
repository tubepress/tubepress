 ...
 * @since 4.0.0
 */
interface tubepress_lib_http_api_Constants
{
    /**
     * This event is fired when TubePress encounters an HTTP exception.
     *
     * @subject `tubepress_lib_http_api_exception_RequestException` The HTTP request exception.
     *
     * @argument <var>response</var> (`tubepress_lib_http_api_message_ResponseInterface`): Initially null, listeners
     ...
     *
     * @subject `tubepress_lib_http_api_message_RequestInterface` The HTTP request.
     *
     * @argument <var>response</var> (`tubepress_lib_http_api_message_ResponseInterface`): Initially null, listeners can
     ...
     *
     * @subject `tubepress_lib_http_api_message_ResponseInterface` The HTTP response.
     *
     * @argument <var>request</var> (`tubepress_lib_http_api_message_RequestInterface`):  The HTTP request.
     *
     * @api
     * @since 4.0.0
     */
     ...
     * @ignore
     */
    const PARAM_NAME_ACTION  = 'tubepress_action';
    const PARAM_NAME_PAGE    = 'tubepress_page';
    const PARAM_NAME_ITEMID  = 'tubepress_item';
}