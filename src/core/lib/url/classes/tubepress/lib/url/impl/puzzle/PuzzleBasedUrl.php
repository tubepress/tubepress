 ...
 */
class tubepress_lib_url_impl_puzzle_PuzzleBasedUrl implements tubepress_lib_url_api_UrlInterface
{
    /**
     * @var tubepress_lib_url_api_QueryInterface
     */
    private $_query = null;
    ...
    public function __construct(puzzle_Url $delegate)
    {
        ...
        if ($this->_delegateUrl->getQuery()) {
            ...
            $this->_query = new tubepress_lib_url_impl_puzzle_PuzzleBasedQuery($this->_delegateUrl->getQuery());
        }
    }
    ...
    /**
     * @return tubepress_lib_url_api_QueryInterface
     */
     ...
     *
     * @param tubepress_lib_url_api_QueryInterface|string|array $query Query string value to set. Can
     *                                                             be a string that will be parsed into a tubepress_lib_url_api_QueryInterface object, an array
     *                                                             of key value pairs, or a tubepress_lib_url_api_QueryInterface object.
     *
     * @return tubepress_lib_url_api_UrlInterface
    ...
    public function setQuery($query)
    {
        ...
        if ($query instanceof tubepress_lib_url_api_QueryInterface) {
        ...
        $this->_query = new tubepress_lib_url_impl_puzzle_PuzzleBasedQuery($puzzleQuery);
