<?php
class tubepress_lib_url_impl_puzzle_PuzzleBasedQuery implements tubepress_lib_url_api_QueryInterface
{
    /**
     * @var puzzle_Query
     */
     ...
     *
     * @return tubepress_lib_url_api_QueryInterface Self.
     */
     ...
     * returned into the result tubepress_lib_url_api_QueryInterface.
     *
    ...
    /**
     * Returns a tubepress_lib_url_api_QueryInterface containing all the elements of the collection after
    ...
    /**
     * Add and merge in a tubepress_lib_url_api_QueryInterface or array of key value pair data.
     *
     * @param tubepress_lib_url_api_QueryInterface|array $data Associative array of key value pair data
     *
     * @return tubepress_lib_url_api_QueryInterface Self.
     */
    public function merge($data)
    {
        if ($data instanceof tubepress_lib_url_api_QueryInterface) {
