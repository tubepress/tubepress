 ...
 *
 */
class tubepress_lib_util_impl_TimeUtils implements tubepress_lib_util_api_TimeUtilsInterface
{
    /**
    ...
    public function unixTimeToHumanReadable($unixTime, $format, $relative)
    {
        ...
        if ($relative) {
            ...
            return tubepress_lib_util_impl_TimeUtils::getRelativeTime($unixTime);
        }
