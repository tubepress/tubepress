...
<dt class="tubepress-meta-<?php echo $attributeName; ?>"><?php
    if (isset(${tubepress_app_media_item_api_Constants::TEMPLATE_VAR_ATTRIBUTE_LABELS}[$attributeName])):
        echo htmlspecialchars(${tubepress_app_media_item_api_Constants::TEMPLATE_VAR_ATTRIBUTE_LABELS}[$attributeName], ENT_QUOTES, 'UTF-8');
    endif;
?></dt>
...
<dd class="tubepress-meta-<?php echo $attributeName; ?>"><?php
     ...
     */
    if ($attributeName === tubepress_app_media_item_api_Constants::ATTRIBUTE_HOME_URL):
    ?>
     ...
     */
    if ($attributeName === tubepress_app_media_item_api_Constants::ATTRIBUTE_AUTHOR_DISPLAY_NAME &&
        $mediaItem->hasAttribute(tubepress_app_media_item_api_Constants::ATTRIBUTE_AUTHOR_URL)): ?>
    <a ref="nofollow" target="_blank" href="<?php echo htmlspecialchars($mediaItem->getAttribute(tubepress_app_media_item_api_Constants::ATTRIBUTE_AUTHOR_URL), ENT_QUOTES, 'UTF-8'); ?>"><?php
    $anchorOpen = true;
    endif;
