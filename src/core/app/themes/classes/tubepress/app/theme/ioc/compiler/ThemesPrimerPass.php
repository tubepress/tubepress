 ...
 */
class tubepress_app_theme_ioc_compiler_ThemesPrimerPass implements tubepress_platform_api_ioc_CompilerPassInterface
{
    ...
    public function process(tubepress_platform_api_ioc_ContainerBuilderInterface $containerBuilder)
    {
        ...
        $registries    = $containerBuilder->findTaggedServiceIds(tubepress_platform_api_contrib_RegistryInterface::_);
        $themeRegistry = null;
        ...
        foreach ($registries as $id => $tagArray) {
            ...
            foreach ($tagArray as $tag) {
                ...
                if ($tag['type'] === tubepress_app_theme_api_ThemeInterface::_) {
        ...
        /**
         * @var $theme tubepress_app_theme_api_ThemeInterface
         */
