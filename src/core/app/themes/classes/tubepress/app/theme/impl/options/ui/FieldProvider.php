...
/**
 */
class tubepress_app_theme_impl_options_ui_FieldProvider implements tubepress_app_options_ui_api_FieldProviderInterface
{
    /**
    ...
    {
        return 'tubepress-core-theme-field-provider';
    }
