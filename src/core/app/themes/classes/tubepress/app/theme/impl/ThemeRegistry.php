 ...
 */
class tubepress_app_theme_impl_ThemeRegistry extends tubepress_platform_impl_contrib_AbstractRegistry
{
    private static $_LEGACY_THEME_NAME_PREFIX = 'unknown/legacy-';

    /**
     * @var tubepress_app_contrib_api_ContributableValidatorInterface
     */
    private $_validator;
    ...
    public function __construct(tubepress_platform_api_log_LoggerInterface                          $logger,
                                ...
                                tubepress_app_contrib_api_ContributableValidatorInterface $validator)
    {
    ...
    {
        $modernThemes = $this->findContributables('/web/themes', '/themes');
    ...
    protected function getOptionalAttributesMap()
    {
        return array(
            ...
            tubepress_app_theme_impl_ThemeBase::ATTRIBUTE_PARENT   => 'ParentThemeName',
            tubepress_app_theme_impl_ThemeBase::CATEGORY_RESOURCES => array(

                tubepress_app_theme_impl_ThemeBase::ATTRIBUTE_SCRIPTS => 'Scripts',
                tubepress_app_theme_impl_ThemeBase::ATTRIBUTE_STYLES  => 'Styles',
            ),
        );
    }
    ...
    {
        return 'tubepress_app_theme_impl_ThemeBase';
    }
    ...
    {
        if (!($element instanceof tubepress_app_theme_api_ThemeInterface)) {
    ...
    private function _findLegacyThemes(array $modernThemes)
    {
        ...
        foreach ($finder as $candidateLegacyThemeDir) {
            ...
            /**
             * @var $modernTheme tubepress_app_theme_api_ThemeInterface
             */
        ...
        foreach ($themesToKeep as $legacyThemeDirectory) {
            ...
            $theme = new tubepress_app_theme_impl_ThemeBase(
