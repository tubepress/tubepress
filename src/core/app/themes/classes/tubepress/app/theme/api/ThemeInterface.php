 ...
 * @since 4.0.0
 */
interface tubepress_app_theme_api_ThemeInterface extends tubepress_platform_api_contrib_ContributableInterface
{
    /**
     * @ignore
     */
    const _ = 'tubepress_app_theme_api_ThemeInterface';
