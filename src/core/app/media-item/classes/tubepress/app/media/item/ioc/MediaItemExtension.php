 ...
 *
 */
class tubepress_app_media_item_ioc_MediaItemExtension implements tubepress_platform_api_ioc_ContainerExtensionInterface
{
    ...
    public function load(tubepress_platform_api_ioc_ContainerBuilderInterface $containerBuilder)
    {
        ...
        $containerBuilder->setParameter(tubepress_app_options_api_Constants::IOC_PARAM_EASY_REFERENCE . '_media_item', array(
        ...
        $containerBuilder->setParameter(tubepress_app_options_api_Constants::IOC_PARAM_EASY_VALIDATION . '_media_item', array(
        ...
        $containerBuilder->register(
         ...
         ->addArgument(tubepress_app_media_item_api_Constants::OPTIONS_UI_CATEGORY_META)
        ...
        $containerBuilder->register(
         ...
         ->addArgument(array(new tubepress_platform_api_ioc_Reference('meta_category')))
