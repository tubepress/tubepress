...
/**
 */
class tubepress_app_media_item_impl_easy_EasyAttributeFormatter
{
    /**
     * @var tubepress_lib_util_api_TimeUtilsInterface
     */
    private $_timeUtils;
    ...
    public function __construct(tubepress_lib_util_api_TimeUtilsInterface  $timeUtils,
    ...
    private function _handleArrayImplosions(tubepress_app_media_item_api_MediaItem $mediaItem)
    {
    ...
    private function _handleDurations(tubepress_app_media_item_api_MediaItem $mediaItem)
    {
    ...
    private function _handleDates(tubepress_app_media_item_api_MediaItem $mediaItem)
    {
        $dateFormat = $this->_context->get(tubepress_app_media_item_api_Constants::OPTION_DATEFORMAT);
        $relative   = $this->_context->get(tubepress_app_media_item_api_Constants::OPTION_RELATIVE_DATES);
    ...
    private function _handleNumbers(tubepress_app_media_item_api_MediaItem $mediaItem)
    {
    ...
    private function _handleStringTruncations(tubepress_app_media_item_api_MediaItem $mediaItem)
    {
