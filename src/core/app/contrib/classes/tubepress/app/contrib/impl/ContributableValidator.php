 ...
 *
 */
class tubepress_app_contrib_impl_ContributableValidator implements tubepress_app_contrib_api_ContributableValidatorInterface
{
    /**
     ...
     * @since 4.0.0
     */
    public function getProblemMessage(tubepress_platform_api_contrib_ContributableInterface $contributable)
    {
        try {
     ...
     * @since 4.0.0
     */
    public function isValid(tubepress_platform_api_contrib_ContributableInterface $contributable)
    {
        return $this->getProblemMessage($contributable) === null;
    }

    private function _validateVersion(tubepress_platform_api_contrib_ContributableInterface $contributable)
    {
        try {

            tubepress_lib_version_api_Version::parse($contributable->getVersion());
    ...
    private function _validateScreenshots(tubepress_platform_api_contrib_ContributableInterface $contributable) {
    ...
    private function _validateLicenses(tubepress_platform_api_contrib_ContributableInterface $contributable)
    {
    ...
    private function _validateAuthor(tubepress_platform_api_contrib_ContributableInterface $contributable)
    {
    ...
    private function _validateUrlAttribute(tubepress_platform_api_contrib_ContributableInterface $contributable, $method, $name)
    {
