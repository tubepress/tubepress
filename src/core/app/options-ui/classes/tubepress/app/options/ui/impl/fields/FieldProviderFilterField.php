 ...
 */
class tubepress_app_options_ui_impl_fields_FieldProviderFilterField extends tubepress_app_options_ui_impl_fields_AbstractMultiSelectField
{
    ...
    {
        $optionName = tubepress_app_options_ui_api_Constants::OPTION_DISABLED_FIELD_PROVIDERS;
    ...
    protected function onSubmitAllMissing()
    {
        ...
        return $this->getOptionPersistence()->queueForSave(tubepress_app_options_ui_api_Constants::OPTION_DISABLED_FIELD_PROVIDERS, $newValue);
    }
