 ...
 *
 */
class tubepress_app_options_ui_impl_FieldBuilder implements tubepress_app_options_ui_api_FieldBuilderInterface
{
    /**
     ...
     *
     * @return tubepress_app_options_ui_api_FieldInterface A new instance of the field.
     *
    ...
    public function setThemeRegistry(tubepress_platform_api_contrib_RegistryInterface $themeRegistry)
    {
    ...
    private function _buildPerPageSort()
    {
        return new tubepress_app_options_ui_impl_fields_provided_PerPageSortField(
    ...
    {
        return new tubepress_app_options_ui_impl_fields_provided_OrderByField(
    ...
    {
        return new tubepress_app_options_ui_impl_fields_MetaMultiSelectField(
            $this->_translator,
            $this->_persistence,
            $this->_requestParams,
            $this->_eventDispatcher,
    ...
    {
        return new tubepress_app_options_ui_impl_fields_provided_ThemeField(
    ...
    {
        $toReturn = new tubepress_app_options_ui_impl_fields_provided_SpectrumColorField(
            $id,
            $this->_translator,
            $this->_persistence,
            $this->_requestParams,
    ...
    {
        $toReturn = new tubepress_app_options_ui_impl_fields_provided_TextField(
            $id,
            $this->_translator,
            $this->_persistence,
            $this->_requestParams,
    ...
    {
        return new tubepress_app_options_ui_impl_fields_provided_BooleanField(
            $id,
            $this->_translator,
            $this->_persistence,
            $this->_requestParams,
