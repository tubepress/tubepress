 ...
 */
abstract class tubepress_app_options_ui_impl_fields_AbstractTemplateBasedOptionsPageField extends tubepress_app_options_ui_impl_fields_AbstractOptionsPageField
{
    /**
    ...
    public function getWidgetHTML()
    {
        ...
        $this->_eventDispatcher->dispatch(tubepress_app_options_ui_api_Constants::EVENT_OPTIONS_UI_FIELD_TEMPLATE, $templateEvent);
