 ...
 */
class tubepress_app_options_ui_impl_fields_GallerySourceRadioField extends tubepress_app_options_ui_impl_fields_AbstractTemplateBasedOptionsPageField
{
    /**
    ...
    public function __construct($modeName,
                                ...
                                tubepress_app_options_ui_api_FieldInterface            $additionalField = null)
    {
        parent::__construct(
    ...
    {
        $currentMode = $this->_context->get(tubepress_app_media_provider_api_Constants::OPTION_GALLERY_SOURCE);
