 ...
 */
class tubepress_app_options_ui_impl_Form implements tubepress_app_options_ui_api_FormInterface
{
    /**
    ...
    /**
     * @var tubepress_app_options_ui_api_FieldProviderInterface[] Categories.
     */
    ...
    /**
     * @var tubepress_lib_template_api_TemplateInterface
     */
    private $_template;
    ...
    public function __construct(tubepress_lib_template_api_TemplateInterface       $template,
    ...
    public function getHTML(array $errors = array(), $justSubmitted = false)
    {
        ...
        $this->_eventDispatcher->dispatch(tubepress_app_options_ui_api_Constants::EVENT_OPTIONS_UI_PAGE_TEMPLATE, $templateEvent);
    ...
    {
        /**
         * @var tubepress_app_options_ui_api_FieldInterface[] $fields
         */
        $fields = $this->_buildFieldsArray();
        $errors = array();
     ...
     *
     * @param tubepress_app_options_ui_api_FieldProviderInterface[] $providers
     */
    ...
    private function _buildFieldsArray()
    {
        ...
        /**
         * @var $fields tubepress_app_options_ui_api_FieldInterface[]
         */
        foreach ($fields as $field) {
        ...
        if (isset($toReturn[tubepress_app_options_ui_impl_fields_FieldProviderFilterField::FIELD_ID])) {

            /**
             * @var $filterField tubepress_app_options_ui_impl_fields_FieldProviderFilterField
             */
            $filterField = $toReturn[tubepress_app_options_ui_impl_fields_FieldProviderFilterField::FIELD_ID];
    ...
    /**
     * @param tubepress_app_options_ui_api_ElementInterface[] $categories
     *
     * @return array
     */
