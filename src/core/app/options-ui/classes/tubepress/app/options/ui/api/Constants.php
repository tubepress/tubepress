 ...
 * @since 4.0.0
 */
interface tubepress_app_options_ui_api_Constants
{
    /**
     * This event is fired after TubePress builds the PHP/HTML template for a field on the options page.
     *
     * @subject `tubepress_lib_template_api_TemplateInterface` The template for the field.
     *
     * @argument <var>field</var> (`tubepress_app_options_ui_api_FieldInterface`): The backing field.
     *
     * @api
     * @since 4.0.0
     */
     ...
     *
     * @subject `tubepress_lib_template_api_TemplateInterface` The template for the page.
     *
     * @api
     * @since 4.0.0
     */
