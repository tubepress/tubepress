 ...
 *
 */
class tubepress_app_options_ui_impl_ElementBuilder implements tubepress_app_options_ui_api_ElementBuilderInterface
{
    /**
     ...
     *
     * @return tubepress_app_options_ui_api_ElementInterface A new instance of the field.
     *
     * @api
     * @since 4.0.0
     */
    ...
    {
        return new tubepress_app_options_ui_impl_BaseElement($id, $this->_translator, $untranslatedDisplayName);
    }
}