 ...
 */
class tubepress_app_options_ui_impl_fields_provided_ThemeField extends tubepress_app_options_ui_impl_fields_provided_DropdownField
{
    /**
    ...
    private function _buildThemeData(tubepress_app_theme_api_ThemeInterface $theme)
    {
        return array(
