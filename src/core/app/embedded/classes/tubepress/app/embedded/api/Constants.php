 ...
 * @since 4.0.0
 */
interface tubepress_app_embedded_api_Constants
{
    /**
     * This event is fired when TubePress builds the PHP/HTML template for an embedded
     * media player.
     *
     * @subject `tubepress_lib_template_api_TemplateInterface` The embedded media player template.
     *
     * @argument <var>itemId</var> (`string`): The ID of the item to be viewed. (since 4.0.0)
     * @argument <var>mediaProvider</var> (`tubepress_app_media_provider_api_MediaProviderInterface`): The item's media provider. (since 4.0.0)
     * @argument <var>dataUrl</var> (`tubepress_lib_url_api_UrlInterface`): The embedded data URL. (since 4.0.0)
     * @argument <var>embeddedProvider</var> (`tubepress_app_embedded_api_EmbeddedProviderInterface`): The embedded provider. (since 4.0.0)
     *
     * @api
     * @since 4.0.0
     */
