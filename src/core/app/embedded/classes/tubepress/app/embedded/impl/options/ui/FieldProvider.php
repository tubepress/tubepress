...
/**
 */
class tubepress_app_embedded_impl_options_ui_FieldProvider implements tubepress_app_options_ui_api_FieldProviderInterface
{
    /**
    ...
    {
        return 'tubepress-core-embedded-field-provider';
    }
    ...
    /**
     * @return tubepress_app_options_ui_api_FieldInterface[] The fields that this options page field provider provides.
     *
     * @api
     * @since 4.0.0
     */
