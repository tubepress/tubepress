 ...
 * @since 4.0.0
 */
interface tubepress_app_embedded_api_EmbeddedProviderInterface
{
    /**
     * @ignore
     */
    const _ = 'tubepress_app_embedded_api_EmbeddedProviderInterface';
     ...
     * @param tubepress_app_media_provider_api_MediaProviderInterface $provider   The media provider
     * @param string                                                   $mediaId    The media ID to play
     *
     * @return tubepress_lib_url_api_UrlInterface The URL of the data for this item.
     *
     * @api
     * @since 4.0.0
     */
    function getDataUrlForMediaItem(tubepress_lib_url_api_UrlFactoryInterface               $urlFactory,
