 ...
 * @since 4.0.0
 */
interface tubepress_app_html_api_Constants
{
    /**
     ...
     *
     * @subject `tubepress_lib_url_api_UrlInterface[]` An array of URLs for the stylesheets that TubePress will print in the HTML <head>
     *
     * @api
     * @since 4.0.0
     */
     ...
     *
     * @subject `tubepress_lib_url_api_UrlInterface[]` An array of URLs for the scripts that TubePress will print in the HTML <head>
