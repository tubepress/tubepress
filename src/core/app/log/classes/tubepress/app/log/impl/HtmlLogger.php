 ...
 *
 */
class tubepress_app_log_impl_HtmlLogger implements tubepress_platform_api_log_LoggerInterface
{
    /**
     * @var boolean
     */
                                ...
                                tubepress_app_http_api_RequestParametersInterface $requestParams)
    {
        ...
        $loggingEnabled           = $context->get(tubepress_app_log_api_Constants::OPTION_DEBUG_ON);
