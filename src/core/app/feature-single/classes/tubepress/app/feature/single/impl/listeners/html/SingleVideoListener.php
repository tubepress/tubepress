 ...
 */
class tubepress_app_feature_single_impl_listeners_html_SingleVideoListener
{
    /**
    ...
    {
        $mediaItemId = $this->_context->get(tubepress_app_feature_single_api_Constants::OPTION_MEDIA_ITEM_ID);
    ...
    private function _getSingleVideoHtml(tubepress_lib_event_api_EventInterface $event, $itemId)
    {
        $template = $this->_templateFactory->fromFilesystem(array(

            'single_video.tpl.php',
            TUBEPRESS_ROOT . '/web/themes/default/single_video.tpl.php'
        ));
        ...
        if ($this->_eventDispatcher->hasListeners(tubepress_app_feature_single_api_Constants::EVENT_SINGLE_ITEM_TEMPLATE)) {
            ...
            $this->_eventDispatcher->dispatch(
                ...
                tubepress_app_feature_single_api_Constants::EVENT_SINGLE_ITEM_TEMPLATE,
                $templateEvent
            );
        ...
        if ($this->_eventDispatcher->hasListeners(tubepress_app_feature_single_api_Constants::EVENT_SINGLE_ITEM_HTML)) {

            $htmlEvent = $this->_eventDispatcher->newEventInstance($html);

            $this->_eventDispatcher->dispatch(

                tubepress_app_feature_single_api_Constants::EVENT_SINGLE_ITEM_HTML,
                $htmlEvent
            );
