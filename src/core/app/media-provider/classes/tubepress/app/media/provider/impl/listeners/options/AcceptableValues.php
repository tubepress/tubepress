 ...
 *
 */
class tubepress_app_media_provider_impl_listeners_options_AcceptableValues
{
    /**
    ...
    public function onMode(tubepress_lib_event_api_EventInterface $event)
    {
        $this->_handle($event, 'getGallerySourceNames');
    }

    public function onOrderBy(tubepress_lib_event_api_EventInterface $event)
    {
        $this->_handle($event, 'getMapOfFeedSortNamesToUntranslatedLabels');
    }

    public function onPerPageSort(tubepress_lib_event_api_EventInterface $event)
    {
        $this->_handle($event, 'getMapOfPerPageSortNamesToUntranslatedLabels');
    }

    private function _handle(tubepress_lib_event_api_EventInterface $event, $methodName)
    {
