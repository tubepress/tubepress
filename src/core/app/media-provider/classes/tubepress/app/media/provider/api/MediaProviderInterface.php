 ...
 * @since 4.0.0
 */
interface tubepress_app_media_provider_api_MediaProviderInterface
{
    /**
     * @ignore
     */
    const _ = 'tubepress_app_media_provider_api_MediaProviderInterface';
     ...
     * @return int
     */
    function compareForPerPageSort(tubepress_app_media_item_api_MediaItem $first,
