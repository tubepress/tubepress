 ...
 */
class tubepress_app_media_provider_impl_Collector implements tubepress_app_media_provider_api_CollectorInterface
{
    /**
     ...
     *
     * @return tubepress_app_media_provider_api_Page The media gallery page, never null.
     *
     * @api
     * @since 4.0.0
     */
    ...
    {
        $mediaSource  = $this->_context->get(tubepress_app_media_provider_api_Constants::OPTION_GALLERY_SOURCE);
        $result       = null;
        $providerName = null;
        ...
        if ($result === null) {
            ...
            $result = new tubepress_app_media_provider_api_Page();
        }
        ...
        $this->_eventDispatcher->dispatch(
            ...
            tubepress_app_media_provider_api_Constants::EVENT_NEW_MEDIA_PAGE,
            $event
        );
     ...
     *
     * @return tubepress_app_media_item_api_MediaItem The media item, or null not found.
     *
     * @api
     * @since 4.0.0
     */
    ...
    {
        $page = $this->_requestParams->getParamValueAsInt(tubepress_lib_http_api_Constants::PARAM_NAME_PAGE, 1);
