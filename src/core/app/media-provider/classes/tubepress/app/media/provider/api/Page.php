 ...
 * @since 4.0.0
 */
class tubepress_app_media_provider_api_Page
{
    /**
     * @var int
     */
     ...
     *
     * @param tubepress_app_media_item_api_MediaItem[] $items The media item array.
     *
     * @return void
     *
     * @api
     ...
     *
     * @return tubepress_app_media_item_api_MediaItem[] The media item array. May be empty but never null.
     *
     * @api
     * @since 4.0.0
     */
