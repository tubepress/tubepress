 ...
 */
class tubepress_app_feature_gallery_impl_listeners_template_PaginationTemplateListener
{
    ...
    {
        /**
         * @var $providerResult tubepress_app_media_provider_api_Page
         */
        $providerResult = $event->getArgument('page');

        /**
         * @var $template tubepress_lib_template_api_TemplateInterface $template
         */
        ...
        $this->_eventDispatcher->dispatch(
            ...
            tubepress_app_feature_gallery_api_Constants::EVENT_HTML_PAGINATION,
            $event
        );
        ...
        if ($this->_context->get(tubepress_app_feature_gallery_api_Constants::OPTION_PAGINATE_ABOVE)) {

            $context[tubepress_app_feature_gallery_api_Constants::TEMPLATE_VAR_PAGINATION_TOP] = $pagination;
        }

        if ($this->_context->get(tubepress_app_feature_gallery_api_Constants::OPTION_PAGINATE_BELOW)) {

            $context[tubepress_app_feature_gallery_api_Constants::TEMPLATE_VAR_PAGINATION_BOTTOM] = $pagination;
        }
    ...
    {
        $currentPage = $this->_requestParams->getParamValueAsInt(tubepress_lib_http_api_Constants::PARAM_NAME_PAGE, 1);
        $vidsPerPage = $this->_context->get(tubepress_app_media_provider_api_Constants::OPTION_RESULTS_PER_PAGE);
    ...
    private function _paginationFromTemplate($totalItems, $currentPage, $perPage, tubepress_lib_url_api_UrlInterface $url)
    {
        $template = $this->_templateFactory->fromFilesystem(array(
            
            'pagination.tpl.php',
            TUBEPRESS_ROOT . '/web/themes/default/pagination.tpl.php'
        ));
        ...
        $vars      = array(
            ...
            tubepress_app_feature_gallery_api_Constants::TEMPLATE_VAR_PAGINATION_CURRENT_PAGE     => $currentPage,
            tubepress_app_feature_gallery_api_Constants::TEMPLATE_VAR_PAGINATION_TOTAL_ITEMS      => $totalItems,
            tubepress_app_feature_gallery_api_Constants::TEMPLATE_VAR_PAGINATION_HREF_FORMAT      => $urlFormat,
            tubepress_app_feature_gallery_api_Constants::TEMPLATE_VAR_PAGINATION_RESULTS_PER_PAGE => $perPage,
            tubepress_app_feature_gallery_api_Constants::TEMPLATE_VAR_PAGINATION_TEXT_NEXT        => $this->_translator->_('next'),
            tubepress_app_feature_gallery_api_Constants::TEMPLATE_VAR_PAGINATION_TEXT_PREV        => $this->_translator->_('prev'),
        );
        ...
        $this->_eventDispatcher->dispatch(tubepress_app_feature_gallery_api_Constants::EVENT_TEMPLATE_PAGINATION, $event);
     ...
     * @return string The HTML for the pagination
     */
    private function _diggStyle($totalitems, $page = 1, $limit = 15, $adjacents = 1, tubepress_lib_url_api_UrlInterface $url, $pagestring = '?page=')
    {
