 ...
 */
class tubepress_app_options_impl_listeners_StringMagic
{
    /**
    ...
    public function onExternalInput(tubepress_lib_event_api_EventInterface $event)
    {
    ...
    public function onSet(tubepress_lib_event_api_EventInterface $event)
    {
