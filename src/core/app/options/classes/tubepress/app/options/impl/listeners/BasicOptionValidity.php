 ...
 *
 */
class tubepress_app_options_impl_listeners_BasicOptionValidity
{
    /**
    ...
    public function __construct(tubepress_app_options_api_ReferenceInterface        $optionsReference,
