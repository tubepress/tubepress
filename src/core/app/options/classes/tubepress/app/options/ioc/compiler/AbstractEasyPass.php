 ...
 *
 */
abstract class tubepress_app_options_ioc_compiler_AbstractEasyPass implements tubepress_platform_api_ioc_CompilerPassInterface
{
    /**
    ...
    {
        $this->_stringUtils = $containerBuilder->get(tubepress_platform_api_util_StringUtilsInterface::_);
        $this->_langUtils   = $containerBuilder->get(tubepress_platform_api_util_LangUtilsInterface::_);
        $this->_logger      = $containerBuilder->get('tubepress_platform_impl_log_BootLogger');
    ...
    /**
     * @return tubepress_platform_api_util_StringUtilsInterface
     */
    ...
    private function _isValid($paramName, $paramValue, tubepress_platform_api_ioc_ContainerBuilderInterface $containerBuilder)
    {
    ...
    private function _findCandidateParameters(tubepress_platform_api_ioc_ContainerBuilderInterface $containerBuilder)
    {
