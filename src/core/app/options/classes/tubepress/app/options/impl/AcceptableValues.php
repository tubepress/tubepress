 ...
 *
 */
class tubepress_app_options_impl_AcceptableValues implements tubepress_app_options_api_AcceptableValuesInterface
{
    /**
    ...
    public function getAcceptableValues($optionName)
    {
        ...
        $this->_eventDispatcher->dispatch(
            ...
            tubepress_app_options_api_Constants::EVENT_OPTION_GET_ACCEPTABLE_VALUES . ".$optionName",
            $event
        );
