 ...
 */
class tubepress_app_http_impl_PrimaryAjaxHandler implements tubepress_app_http_api_AjaxCommandInterface
{
    /**
    ...
    public function handle()
    {
        ...
        $actionName = $this->_requestParameters->getParamValue(tubepress_lib_http_api_Constants::PARAM_NAME_ACTION);
        ...
        /**
         * @var $commandHandler tubepress_app_http_api_AjaxCommandInterface
         */
    ...
    public function setAjaxCommands(array $handlers)
    {
