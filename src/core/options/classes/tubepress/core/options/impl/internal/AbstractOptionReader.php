 ...
 *
 */
class tubepress_core_options_impl_internal_AbstractOptionReader
{
    /**
    ...
    {
        $event = $this->_dispatch($optionName, $optionValue, array(), tubepress_core_options_api_Constants::EVENT_OPTION_SET);
