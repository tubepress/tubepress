 ...
 * from a shortcode
 */
class tubepress_core_options_impl_Context extends tubepress_core_options_impl_internal_AbstractOptionReader implements tubepress_core_options_api_ContextInterface
{
    /**
