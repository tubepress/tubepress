 ...
 *
 */
class tubepress_core_options_ioc_compiler_EasyReferencesPass extends tubepress_core_options_ioc_compiler_AbstractEasyPass
{
    ...
    protected function processParameter($paramName, array $paramValue, tubepress_api_ioc_ContainerBuilderInterface $containerBuilder)
    {
        $definition = $containerBuilder->register(
            ...
            'tubepress_core_options_impl_easy_EasyReference'
         ...
         ->addTag(tubepress_core_options_api_ReferenceInterface::_);

        $this->_addOptionalMethodCalls($definition, $paramValue);
    }

    private function _validStringSets(array $param, tubepress_api_util_LangUtilsInterface $langUtils)
    {
    ...
    private function _validStringMaps(array $param, tubepress_api_util_LangUtilsInterface $langUtils)
    {
    ...
    private function _addOptionalMethodCalls(tubepress_api_ioc_DefinitionInterface $definition, array $paramValue)
    {
    ...
    {
        return tubepress_core_options_api_Constants::IOC_PARAM_EASY_REFERENCE;
    }
