 ...
 *
 */
class tubepress_core_options_ioc_compiler_EasyTrimmersPass extends tubepress_core_options_ioc_compiler_AbstractEasyPass
{
    ...
    {
        return tubepress_core_options_api_Constants::IOC_PARAM_EASY_TRIMMER;
    }
