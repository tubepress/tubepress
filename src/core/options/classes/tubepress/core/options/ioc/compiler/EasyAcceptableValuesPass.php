 ...
 *
 */
class tubepress_core_options_ioc_compiler_EasyAcceptableValuesPass extends tubepress_core_options_ioc_compiler_AbstractEasyPass
{
    ...
    protected function processParameter($paramName, array $paramValue, tubepress_api_ioc_ContainerBuilderInterface $containerBuilder)
    {
        $containerBuilder->register(
            ...
            'tubepress_core_options_impl_easy_EasyAcceptableValuesListener'
        )->addArgument($paramValue[self::$_KEY_VALUES])
         ->addTag(tubepress_core_ioc_api_Constants::TAG_EVENT_LISTENER, array(
            'event'    => tubepress_core_options_api_Constants::EVENT_OPTION_GET_ACCEPTABLE_VALUES . '.' . $paramValue[self::$_KEY_OPTION_NAME],
    ...
    {
        return tubepress_core_options_api_Constants::IOC_PARAM_EASY_ACCEPTABLE_VALUES;
    }
