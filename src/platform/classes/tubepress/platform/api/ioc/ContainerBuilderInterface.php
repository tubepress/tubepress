...
/**
 * Provides utility functions used during construction of a {@link tubepress_platform_api_ioc_ContainerInterface} instance.
 *
 ...
 * @since 4.0.0
 */
interface tubepress_platform_api_ioc_ContainerBuilderInterface extends tubepress_platform_api_ioc_ContainerInterface
{
    /**
     * @ignore
     */
    const _ = 'tubepress_platform_api_ioc_ContainerBuilderInterface';
     ...
     *
     * @param string                                $id         The service identifier
     * @param tubepress_platform_api_ioc_DefinitionInterface $definition The service definition.
     *
     ...
     * @since 4.0.0
     */
    function setDefinition($id, tubepress_platform_api_ioc_DefinitionInterface $definition);
