 ...
 */
class tubepress_impl_ioc_ContainerBuilder extends tubepress_impl_ioc_Container implements tubepress_api_ioc_ContainerBuilderInterface, tubepress_api_ioc_CompilerPassInterface
{
    /**
    ...
    public function process(tubepress_api_ioc_ContainerBuilderInterface $self)
    {
        ...
        foreach ($this->_tubePressContainerExtensions as $extension) {
            ...
            $tmpContainer = new tubepress_impl_ioc_ContainerBuilder($this->_delegateContainerBuilder->getParameterBag());
     ...
     * @internal
     */
    private function merge(tubepress_impl_ioc_ContainerBuilder $containerBuilder)
    {
    ...
    {
        return tubepress_impl_ioc_Definition::fromIconicDefinition($definition);
    }

    public function toIconicDefinition(tubepress_api_ioc_DefinitionInterface $definition)
    {
        if ($definition instanceof tubepress_impl_ioc_Definition) {
