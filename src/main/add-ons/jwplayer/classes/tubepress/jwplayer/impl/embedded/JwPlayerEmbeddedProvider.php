 ...
 */
class tubepress_jwplayer_impl_embedded_JwPlayerEmbeddedProvider implements tubepress_core_embedded_api_EmbeddedProviderInterface
{
    /**
    ...
    public function getPathsForTemplateFactory()
    {
        return array(
            ...
            TUBEPRESS_ROOT . '/src/main/add-ons/jwplayer/resources/templates'
        );
    }
