 ...
 */
class tubepress_core_options_ui_impl_fields_GallerySourceField extends tubepress_core_options_ui_impl_fields_AbstractOptionsPageField
{
    ...
    {
        parent::__construct(tubepress_core_media_gallery_api_Constants::OPTION_GALLERY_SOURCE, $translator, $persistence, $requestParams);
    }
    ...
    {
        $fieldName = tubepress_core_media_gallery_api_Constants::OPTION_GALLERY_SOURCE;
