 ...
 */
abstract class tubepress_core_options_ui_impl_fields_provided_AbstractProvidedOptionBasedField extends tubepress_core_options_ui_impl_fields_AbstractTemplateBasedOptionsPageField
{
    /**
