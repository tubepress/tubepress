 ...
 *
 */
class tubepress_core_media_search_ioc_SearchExtension implements tubepress_api_ioc_ContainerExtensionInterface
{
    ...
    public function load(tubepress_api_ioc_ContainerBuilderInterface $containerBuilder)
    {
        ...
        $containerBuilder->register(
         ...
         ->addArgument(new tubepress_api_ioc_Reference(tubepress_core_options_api_ContextInterface::_))
         ->addArgument(new tubepress_api_ioc_Reference('tubepress_core_media_gallery_impl_listeners_html_GalleryMaker'))
