 ...
 */
class tubepress_core_media_search_impl_listeners_template_SearchInputCoreVariables
{
    /**
    ...
    public function onSearchInputTemplate(tubepress_core_event_api_EventInterface $event)
    {
        ...
        $resultsUrl = $this->_context->get(tubepress_core_media_search_api_Constants::OPTION_SEARCH_RESULTS_URL);
        $url        = '';
