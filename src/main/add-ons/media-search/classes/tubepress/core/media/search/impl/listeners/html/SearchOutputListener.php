 ...
 */
class tubepress_core_media_search_impl_listeners_html_SearchOutputListener
{
    /**
    ...
    public function __construct(tubepress_api_log_LoggerInterface $logger,
                                ...
                                tubepress_core_media_gallery_impl_listeners_html_GalleryMaker      $thumbGalleryShortcodeHandler,
    ...
    public function onHtmlGeneration(tubepress_core_event_api_EventInterface $event)
    {
        ...
        if ($this->_context->get(tubepress_core_html_api_Constants::OPTION_OUTPUT) !== tubepress_core_media_search_api_Constants::OUTPUT_SEARCH_RESULTS) {
        ...
        $mustShowSearchResults = $this->_context->get(tubepress_core_media_search_api_Constants::OPTION_SEARCH_RESULTS_ONLY);
    ...
    private function _handle(tubepress_core_event_api_EventInterface $event)
    {
        ...
        switch ($this->_context->get(tubepress_core_media_search_api_Constants::OPTION_SEARCH_PROVIDER)) {

            case 'vimeo':

                $this->_context->set(tubepress_core_media_gallery_api_Constants::OPTION_GALLERY_SOURCE, tubepress_vimeo_api_Constants::GALLERYSOURCE_VIMEO_SEARCH);
            ...
            default:
                ...
                $this->_context->set(tubepress_core_media_gallery_api_Constants::OPTION_GALLERY_SOURCE, tubepress_youtube_api_Constants::GALLERYSOURCE_YOUTUBE_SEARCH);
