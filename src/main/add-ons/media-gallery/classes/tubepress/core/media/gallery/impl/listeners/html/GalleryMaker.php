...
class tubepress_core_media_gallery_impl_listeners_html_GalleryMaker
{
    /**
    ...
    public function onHtmlGeneration(tubepress_core_event_api_EventInterface $event)
    {
        ...
        if ($this->_eventDispatcher->hasListeners(tubepress_core_media_gallery_api_Constants::EVENT_TEMPLATE_THUMBNAIL_GALLERY)) {
            ...
            $this->_eventDispatcher->dispatch(
                ...
                tubepress_core_media_gallery_api_Constants::EVENT_TEMPLATE_THUMBNAIL_GALLERY,
                $templateEvent
            );
        ...
        if ($this->_eventDispatcher->hasListeners(tubepress_core_media_gallery_api_Constants::EVENT_HTML_THUMBNAIL_GALLERY)) {
            ...
            $this->_eventDispatcher->dispatch(
                ...
                tubepress_core_media_gallery_api_Constants::EVENT_HTML_THUMBNAIL_GALLERY,
                $htmlEvent
            );
