 ...
 * @since 4.0.0
 */
interface tubepress_core_media_gallery_api_Constants
{
    /**
     ...
     *
     * @argument <var>page</var> (`{@link tubepress_core_provider_api_Page}`): The backing {@link tubepress_core_provider_api_Page}.
