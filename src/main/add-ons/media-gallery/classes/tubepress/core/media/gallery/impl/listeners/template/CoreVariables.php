 ...
 */
class tubepress_core_media_gallery_impl_listeners_template_CoreVariables
{
    /**
    ...
    public function onGalleryTemplate(tubepress_core_event_api_EventInterface $event)
    {
        ...
        $thumbWidth  = $this->_context->get(tubepress_core_media_gallery_api_Constants::OPTION_THUMB_WIDTH);
        $thumbHeight = $this->_context->get(tubepress_core_media_gallery_api_Constants::OPTION_THUMB_HEIGHT);
