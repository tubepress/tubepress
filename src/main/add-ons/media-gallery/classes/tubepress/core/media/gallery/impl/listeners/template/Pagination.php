 ...
 */
class tubepress_core_media_gallery_impl_listeners_template_Pagination
{
    ...
    public function onGalleryTemplate(tubepress_core_event_api_EventInterface $event)
    {
        ...
        $this->_eventDispatcher->dispatch(
            ...
            tubepress_core_media_gallery_api_Constants::EVENT_HTML_PAGINATION,
            $event
        );
        ...
        if ($this->_context->get(tubepress_core_media_gallery_api_Constants::OPTION_PAGINATE_ABOVE)) {

            $context[tubepress_core_template_api_const_VariableNames::PAGINATION_TOP] = $pagination;
        }

        if ($this->_context->get(tubepress_core_media_gallery_api_Constants::OPTION_PAGINATE_BELOW)) {
    ...
    private function _getHtml($vidCount)
    {
        ...
        $vidsPerPage = $this->_context->get(tubepress_core_provider_api_Constants::OPTION_RESULTS_PER_PAGE);
    ...
    private function _paginationFromTemplate($totalItems, $currentPage, $perPage, tubepress_core_url_api_UrlInterface $url)
    {
        ...
        $this->_eventDispatcher->dispatch(tubepress_core_media_gallery_api_Constants::EVENT_TEMPLATE_PAGINATION, $event);
