 ...
 */
class tubepress_core_url_impl_puzzle_PuzzleBasedUrl implements tubepress_core_url_api_UrlInterface
{
    /**
     * @var tubepress_core_url_api_QueryInterface
     */
    private $_query = null;
    ...
    public function __construct(puzzle_Url $delegate)
    {
        ...
        if ($this->_delegateUrl->getQuery()) {
            ...
            $this->_query = new tubepress_core_url_impl_puzzle_PuzzleBasedQuery($this->_delegateUrl->getQuery());
        }
    }
    ...
    public function setQuery($query)
    {
        ...
        if ($query instanceof tubepress_core_url_api_QueryInterface) {
        ...
        $this->_query = new tubepress_core_url_impl_puzzle_PuzzleBasedQuery($puzzleQuery);
