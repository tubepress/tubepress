 ...
 * Puzzle-based stream.
 */
abstract class tubepress_core_http_impl_puzzle_AbstractMessage implements tubepress_core_http_api_message_MessageInterface
{
    /**
     ...
     *
     * @return tubepress_core_http_api_message_MessageInterface Self.
     *
     * @api
     * @since 4.0.0
     */
     ...
     *
     * @return tubepress_core_stream_api_StreamInterface|null
     *
     * @api
     * @since 4.0.0
     */
     ...
     *
     * The body MUST be a tubepress_core_stream_api_StreamInterface object. Setting the body to null MUST
     * remove the existing body.
     *
     * @param tubepress_core_stream_api_StreamInterface|null $body Body.
     *
     * @return tubepress_core_http_api_message_MessageInterface Self.
     *
     * @api
     * @since 4.0.0
     */
    public function setBody(tubepress_core_stream_api_StreamInterface $body = null)
    {
        if ($body !== null && (!($body instanceof tubepress_core_stream_impl_puzzle_FlexibleStream))) {

            $body = new tubepress_core_stream_impl_puzzle_FlexibleStream($body);
        }
