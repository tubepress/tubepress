 ...
 * Parses shortcodes.
 */
class tubepress_core_shortcode_impl_Parser implements tubepress_core_shortcode_api_ParserInterface
{
    /**
    ...
    {
        $keyword = $this->_context->get(tubepress_core_shortcode_api_Constants::OPTION_KEYWORD);
    ...
    private function _buildNameValuePairArray($match)
    {
        ...
        foreach ($match as $m) {
            ...
            $this->_eventDispatcher->dispatch(
                ...
                tubepress_core_options_api_Constants::EVENT_NVP_READ_FROM_EXTERNAL_INPUT,
                $event
            );
            ...
            $this->_eventDispatcher->dispatch(
                ...
                tubepress_core_options_api_Constants::EVENT_NVP_READ_FROM_EXTERNAL_INPUT . ".$name",
                $event
            );
