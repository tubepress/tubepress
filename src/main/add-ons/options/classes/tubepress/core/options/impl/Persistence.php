 ...
 *
 */
class tubepress_core_options_impl_Persistence extends tubepress_core_options_impl_internal_AbstractOptionReader implements tubepress_core_options_api_PersistenceInterface
{
    /**
     * @var array
     */
    ...
    /**
     * @var tubepress_core_options_api_PersistenceBackendInterface
     */
    private $_backend;

    public function __construct(tubepress_core_options_api_PersistenceBackendInterface $backend,
