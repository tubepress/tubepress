 ...
 */
class tubepress_core_options_impl_Reference implements tubepress_core_options_api_ReferenceInterface
{
    /**
     * @var array
     */
    ...
    public function getDefaultValue($optionName)
    {
        ...
        return $this->_dispatchAndGetResult(
            ...
            $optionName,
            $raw,
            tubepress_core_options_api_Constants::EVENT_OPTION_GET_DEFAULT_VALUE
        );
    }
    ...
    public function getUntranslatedDescription($optionName)
    {
        ...
        return $this->_dispatchAndGetResult(
            ...
            $optionName,
            $raw,
            tubepress_core_options_api_Constants::EVENT_OPTION_GET_DESCRIPTION
        );
    }
    ...
    public function getUntranslatedLabel($optionName)
    {
        ...
        return $this->_dispatchAndGetResult(
            ...
            $optionName,
            $raw,
            tubepress_core_options_api_Constants::EVENT_OPTION_GET_LABEL
        );
    }
