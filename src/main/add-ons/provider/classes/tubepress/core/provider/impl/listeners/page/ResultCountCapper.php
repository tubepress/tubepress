 ...
 */
class tubepress_core_provider_impl_listeners_page_ResultCountCapper
{
    /**
    ...
    public function onVideoGalleryPage(tubepress_core_event_api_EventInterface $event)
    {
        ...
        $limit        = $this->_context->get(tubepress_core_provider_api_Constants::OPTION_RESULT_COUNT_CAP);
