 ...
 */
class tubepress_core_provider_impl_Collector implements tubepress_core_provider_api_CollectorInterface
{
    /**
     ...
     *
     * @return tubepress_core_provider_api_Page The video gallery page, never null.
     *
     * @api
     * @since 4.0.0
     */
    ...
    {
        $videoSource           = $this->_context->get(tubepress_core_media_gallery_api_Constants::OPTION_GALLERY_SOURCE);
        $result                = null;
        $providerName          = null;
        ...
        foreach ($this->_videoProviders as $videoProvider) {
            ...
            if (in_array($videoSource, $sources)) {
                ...
                $result = $videoProvider->fetchPage($currentPage);
        ...
        if ($result === null) {
            ...
            $result = new tubepress_core_provider_api_Page();
        }
        ...
        $this->_eventDispatcher->dispatch(
            ...
            tubepress_core_provider_api_Constants::EVENT_NEW_MEDIA_PAGE,
            $event
        );
     ...
     *
     * @return tubepress_core_provider_api_MediaItem The video, or null not found.
     *
     * @api
     * @since 4.0.0
     */
    public final function collectSingle($id)
    {
        ...
        foreach ($this->_videoProviders as $videoProvider) {
            ...
            if ($videoProvider->recognizesItemId($id)) {
                ...
                return $videoProvider->fetchSingle($id);
            }
