 ...
 * @since 4.0.0
 */
interface tubepress_core_provider_api_MediaProviderInterface
{
    /**
     * @ignore
     */
    const _ = 'tubepress_core_provider_api_MediaProviderInterface';
     ...
     * @since 4.0.0
     */
    function getAttributeNameOfItemDescription();
     ...
     * @since 4.0.0
     */
    function getAttributeNameOfItemTitle();
     ...
     * @since 4.0.0
     */
    function getAttributeNameOfItemId();
     ...
     * @since 4.0.0
     */
    function getAttributeNamesOfIntegersToFormat();
     ...
     * @since 4.0.0
     */
    function getMapOfFormattedDateAttributeNamesToUnixTimeAttributeNames();
     ...
     * @since 4.0.0
     */
    function getMapOfHhMmSsAttributeNamesToSecondsAttributeNames();
     ...
     * @return int
     */
    function compareForPerPageSort(tubepress_core_provider_api_MediaItem $first,
