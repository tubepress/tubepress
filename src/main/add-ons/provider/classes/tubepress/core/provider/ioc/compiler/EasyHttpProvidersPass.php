 ...
 *
 */
class tubepress_core_provider_ioc_compiler_EasyHttpProvidersPass implements tubepress_api_ioc_CompilerPassInterface
{
    /**
    ...
    {
        $simpleProviderIds = $containerBuilder->findTaggedServiceIds(tubepress_core_provider_api_HttpProviderInterface::_);
        ...
        foreach ($simpleProviderIds as $simpleProviderId => $tags) {
            ...
            $containerBuilder->register(
             ...
             ->addTag(tubepress_core_provider_api_MediaProviderInterface::_);
        }
    }
}