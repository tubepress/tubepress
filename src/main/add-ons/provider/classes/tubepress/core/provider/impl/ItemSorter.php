 ...
 * @since 4.0.0
 */
class tubepress_core_provider_impl_ItemSorter implements tubepress_core_provider_api_ItemSorterInterface
{
    public function numericSort(tubepress_core_provider_api_MediaItem $first,
