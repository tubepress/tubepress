 ...
 * @since 4.0.0
 */
class tubepress_core_provider_api_Page
{
    /**
     * @var int
     */
     ...
     * Set the video array
     *
     * @param tubepress_core_provider_api_MediaItem[] $videos The video array.
     *
     * @return void
     *
     * @api
     * @since 4.0.0
     */
    public function setItems(array $videos)
    {
     ...
     * Get the video array
     *
     * @return tubepress_core_provider_api_MediaItem[] The video array. May be empty but never null.
     *
     * @api
     * @since 4.0.0
     */
