...
<div class="tubepress_container tubepress_sidebar" id="tubepress_gallery_<?php echo ${tubepress_core_api_const_template_Variable::GALLERY_ID}; ?>">
                ...
                <div class="tubepress_thumb">
                    ...
                    <dl class="tubepress_meta_group" style="width: 100%">
                        ...
                        <?php if (${tubepress_core_api_const_template_Variable::META_SHOULD_SHOW}[tubepress_core_api_const_options_Names::AUTHOR]): ?>
                            ...
                            <dt class="tubepress_meta tubepress_meta_author"><?php echo ${tubepress_core_api_const_template_Variable::META_LABELS}[tubepress_core_api_const_options_Names::AUTHOR]; ?></dt><dd class="tubepress_meta tubepress_meta_author"><?php echo $video->getAuthorDisplayName(); ?></dd>
                        <?php endif; ?>

                        <?php if (${tubepress_core_api_const_template_Variable::META_SHOULD_SHOW}[tubepress_core_api_const_options_Names::KEYWORDS]): ?>

                            <dt class="tubepress_meta tubepress_meta_keywords"><?php echo ${tubepress_core_api_const_template_Variable::META_LABELS}[tubepress_core_api_const_options_Names::KEYWORDS]; ?></dt><dd class="tubepress_meta tubepress_meta_keywords"><?php echo $raw = htmlspecialchars(implode(" ", $video->getKeywords()), ENT_QUOTES, "UTF-8"); ?></dd>
                        <?php endif; ?>
