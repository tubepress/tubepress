 ...
 */
class tubepress_impl_addon_Registry extends tubepress_impl_contrib_AbstractRegistry implements tubepress_api_contrib_RegistryInterface
{
    /**
    ...
    {
        return $this->findContributables('/src/main/add-ons', '/add-ons');
    }
    ...
    protected function getOptionalAttributesMap()
    {
        return array(
            ...
            tubepress_impl_addon_AddonBase::CATEGORY_IOC                  => array(
                ...
                tubepress_impl_addon_AddonBase::ATTRIBUTE_IOC_COMPILER_PASSES => 'MapOfCompilerPassClassNamesToPriorities',
                tubepress_impl_addon_AddonBase::ATTRIBUTE_IOC_EXTENSIONS      => 'ExtensionClassNames',
            )
        );
    }
