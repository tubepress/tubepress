...
class tubepress_addons_wordpress_impl_listeners_template_options_OptionsUiTemplateListener
{
    ...
    public function onOptionsUiTemplate(tubepress_api_event_TubePressEvent $event)
    {
        ...
        $template->setVariable(tubepress_impl_options_ui_AbstractFormHandler::TEMPLATE_VAR_TITLE, $messageService->_('TubePress Options'));                                                                                                                                                                                                                                                                                                                                 //>(translatable)<
        $template->setVariable(tubepress_impl_options_ui_AbstractFormHandler::TEMPLATE_VAR_INTRO, $messageService->_('Here you can set the default options for TubePress. Each option here can be overridden on a per page/post basis with TubePress shortcodes. See the <a href="http://tubepress.org/documentation">documentation</a> for more information.')); //>(translatable)<
