 ...
 */
class tubepress_addons_core_impl_patterns_ioc_CoreIocContainerCompilerPass implements ehough_iconic_compiler_CompilerPassInterface
{
    /**
    ...
    private function _registerChainDefinitionByReferences(ehough_iconic_ContainerBuilder $container, $chainName, array $references)
    {
        ...
        )->setFactoryClass('tubepress_addons_core_impl_patterns_ioc_CoreIocContainerCompilerPass')
