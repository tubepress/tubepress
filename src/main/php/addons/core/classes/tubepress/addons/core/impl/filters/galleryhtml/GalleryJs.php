 ...
 */
class tubepress_addons_core_impl_filters_galleryhtml_GalleryJs
{
    public function onGalleryHtml(tubepress_api_event_TubePressEvent $event)
    {
        ...
        $filterManager->dispatch(tubepress_api_const_event_EventNames::GALLERY_INIT_JS_CONSTRUCTION, $jsEvent);
