 ...
 */
class tubepress_addons_core_impl_listeners_galleryhtml_GalleryJs
{
    public function onGalleryHtml(tubepress_api_event_TubePressEvent $event)
    {
        ...
        $eventDispatcher->dispatch(tubepress_api_const_event_EventNames::GALLERY_INIT_JS_CONSTRUCTION, $jsEvent);
