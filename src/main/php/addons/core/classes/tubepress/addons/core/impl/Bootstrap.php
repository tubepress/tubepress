...
class tubepress_addons_core_impl_Bootstrap
{
    ...
    private static function _registerCoreOptions()
    {
        ...
        $option->setAcceptableValuesCallback(array('tubepress_addons_core_impl_Bootstrap', '_callbackGetValidPlayerImplementations'));
        $odr->registerOptionDescriptor($option);
        ...
        $option->setAcceptableValuesCallback(array('tubepress_addons_core_impl_Bootstrap', '_callbackGetValidPlayerLocations'));
        $odr->registerOptionDescriptor($option);
        ...
        $option->setAcceptableValuesCallback(array('tubepress_addons_core_impl_Bootstrap', '_callbackGetValidVideoProviderNames'));
        $odr->registerOptionDescriptor($option);
        ...
        $option->setAcceptableValuesCallback(array('tubepress_addons_core_impl_Bootstrap', '_callbackGetValidThemeOptions'));
        $odr->registerOptionDescriptor($option);
