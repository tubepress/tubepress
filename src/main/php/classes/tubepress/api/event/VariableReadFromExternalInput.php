 ...
 */
class tubepress_api_event_VariableReadFromExternalInput extends tubepress_api_event_PreValidationOptionSet
{
    const EVENT_NAME = 'core.VariableReadFromExternalInput';
}
