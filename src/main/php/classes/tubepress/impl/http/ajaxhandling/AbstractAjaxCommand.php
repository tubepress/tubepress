 ...
 */
abstract class tubepress_impl_http_ajaxhandling_AbstractAjaxCommand implements ehough_chaingang_api_Command
{
    /**
    ...
    {
        $requestedAction = $context->get(tubepress_impl_http_DefaultAjaxHandler::CHAIN_KEY_ACTION);

        if ($requestedAction != $this->getActionName()) {
    ...
    protected abstract function _doExecute(ehough_chaingang_api_Context $context);
}
