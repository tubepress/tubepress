...
class tubepress_impl_options_DefaultOptionDescriptorReference implements tubepress_spi_options_OptionDescriptorReference
{
     ...
     *
     * @param tubepress_spi_options_OptionDescriptor $descriptor The descriptor to register.
     *
    ...
    public final function register(tubepress_spi_options_OptionDescriptor $descriptor)
    {
        if (array_key_exists($descriptor->getName(), $this->_nameToOptionDescriptorMap)) {
            ...
            throw new InvalidArgumentException($descriptor->getName() . ' is already registered as an option descriptor');
        }
    ...
    private function _buildAllOptionDescriptors()
    {
        ...
        $option = new tubepress_spi_options_OptionDescriptor(tubepress_api_const_options_names_Embedded::AUTOHIDE);
        ...
        $option = new tubepress_spi_options_OptionDescriptor(tubepress_api_const_options_names_Embedded::FULLSCREEN);
        ...
        $option = new tubepress_spi_options_OptionDescriptor(tubepress_api_const_options_names_Embedded::HIGH_QUALITY);
        ...
        $option = new tubepress_spi_options_OptionDescriptor(tubepress_api_const_options_names_Embedded::MODEST_BRANDING);
        $option->setDefaultValue(true);
        ...
        $option = new tubepress_spi_options_OptionDescriptor(tubepress_api_const_options_names_Embedded::PLAYER_COLOR);
        ...
        $option = new tubepress_spi_options_OptionDescriptor(tubepress_api_const_options_names_Embedded::PLAYER_HIGHLIGHT);
        ...
        $option = new tubepress_spi_options_OptionDescriptor(tubepress_api_const_options_names_Embedded::SHOW_RELATED);
        $option->setDefaultValue(true);
        ...
        $option = new tubepress_spi_options_OptionDescriptor(tubepress_api_const_options_names_Feed::DEV_KEY);
        ...
        $option = new tubepress_spi_options_OptionDescriptor(tubepress_api_const_options_names_Feed::EMBEDDABLE_ONLY);
        $option->setDefaultValue(true);
        ...
        $option = new tubepress_spi_options_OptionDescriptor(tubepress_api_const_options_names_Feed::FILTER);
        ...
        $option = new tubepress_spi_options_OptionDescriptor(tubepress_api_const_options_names_Feed::VIMEO_KEY);
        ...
        $option = new tubepress_spi_options_OptionDescriptor(tubepress_api_const_options_names_Feed::VIMEO_SECRET);
        $option->setLabel('Vimeo API "Consumer Secret"');                                                                                     //>(translatable)<
        $option->setDescription('<a href="http://vimeo.com/api/applications/new">Click here</a> to register for a consumer key and secret.'); //>(translatable)<
        $option->setExcludedProviders(self::$_providerArrayYouTube);
        $this->register($option);

        $option = new tubepress_spi_options_OptionDescriptor(tubepress_api_const_options_names_GallerySource::YOUTUBE_TAG_VALUE);
        ...
        $option = new tubepress_spi_options_OptionDescriptor(tubepress_api_const_options_names_GallerySource::YOUTUBE_TOP_RATED_VALUE);
        ...
        $option = new tubepress_spi_options_OptionDescriptor(tubepress_api_const_options_names_GallerySource::YOUTUBE_TOP_FAVORITES_VALUE);
        $option->setDefaultValue(tubepress_api_const_options_values_TimeFrameValue::TODAY);
        $option->setAcceptableValues(self::$_valueMapTime);
        $option->setExcludedProviders(self::$_providerArrayVimeo);
        ...
        $option = new tubepress_spi_options_OptionDescriptor(tubepress_api_const_options_names_GallerySource::YOUTUBE_USER_VALUE);
        ...
        $option = new tubepress_spi_options_OptionDescriptor(tubepress_api_const_options_names_GallerySource::VIMEO_UPLOADEDBY_VALUE);
        ...
        $option = new tubepress_spi_options_OptionDescriptor(tubepress_api_const_options_names_GallerySource::VIMEO_LIKES_VALUE);
        ...
        $option = new tubepress_spi_options_OptionDescriptor(tubepress_api_const_options_names_GallerySource::VIMEO_APPEARS_IN_VALUE);
        ...
        $option = new tubepress_spi_options_OptionDescriptor(tubepress_api_const_options_names_GallerySource::VIMEO_SEARCH_VALUE);
        ...
        $option = new tubepress_spi_options_OptionDescriptor(tubepress_api_const_options_names_GallerySource::VIMEO_CREDITED_VALUE);
        ...
        $option = new tubepress_spi_options_OptionDescriptor(tubepress_api_const_options_names_GallerySource::VIMEO_CHANNEL_VALUE);
        ...
        $option = new tubepress_spi_options_OptionDescriptor(tubepress_api_const_options_names_GallerySource::VIMEO_GROUP_VALUE);
        ...
        $option = new tubepress_spi_options_OptionDescriptor(tubepress_api_const_options_names_GallerySource::VIMEO_ALBUM_VALUE);
        ...
        $option = new tubepress_spi_options_OptionDescriptor(tubepress_api_const_options_names_GallerySource::YOUTUBE_FAVORITES_VALUE);
        ...
        $option = new tubepress_spi_options_OptionDescriptor(tubepress_api_const_options_names_GallerySource::YOUTUBE_MOST_VIEWED_VALUE);
        $option->setDefaultValue(tubepress_api_const_options_values_TimeFrameValue::TODAY);
        $option->setAcceptableValues(self::$_valueMapTime);
        $option->setExcludedProviders(self::$_providerArrayVimeo);
        ...
        $option = new tubepress_spi_options_OptionDescriptor(tubepress_api_const_options_names_GallerySource::YOUTUBE_PLAYLIST_VALUE);
        ...
        $option = new tubepress_spi_options_OptionDescriptor(tubepress_api_const_options_names_GallerySource::YOUTUBE_MOST_DISCUSSED_VALUE);
        $option->setExcludedProviders(self::$_providerArrayVimeo);
        $option->setLabel('Most-discussed YouTube videos from');    //>(translatable)<
        $option->setAcceptableValues(self::$_valueMapTime);
        $this->register($option);

        $option = new tubepress_spi_options_OptionDescriptor(tubepress_api_const_options_names_GallerySource::YOUTUBE_MOST_RECENT_VALUE);
        $option->setExcludedProviders(self::$_providerArrayVimeo);
        $option->setLabel('Most-recently added YouTube videos from');    //>(translatable)<
        $option->setAcceptableValues(self::$_valueMapTime);
        $this->register($option);

        $option = new tubepress_spi_options_OptionDescriptor(tubepress_api_const_options_names_GallerySource::YOUTUBE_MOST_RESPONDED_VALUE);
        $option->setExcludedProviders(self::$_providerArrayVimeo);
