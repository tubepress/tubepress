 ...
 */
abstract class tubepress_impl_contrib_AbstractRegistry implements tubepress_api_contrib_RegistryInterface
{
    /**
    ...
    /**
     * @return tubepress_api_boot_BootSettingsInterface
     */
    ...
    private function _setOptionalAttributes(tubepress_api_contrib_ContributableInterface $contributable,
    ...
    private function _setOptionalAttributesFromMap(tubepress_api_contrib_ContributableInterface $contributable, array $manifestContentsAsArray,
