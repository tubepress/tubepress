...
class tubepress_impl_ioc_IconicContainer implements tubepress_api_ioc_ContainerInterface
{
    /**
    ...
    public function __construct(ehough_iconic_ContainerInterface $delegate)
    {
        ...
        $this->_delegate->set('ehough_iconic_ContainerInterface', $this->_delegate);
    }
    ...
    {
        return $this->_delegate->get($id, ehough_iconic_ContainerInterface::NULL_ON_INVALID_REFERENCE);
    }
