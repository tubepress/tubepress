 ...
 */
class tubepress_impl_ioc_ContainerBuilder implements tubepress_api_ioc_ContainerBuilderInterface, tubepress_api_ioc_CompilerPassInterface
{
    /**
    ...
    {
        $this->_delegateContainerBuilder = new tubepress_impl_ioc_IconicContainerBuilder($params);
