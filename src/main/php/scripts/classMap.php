...
return array(
    ...
    'tubepress_api_ioc_Definition'                                 => $apiPrefix . '/ioc/Definition.php',
    'tubepress_api_ioc_Reference'                                  => $apiPrefix . '/ioc/Reference.php',
    ...
    'tubepress_impl_addon_DefaultAddonLoader'                             => $implPrefix . '/addon/DefaultAddonLoader.php',
    'tubepress_impl_addon_FilesystemAddonDiscoverer'                      => $implPrefix . '/addon/FilesystemAddonDiscoverer.php',
    'tubepress_impl_bootstrap_TubePressBootstrapper'                      => $implPrefix . '/bootstrap/TubePressBootstrapper.php',
    ...
    'tubepress_impl_ioc_IconicCompilerPassWrapper'                        => $implPrefix . '/ioc/IconicCompilerPassWrapper.php',
    'tubepress_impl_ioc_IconicContainerExtensionWrapper'                  => $implPrefix . '/ioc/IconicContainerExtensionWrapper.php',
    ...
    'tubepress_impl_options_ui_AbstractPluggableOptionsPageParticipant'   => $implPrefix . '/options/ui/AbstractPluggableOptionsPageParticipant.php',
    ...
    'tubepress_impl_options_ui_fields_AbstractPluggableOptionsPageField'  => $implPrefix . '/options/ui/fields/AbstractPluggableOptionsPageField.php',
    ...
    'tubepress_impl_options_ui_fields_FilterMultiSelectField'             => $implPrefix . '/options/ui/fields/FilterMultiSelectField.php',
    'tubepress_impl_options_ui_fields_GallerySourceField'                 => $implPrefix . '/options/ui/fields/GallerySourceField.php',
    'tubepress_impl_options_ui_fields_MetaMultiSelectField'               => $implPrefix . '/options/ui/fields/MetaMultiSelectField.php',
    'tubepress_impl_options_ui_fields_TextField'                          => $implPrefix . '/options/ui/fields/TextField.php',
    'tubepress_impl_options_ui_fields_ThemeField'                         => $implPrefix . '/options/ui/fields/ThemeField.php',
    ...
    'tubepress_impl_options_ui_tabs_AdvancedTab'                          => $implPrefix . '/options/ui/tabs/AdvancedTab.php',
    'tubepress_impl_options_ui_tabs_CacheTab'                             => $implPrefix . '/options/ui/tabs/CacheTab.php',
    'tubepress_impl_options_ui_tabs_EmbeddedTab'                          => $implPrefix . '/options/ui/tabs/EmbeddedTab.php',
    'tubepress_impl_options_ui_tabs_FeedTab'                              => $implPrefix . '/options/ui/tabs/FeedTab.php',
    'tubepress_impl_options_ui_tabs_GallerySourceTab'                     => $implPrefix . '/options/ui/tabs/GallerySourceTab.php',
    'tubepress_impl_options_ui_tabs_MetaTab'                              => $implPrefix . '/options/ui/tabs/MetaTab.php',
    'tubepress_impl_options_ui_tabs_ThemeTab'                             => $implPrefix . '/options/ui/tabs/ThemeTab.php',
    'tubepress_impl_options_ui_tabs_ThumbsTab'                            => $implPrefix . '/options/ui/tabs/ThumbsTab.php',
    ...
    'tubepress_spi_addon_AddonDiscoverer'                      => $spiPrefix . '/addon/AddonDiscoverer.php',
    'tubepress_spi_addon_Addon'                                => $spiPrefix . '/addon/Addon.php',
    'tubepress_spi_addon_AddonLoader'                          => $spiPrefix . '/addon/AddonLoader.php',
    ...
    'tubepress_spi_options_ui_PluggableFieldBuilder'           => $spiPrefix . '/options/ui/PluggableFieldBuilder.php',
    'tubepress_spi_options_ui_PluggableOptionsPageParticipant' => $spiPrefix . '/options/ui/PluggableOptionsPageParticipant.php',
    'tubepress_spi_options_ui_PluggableOptionsPageTab'         => $spiPrefix . '/options/ui/PluggableOptionsPageTab.php',
