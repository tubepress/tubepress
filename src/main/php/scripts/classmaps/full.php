...
return array(
    ...
    'ehough_iconic_compiler_DecoratorServicePass'                         => $iconicPrefix . '/compiler/DecoratorServicePass.php',
    ...
    'ehough_pulsar_Psr4ClassLoader'           => $pulsarPrefix . '/Psr4ClassLoader.php',
