 ...
 */
class tubepress_addons_core_impl_player_JqModalPluggablePlayerLocationService implements tubepress_spi_player_PluggablePlayerLocationService
{
    /**
    ...
    {
        return 'with jqModal';                                          //>(translatable)<
    }
}