 ...
 */
class tubepress_addons_core_impl_player_StaticPluggablePlayerLocationService implements tubepress_spi_player_PluggablePlayerLocationService
{
    /**
    ...
    {
        return $themeHandler->getTemplateInstance('players/static.tpl.php', TUBEPRESS_ROOT . '/src/main/web/themes/default');
    }
    ...
    {
        return 'statically (page refreshes on each thumbnail click)';   //>(translatable)<
    }
}