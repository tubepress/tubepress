 ...
 */
class tubepress_core_impl_ioc_RegisterListenersPass implements tubepress_api_ioc_CompilerPassInterface
{
    /**
    ...
    public function process(tubepress_api_ioc_ContainerBuilderInterface $containerBuilder)
    {
        ...
        $listenerServiceIds        = $containerBuilder->findTaggedServiceIds(tubepress_core_api_const_ioc_Tags::EVENT_LISTENER);
            ...
            foreach ($events as $event) {
                ...
                if (!isset($event['event'])) {
                    ...
                    throw new InvalidArgumentException(sprintf('Service "%s" must define the "event" attribute on "%s" tags.',
                        $serviceId, tubepress_core_api_const_ioc_Tags::EVENT_LISTENER));
                }
