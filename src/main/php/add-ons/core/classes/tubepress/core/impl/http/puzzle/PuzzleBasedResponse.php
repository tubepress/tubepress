 ...
 */
class tubepress_core_impl_http_puzzle_PuzzleBasedResponse extends tubepress_core_impl_http_puzzle_AbstractMessage implements tubepress_core_api_http_ResponseInterface
{
    /**
    ...
    /**
     * @var tubepress_core_api_url_UrlInterface
     */
    ...
    public function __construct(puzzle_message_ResponseInterface $delegate)
    {
        ...
        if ($urlString !== null) {
            ...
            $this->_effectiveUrl = new tubepress_core_impl_url_puzzle_PuzzleBasedUrl($puzzleUrl);
        }
     ...
     * redirect URL).
     *
     * @param tubepress_core_api_url_UrlInterface $url Effective URL
     *
     * @return tubepress_core_api_http_ResponseInterface Self.
     *
     * @api
     * @since 4.0.0
     */
    public function setEffectiveUrl(tubepress_core_api_url_UrlInterface $url)
    {
