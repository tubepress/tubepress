 ...
 */
class tubepress_core_impl_theme_ThemeRegistry extends tubepress_impl_contrib_AbstractRegistry
{
    private static $_LEGACY_THEME_NAME_PREFIX = 'unknown/legacy-';

    /**
     * @var tubepress_core_api_contrib_ContributableValidatorInterface
     */
    private $_validator;
    ...
    public function __construct(tubepress_api_log_LoggerInterface        $logger,
                                ...
                                tubepress_core_api_contrib_ContributableValidatorInterface $validator)
    {
    ...
    protected function getOptionalAttributesMap()
    {
        return array(
            ...
            tubepress_core_impl_theme_ThemeBase::ATTRIBUTE_PARENT   => 'ParentThemeName',
            tubepress_core_impl_theme_ThemeBase::CATEGORY_RESOURCES => array(

                tubepress_core_impl_theme_ThemeBase::ATTRIBUTE_SCRIPTS => 'Scripts',
                tubepress_core_impl_theme_ThemeBase::ATTRIBUTE_STYLES  => 'Styles',
            ),
        );
    }
    ...
    {
        return 'tubepress_core_impl_theme_ThemeBase';
    }
    ...
    {
        if (!($element instanceof tubepress_core_api_theme_ThemeInterface)) {
    ...
    private function _findLegacyThemes(array $modernThemes)
    {
        ...
        foreach ($finder as $candidateLegacyThemeDir) {
            ...
            /**
             * @var $modernTheme tubepress_core_api_theme_ThemeInterface
             */
        ...
        foreach ($themesToKeep as $legacyThemeDirectory) {
            ...
            $theme = new tubepress_core_impl_theme_ThemeBase(
