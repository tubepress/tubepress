 ...
 * Puzzle-based stream.
 */
abstract class tubepress_core_impl_http_puzzle_AbstractMessage implements tubepress_core_api_http_MessageInterface
{
    /**
     ...
     *
     * @return tubepress_core_api_http_MessageInterface Self.
     *
     * @api
     * @since 4.0.0
     */
     ...
     *
     * @return tubepress_core_api_stream_StreamInterface|null
     *
     * @api
     * @since 4.0.0
     */
    ...
    {
        /**
         * This will ALWAYS be an instance of tubepress_core_impl_stream_puzzle_FlexibleStream (or null),
     ...
     *
     * The body MUST be a tubepress_core_api_stream_StreamInterface object. Setting the body to null MUST
     * remove the existing body.
     *
     * @param tubepress_core_api_stream_StreamInterface|null $body Body.
     *
     * @return tubepress_core_api_http_MessageInterface Self.
     *
     * @api
     * @since 4.0.0
     */
    public function setBody(tubepress_core_api_stream_StreamInterface $body = null)
    {
        if ($body !== null && (!($body instanceof tubepress_core_impl_stream_puzzle_FlexibleStream))) {

            $body = new tubepress_core_impl_stream_puzzle_FlexibleStream($body);
        }
