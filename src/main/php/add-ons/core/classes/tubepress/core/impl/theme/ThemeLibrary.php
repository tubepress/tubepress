 ...
 */
class tubepress_core_impl_theme_ThemeLibrary implements tubepress_core_api_theme_ThemeLibraryInterface
{
     ...
     *
     * @return tubepress_core_api_url_UrlInterface[] URLs of CSS stylesheets required for the current theme. May be empty but never null.
     *
    ...
    public function getStylesUrls($themeName = null)
    {
        ...
        $styles = $this->_recursivelyGetResourceUrlsForTheme($themeName, tubepress_core_impl_theme_ThemeBase::ATTRIBUTE_STYLES);
     ...
     * @param string|null $themeName The name of the theme to query, or null for the currently stored theme.
     *
     * @return tubepress_core_api_url_UrlInterface[] URLs of JS scripts required for the current theme. May be empty but never null.
     *
     * @throws InvalidArgumentException If no such theme.
     */
    public function getScriptsUrls($themeName = null)
    {
        ...
        $themeScripts   = $this->_recursivelyGetResourceUrlsForTheme($themeName, tubepress_core_impl_theme_ThemeBase::ATTRIBUTE_SCRIPTS);
        ...
        $tubePressJsUrl = $baseUrl->addPath('/src/main/web/js/tubepress.js');
    ...
    public function getAbsolutePathToTemplate($relativePath, $themeName = null)
    {
         ...
         */
        if (in_array($relativePath, $this->_themeMap[$themeName][tubepress_core_impl_theme_ThemesPrimerPass::ATTRIBUTE_TEMPLATES])) {
        ...
        while (true) {
            ...
            if (!isset($this->_themeMap[$themeName][tubepress_core_impl_theme_ThemesPrimerPass::ATTRIBUTE_PARENT])) {
             ...
             * Next try the parent.
             */
            $parent = $this->_themeMap[$themeName][tubepress_core_impl_theme_ThemesPrimerPass::ATTRIBUTE_PARENT];
    ...
    public function getScreenshots($themeName = null)
    {
        ...
        $shots = $this->_getResourceUrlsForTheme($themeName, tubepress_core_impl_theme_ThemeBase::ATTRIBUTE_SCREENSHOTS);
    ...
    {
        $currentTheme = $this->_context->get(tubepress_core_api_const_options_Names::THEME);
    ...
    public function getMapOfAllThemeNamesToTitles()
    {
        ...
        foreach ($this->_themeMap as $themeName => $data) {
            ...
            $themeTitle           = $data[tubepress_core_impl_theme_ThemesPrimerPass::ATTRIBUTE_TITLE];
    ...
    {
        $toReturn            = array();
        $themeAbsPath        = $this->_themeMap[$themeName][tubepress_core_impl_theme_ThemesPrimerPass::ATTRIBUTE_THEME_ROOT];
        $themeBaseName       = basename($themeAbsPath);
        $resources           = $this->_themeMap[$themeName][$key];
        $isSystemTheme       = $this->_themeMap[$themeName][tubepress_core_impl_theme_ThemesPrimerPass::ATTRIBUTE_IS_SYSTEM];
