 ...
 */
class tubepress_core_impl_cache_stash_PoolDecorator implements ehough_stash_interfaces_PoolInterface
{
    /**
    ...
    {
        return new tubepress_core_impl_cache_stash_ItemDecorator($this->_context, $item, $this);
    }
