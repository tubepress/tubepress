 ...
 *
 */
class tubepress_core_impl_contrib_ContributableExtension implements tubepress_api_ioc_ContainerExtensionInterface
{
    ...
    public function load(tubepress_api_ioc_ContainerBuilderInterface $containerBuilder)
    {
        $containerBuilder->register(
         ...
         ->addTag(tubepress_core_api_contrib_ContributableValidatorInterface::_, array('type' => tubepress_core_api_theme_ThemeInterface::_));
    }
}
