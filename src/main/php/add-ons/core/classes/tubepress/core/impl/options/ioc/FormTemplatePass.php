 ...
 *
 */
class tubepress_core_impl_options_ioc_BaseOptionsProvidersPass implements tubepress_api_ioc_CompilerPassInterface
{
    ...
    {
        $simpleProviderIds = $containerBuilder->findTaggedServiceIds(tubepress_core_api_const_ioc_Tags::OPTIONS_PAGE_TEMPLATE);
        ...
        foreach ($simpleProviderIds as $simpleProviderId => $tags) {
            ...
            $containerBuilder->register(
                ...
                tubepress_core_api_options_ui_FormInterface::_,
                'tubepress_core_impl_options_ui_Form'
             ...
             ->addTag(tubepress_core_api_const_ioc_Tags::TAGGED_SERVICES_CONSUMER, array(
                'tag' => 'tubepress_core_api_options_ui_FieldProviderInterface',
