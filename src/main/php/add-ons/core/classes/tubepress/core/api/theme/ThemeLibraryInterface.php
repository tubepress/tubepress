 ...
 * @since 4.0.0
 */
interface tubepress_core_api_theme_ThemeLibraryInterface
{
    /**
     * @ignore
     */
    const _ = 'tubepress_core_api_theme_ThemeLibraryInterface';
     ...
     * @param string|null $themeName The name of the theme to query, or null for the currently stored theme.
     *
     * @return tubepress_core_api_url_UrlInterface[] URLs of screenshots for the current theme. May be empty but never null.
     *
     * @throws InvalidArgumentException If no such theme.
     *
     * @api
