 ...
 */
class tubepress_core_impl_url_puzzle_UrlFactory implements tubepress_core_api_url_UrlFactoryInterface
{
    ...
    public function fromString($url)
    {
        if (!is_string($url)) {
            ...
            throw new InvalidArgumentException('tubepress_core_impl_url_puzzle_UrlFactory::fromString() can only accept strings.');
        }

        return new tubepress_core_impl_url_puzzle_PuzzleBasedUrl(puzzle_Url::fromString($url));
    }
