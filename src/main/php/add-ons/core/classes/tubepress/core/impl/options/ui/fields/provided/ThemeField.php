 ...
 */
class tubepress_core_impl_options_ui_fields_provided_ThemeField extends tubepress_core_impl_options_ui_fields_provided_DropdownField
{
    /**
    ...
    private function _buildThemeData(tubepress_core_api_theme_ThemeInterface $theme)
    {
        return array(
