 ...
 */
class tubepress_core_impl_options_ui_fields_provided_TextField extends tubepress_core_impl_options_ui_fields_provided_AbstractProvidedOptionBasedField
{
    /**
