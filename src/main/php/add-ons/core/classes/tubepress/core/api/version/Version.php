 ...
 * @since 4.0.0
 */
class tubepress_core_api_version_Version
{
    /** Version separator. */
    ...
    {
        if (!($otherVersion instanceof tubepress_core_api_version_Version)) {
     ...
     * @param $version
     *
     * @return tubepress_core_api_version_Version
    ...
    public static function parse($version)
    {
        ...
        $empty = new tubepress_core_api_version_Version(0, 0, 0);
        ...
        switch ($pieceCount) {
            ...
            case 1:
                ...
                return new tubepress_core_api_version_Version(self::_validateNumbersOnly($version));

            case 2:

                return new tubepress_core_api_version_Version(self::_validateNumbersOnly($pieces[0]), self::_validateNumbersOnly($pieces[1]));

            case 3:

                return new tubepress_core_api_version_Version(self::_validateNumbersOnly($pieces[0]), self::_validateNumbersOnly($pieces[1]), self::_validateNumbersOnly($pieces[2]));

            case 4:

                return new tubepress_core_api_version_Version(self::_validateNumbersOnly($pieces[0]), self::_validateNumbersOnly($pieces[1]), self::_validateNumbersOnly($pieces[2]), $pieces[3]);
