...
class tubepress_core_impl_options_ioc_BaseOptionsProvidersPass implements tubepress_api_ioc_CompilerPassInterface
{
    ...
    {
        $simpleProviderIds = $containerBuilder->findTaggedServiceIds(tubepress_core_api_options_EasyProviderInterface::_);

        foreach ($simpleProviderIds as $simpleProviderId => $tags) {

            $containerBuilder->register(

                'options_provider_for_' . $simpleProviderId,
             ...
             ->addTag(tubepress_core_api_options_ProviderInterface::_);
        }
    }
}
