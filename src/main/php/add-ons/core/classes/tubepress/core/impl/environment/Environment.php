 ...
 */
class tubepress_core_impl_environment_Environment implements tubepress_core_api_environment_EnvironmentInterface
{
    /**
    ...
    /**
     * @var tubepress_core_api_url_UrlInterface TubePress installation URL.
     */
    private $_baseUrl;

    /**
     * @var tubepress_core_api_url_UrlInterface User content URL.
     */
    ...
    public function __construct(tubepress_core_api_url_UrlFactoryInterface $urlFactory)
    {
        $this->_version    = tubepress_core_api_version_Version::parse('9.9.9');
     ...
     *
     * @return tubepress_core_api_version_Version The current version.
     *
     * @api
     * @since 4.0.0
     */
    ...
    /**
     * @return tubepress_core_api_url_UrlInterface The base TubePress URL. May be null.
     *
     * @api
     * @since 4.0.0
     */
     ...
     *
     * @param string|tubepress_core_api_url_UrlInterface $url The new base URL.
     *
    ...
    /**
     * @return tubepress_core_api_url_UrlInterface The user content URL. May be null.
     *
     * @api
     * @since 4.0.0
     */
     ...
     *
     * @param string|tubepress_core_api_url_UrlInterface $url The user content URL.
     *
     * @throws InvalidArgumentException If unable to parse URL.
     *
     * @return void
    ...
    public function setWpFunctionsInterface($wpFunctionsInterface)
    {
        if (!is_a($wpFunctionsInterface, 'tubepress_wordpress_spi_WpFunctionsInterface')) {
            ...
            throw new InvalidArgumentException('Invalid argument to tubepress_core_impl_environment_Environment::setWpFunctionsInterface');
        }
    ...
    {
        if (!($url instanceof tubepress_core_api_url_UrlInterface)) {
