...
class tubepress_core_impl_event_tickertape_EventDispatcher implements tubepress_core_api_event_EventDispatcherInterface
{
    /**
     ...
     * @param tubepress_core_api_event_EventInterface $event     The event to pass to the event handlers/listeners.
     *                                                      If not supplied, an empty event instance is created.
     *
     * @return tubepress_core_api_event_EventInterface
     *
     * @api
     * @since 3.1.0
     */
    public function dispatch($eventName, tubepress_core_api_event_EventInterface $event = null)
    {
        if (!$event || (!($event instanceof ehough_tickertape_Event))) {

            $event = new tubepress_core_impl_event_tickertape_TickertapeEventWrapper($event);
        }
    ...
    {
        return new tubepress_core_impl_event_tickertape_EventBase($subject, $arguments);
    }
}