 ...
 */
class tubepress_core_impl_theme_ThemesPrimerPass implements tubepress_api_ioc_CompilerPassInterface
{
    ...
    {
        $logger        = $containerBuilder->get(tubepress_api_log_LoggerInterface::_);
        ...
        foreach ($registries as $id => $tag) {
            ...
            if ($tag['type'] === tubepress_core_api_theme_ThemeInterface::_) {
        ...
        /**
         * @var $theme tubepress_core_api_theme_ThemeInterface
         */
