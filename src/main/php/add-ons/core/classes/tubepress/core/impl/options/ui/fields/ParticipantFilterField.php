 ...
 */
class tubepress_core_impl_options_ui_fields_ParticipantFilterField extends tubepress_core_impl_options_ui_fields_AbstractMultiSelectField
{
    ...
    {
        $optionName = tubepress_core_api_const_options_Names::DISABLED_OPTIONS_PAGE_PARTICIPANTS;
        ...
        parent::__construct(
            ...
            $eventDispatcher,
            $templateFactory,
            $optionProvider->getLabel($optionName),
    ...
    protected function onSubmitAllMissing()
    {
        ...
        return $this->getOptionPersistence()->queueForSave(tubepress_core_api_const_options_Names::DISABLED_OPTIONS_PAGE_PARTICIPANTS, $newValue);
    }
