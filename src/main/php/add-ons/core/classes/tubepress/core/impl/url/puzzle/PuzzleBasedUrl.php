 ...
 */
class tubepress_core_impl_url_puzzle_PuzzleBasedUrl implements tubepress_core_api_url_UrlInterface
{
    /**
     * @var tubepress_core_api_url_QueryInterface
     */
    private $_query = null;
    ...
    public function __construct(puzzle_Url $delegate)
    {
        ...
        if ($this->_delegateUrl->getQuery()) {
            ...
            $this->_query = new tubepress_core_impl_url_puzzle_PuzzleBasedQuery($this->_delegateUrl->getQuery());
        }
    }
     ...
     *
     * @return tubepress_core_api_url_UrlInterface
     */
    ...
    /**
     * @return tubepress_core_api_url_QueryInterface
     */
     ...
     *
     * @param tubepress_core_api_url_QueryInterface|string|array $query Query string value to set. Can
     *                                                             be a string that will be parsed into a tubepress_core_api_url_QueryInterface object, an array
     *                                                             of key value pairs, or a tubepress_core_api_url_QueryInterface object.
     *
     * @return tubepress_core_api_url_UrlInterface
    ...
    public function setQuery($query)
    {
        ...
        if ($query instanceof tubepress_core_api_url_QueryInterface) {
        ...
        $this->_query = new tubepress_core_impl_url_puzzle_PuzzleBasedQuery($puzzleQuery);
