 ...
 *
 */
class tubepress_core_impl_util_TimeUtils implements tubepress_core_api_util_TimeUtilsInterface
{
    /**
    ...
    public function unixTimeToHumanReadable($unixTime, $relative)
    {
        ...
        if ($relative) {
            ...
            return tubepress_core_impl_util_TimeUtils::getRelativeTime($unixTime);
        }

        return @date($this->_context->get(tubepress_core_api_const_options_Names::DATEFORMAT), $unixTime);
    }
}
