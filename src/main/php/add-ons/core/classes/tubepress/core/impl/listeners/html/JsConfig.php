 ...
 */
class tubepress_core_impl_listeners_html_JsConfig
{
    /**
    ...
    public function onPreScriptsHtml(tubepress_core_api_event_EventInterface $event)
    {
        $jsEvent = $this->_eventDispatcher->newEventInstance(array());

        $this->_eventDispatcher->dispatch(tubepress_core_api_const_event_EventNames::CSS_JS_GLOBAL_JS_CONFIG, $jsEvent);
