...
/**
 * Providers a wrapper to allow tubepress_core_api_event_EventInterface instances to be passed off as
 * ehough_tickertape_Event instances.
 */
class tubepress_core_impl_event_tickertape_TickertapeEventWrapper extends ehough_tickertape_Event implements tubepress_core_api_event_EventInterface
{
    /**
     * @var tubepress_core_api_event_EventInterface
     */
    private $_delegate;

    public function __construct(tubepress_core_api_event_EventInterface $event = null)
    {
        if (!$event) {
