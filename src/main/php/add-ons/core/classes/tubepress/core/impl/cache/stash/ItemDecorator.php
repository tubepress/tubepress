 ...
 */
class tubepress_core_impl_cache_stash_ItemDecorator implements ehough_stash_interfaces_ItemInterface
{
    /**
    ...
    {
        $cleaningFactor = $this->_context->get(tubepress_core_api_const_options_Names::CACHE_CLEAN_FACTOR);
        ...
        if ($ttl === null) {
            ...
            $ttl = intval($this->_context->get(tubepress_core_api_const_options_Names::CACHE_LIFETIME_SECONDS));
        }
