 ...
 */
class tubepress_core_impl_options_ui_Form implements tubepress_core_api_options_ui_FormInterface
{
    /**
    ...
    /**
     * @var tubepress_core_api_options_ui_FieldProviderInterface[] Categories.
     */
    ...
    /**
     * @var tubepress_core_api_template_TemplateInterface
     */
    private $_template;

    public function __construct(tubepress_core_api_template_TemplateInterface       $template,
    ...
    public function getHTML(array $errors = array(), $justSubmitted = false)
    {
        ...
        if (isset($fields[tubepress_core_impl_options_ui_fields_ParticipantFilterField::FIELD_ID])) {

            /**
             * @var $filterField tubepress_core_impl_options_ui_fields_ParticipantFilterField
             */
            $filterField = $fields[tubepress_core_impl_options_ui_fields_ParticipantFilterField::FIELD_ID];
        ...
        $this->_eventDispatcher->dispatch(tubepress_core_api_const_event_EventNames::OPTIONS_PAGE_TEMPLATE, $templateEvent);
    ...
    {
        /**
         * @var tubepress_core_api_options_ui_FieldInterface[] $fields
         */
        $fields = $this->_buildFieldsArray();
        $errors = array();
     ...
     *
     * @param tubepress_core_api_options_ui_FieldProviderInterface[] $participants
     */
    ...
    private function _buildFieldsArray()
    {
        ...
        /**
         * @var $fields tubepress_core_api_options_ui_FieldInterface[]
         */
        foreach ($fields as $field) {
    ...
    /**
     * @param tubepress_core_api_options_ui_ElementInterface[] $categories
     *
     * @return array
     */
