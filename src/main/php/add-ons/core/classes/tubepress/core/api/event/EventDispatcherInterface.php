 ...
 * @since 3.1.0
 */
interface tubepress_core_api_event_EventDispatcherInterface
{
    /**
     * @ignore
     */
    const _ = 'tubepress_core_api_event_EventDispatcherInterface';
     ...
     * @since 3.1.0
     */
    function dispatch($eventName, tubepress_core_api_event_EventInterface $event = null);
