 ...
 * @since 4.0.0
 */
interface tubepress_core_api_player_PlayerHtmlInterface
{
    /**
     * @ignore
     */
    const _ = 'tubepress_core_api_player_PlayerHtmlInterface';
     ...
     * @since 4.0.0
     */
    function getHtml(tubepress_core_api_video_Video $vid);
}