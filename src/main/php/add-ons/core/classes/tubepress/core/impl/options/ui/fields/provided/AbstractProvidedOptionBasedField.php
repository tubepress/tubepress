 ...
 */
abstract class tubepress_core_impl_options_ui_fields_provided_AbstractProvidedOptionBasedField extends tubepress_core_impl_options_ui_fields_AbstractTemplateBasedOptionsPageField
{
    /**
