 ...
 *
 */
class tubepress_core_impl_options_Persistence implements tubepress_core_api_options_PersistenceInterface
{
    /**
    ...
    /**
     * @var tubepress_core_api_options_PersistenceBackendInterface
     */
    private $_backend;
    ...
    public function __construct(tubepress_api_log_LoggerInterface                      $logger,
                                ...
                                tubepress_core_api_options_PersistenceBackendInterface $backend,
    ...
    private function _validateOneForStorage($optionName, $optionValue)
    {
        ...
        if ($shouldLog) {
            ...
            $this->_logger->error(sprintf("Ignoring invalid value: '%s' = '%s'", $optionName, $this->_stringUtils->redactSecrets($optionValue)));
        }
    ...
    private function _getFilteredValue($optionName, $optionValue)
    {
        ...
        $event = $this->_eventDispatcher->newEventInstance($event->getSubject());
