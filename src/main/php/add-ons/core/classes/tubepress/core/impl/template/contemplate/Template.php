 ...
 */
class tubepress_core_impl_template_contemplate_Template implements tubepress_core_api_template_TemplateInterface
{
    /**
     * @var array
     */
    ...
    public function setVariables(array $context)
    {
        if (!$this->_langUtils->isAssociativeArray($context)) {
            ...
            throw new InvalidArgumentException('tubepress_core_api_template_TemplateInterface::setContext() requires an associative array.');
        }
