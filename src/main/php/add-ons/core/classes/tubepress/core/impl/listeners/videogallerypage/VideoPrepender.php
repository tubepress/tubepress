 ...
 */
class tubepress_core_impl_listeners_videogallerypage_VideoPrepender
{
    /**
    ...
    {
        $customVideoId = $this->_requestParams->getParamValue(tubepress_core_api_const_http_ParamName::VIDEO);
    ...
    private function _prependVideo($id, tubepress_core_api_event_EventInterface $event, $shouldLog)
    {
