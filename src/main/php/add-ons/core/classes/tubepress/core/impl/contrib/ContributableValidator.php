 ...
 *
 */
class tubepress_core_impl_contrib_ContributableValidator implements tubepress_core_api_contrib_ContributableValidatorInterface
{
    /**
    ...
    private function _validateVersion(tubepress_api_contrib_ContributableInterface $contributable)
    {
        try {
            ...
            tubepress_core_api_version_Version::parse($contributable->getVersion());
