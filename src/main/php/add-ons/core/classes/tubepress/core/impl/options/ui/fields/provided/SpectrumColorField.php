 ...
 */
class tubepress_core_impl_options_ui_fields_provided_SpectrumColorField extends tubepress_core_impl_options_ui_fields_provided_AbstractProvidedOptionBasedField
{
    /**
     * @var string
     */
