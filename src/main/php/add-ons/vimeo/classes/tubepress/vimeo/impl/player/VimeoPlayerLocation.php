 ...
 */
class tubepress_vimeo_impl_player_VimeoPlayerLocation implements tubepress_core_api_player_PlayerLocationInterface
{
    /**
    ...
    public function getPlayerJsUrl(tubepress_core_api_environment_EnvironmentInterface $environment)
    {
        ...
        $sysUrl->addPath('src/main/web/players/vimeo/vimeo.js');
