...
class tubepress_vimeo_impl_listeners_video_VimeoVideoConstructionListener
{
    ...
    public function onVideoConstruction(tubepress_core_api_event_EventInterface $event)
    {
         ...
         */
        if ($video->getAttribute(tubepress_core_api_video_Video::ATTRIBUTE_PROVIDER_NAME) !== 'vimeo') {
    ...
    protected final function buildAttributeMap(tubepress_core_api_event_EventInterface $event)
    {
        ...
        /* Keywords */
        $toReturn[tubepress_core_api_video_Video::ATTRIBUTE_KEYWORD_ARRAY] =
            $this->_gatherArrayOfContent($videoArray[$index], 'tags', 'tag');

        /* Likes. */
        if (isset($videoArray[$index]->number_of_likes)) {

            $toReturn[tubepress_core_api_video_Video::ATTRIBUTE_LIKES_COUNT] =
        ...
        $toReturn[tubepress_core_api_video_Video::ATTRIBUTE_TIME_PUBLISHED_FORMATTED] =
            $this->_toDisplayTime($toReturn[tubepress_core_api_video_Video::ATTRIBUTE_TIME_PUBLISHED_UNIXTIME]);
    ...
    {
        $relativeDates = $this->_context->get(tubepress_core_api_const_options_Names::RELATIVE_DATES);
