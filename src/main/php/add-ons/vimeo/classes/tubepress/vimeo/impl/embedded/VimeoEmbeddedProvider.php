 ...
 */
class tubepress_vimeo_impl_embedded_VimeoEmbeddedProvider implements tubepress_core_api_embedded_EmbeddedProviderInterface
{
                                ...
                                $videoId)
    {
        ...
        $jsApi    = $this->_context->get(tubepress_core_api_const_options_Names::ENABLE_JS_API);
        $color    = $this->_context->get(tubepress_vimeo_api_const_options_Names::PLAYER_COLOR);
