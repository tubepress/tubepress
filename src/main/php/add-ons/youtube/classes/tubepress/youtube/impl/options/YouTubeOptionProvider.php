 ...
 */
class tubepress_youtube_impl_options_YouTubeOptionProvider implements tubepress_core_api_options_EasyProviderInterface
{
    private static $_valueMapTime = array(

        tubepress_youtube_api_const_options_Values::TIMEFRAME_ALL_TIME   => 'all time',        //>(translatable)<
        tubepress_youtube_api_const_options_Values::TIMEFRAME_TODAY      => 'today',           //>(translatable)<
    );
    ...
    public function getMapOfOptionNamesToFixedAcceptableValues()
    {
        return array(
            ...
            tubepress_youtube_api_const_options_Names::AUTOHIDE => array(

                tubepress_youtube_api_const_options_Values::AUTOHIDE_HIDE_BAR_SHOW_CONTROLS => 'Fade progress bar only',     //>(translatable)<
                tubepress_youtube_api_const_options_Values::AUTOHIDE_HIDE_BOTH              => 'Fade progress bar and video controls', //>(translatable)<
                tubepress_youtube_api_const_options_Values::AUTOHIDE_SHOW_BOTH              => 'Disable fading - always show both'   //>(translatable)<
            ),

            tubepress_youtube_api_const_options_Names::SHOW_CONTROLS => array(

                tubepress_youtube_api_const_options_Values::CONTROLS_SHOW_IMMEDIATE_FLASH => 'Show controls - load Flash player immediately',          //>(translatable)<
                tubepress_youtube_api_const_options_Values::CONTROLS_SHOW_DELAYED_FLASH   => 'Show controls - load Flash player when playback begins', //>(translatable)<
                tubepress_youtube_api_const_options_Values::CONTROLS_HIDE                 => 'Hide controls',                                          //>(translatable)<
            ),

            tubepress_youtube_api_const_options_Names::THEME => array(

                tubepress_youtube_api_const_options_Values::PLAYER_THEME_DARK  => 'Dark',     //>(translatable)<
                tubepress_youtube_api_const_options_Values::PLAYER_THEME_LIGHT => 'Light'    //>(translatable)<
            ),

            tubepress_youtube_api_const_options_Names::FILTER => array(

                tubepress_youtube_api_const_options_Values::SAFESEARCH_NONE     => 'none',     //>(translatable)<
                tubepress_youtube_api_const_options_Values::SAFESEARCH_MODERATE => 'moderate', //>(translatable)<
                tubepress_youtube_api_const_options_Values::SAFESEARCH_STRICT   => 'strict',   //>(translatable)<
            ),

            tubepress_youtube_api_const_options_Names::YOUTUBE_MOST_POPULAR_VALUE => self::$_valueMapTime,
        );
    }
    ...
    public function getMapOfOptionNamesToValidValueRegexes()
    {
        return array(
            ...
            tubepress_youtube_api_const_options_Names::DEV_KEY => '/[\w-]+/',

            tubepress_youtube_api_const_options_Names::YOUTUBE_RELATED_VALUE   => self::$_regexYouTubeVideo,
            tubepress_youtube_api_const_options_Names::YOUTUBE_PLAYLIST_VALUE  => '/[\w-]+/',
            tubepress_youtube_api_const_options_Names::YOUTUBE_FAVORITES_VALUE => self::$_regexWordChars,
            tubepress_youtube_api_const_options_Names::YOUTUBE_USER_VALUE      => '/[\w-]+/',
        );
    }
