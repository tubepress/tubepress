 ...
 */
class tubepress_youtube_impl_listeners_options_YouTubePlaylistHandler
{
    /**
    ...
    public function onPreValidationOptionSet(tubepress_core_api_event_EventInterface $event)
    {
