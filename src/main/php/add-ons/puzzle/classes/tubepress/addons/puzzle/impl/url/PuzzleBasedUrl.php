 ...
 */
class tubepress_addons_puzzle_impl_url_PuzzleBasedUrl implements tubepress_api_url_UrlInterface
{
    /**
    ...
    public function __construct(puzzle_Url $delegate)
    {
        ...
        if ($this->_delegateUrl->getQuery()) {
            ...
            $this->_query = new tubepress_addons_puzzle_impl_url_PuzzleBasedQuery($this->_delegateUrl->getQuery());
        }
    }
    ...
    public function setQuery($query)
    {
        ...
        $this->_query = new tubepress_addons_puzzle_impl_url_PuzzleBasedQuery($puzzleQuery);
