 ...
 * Puzzle-based stream.
 */
abstract class tubepress_addons_puzzle_impl_message_AbstractMessage implements tubepress_api_http_MessageInterface
{
    /**
     ...
     *
     * @return tubepress_api_http_MessageInterface Self.
     */
     ...
     *
     * @return tubepress_api_stream_StreamInterface|null
     */
    public function getBody()
    {
        /**
         * This will ALWAYS be an instance of tubepress_addons_puzzle_impl_stream_FlexibleStream (or null),
     ...
     *
     * The body MUST be a tubepress_api_stream_StreamInterface object. Setting the body to null MUST
     * remove the existing body.
     *
     * @param tubepress_api_stream_StreamInterface|null $body Body.
     *
     * @return tubepress_api_http_MessageInterface Self.
     */
    public function setBody(tubepress_api_stream_StreamInterface $body = null)
    {
        if ($body !== null && (!($body instanceof tubepress_addons_puzzle_impl_stream_FlexibleStream))) {

            $body = new tubepress_addons_puzzle_impl_stream_FlexibleStream($body);
        }
