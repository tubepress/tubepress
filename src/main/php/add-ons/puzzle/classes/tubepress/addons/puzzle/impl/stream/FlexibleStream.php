 ...
 * Delegating stream.
 */
class tubepress_addons_puzzle_impl_stream_FlexibleStream implements puzzle_stream_StreamInterface, tubepress_api_stream_StreamInterface
{
    /**
     * @var puzzle_stream_StreamInterface|tubepress_api_stream_StreamInterface
     */
    private $_delegate;

    public function __construct($delegate)
    {
        if (!($delegate instanceof puzzle_stream_StreamInterface || $delegate instanceof tubepress_api_stream_StreamInterface)) {

            throw new InvalidArgumentException(sprintf('%s must be constructed with instance of either %s or %s',

                'tubepress_addons_puzzle_impl_stream_FlexibleStream',
                'puzzle_stream_StreamInterface',
                'tubepress_api_stream_StreamInterface'
            ));
        }
