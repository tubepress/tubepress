...
/**
 * Implementation of tubepress_core_api_options_PersistenceInterface that uses the
 * regular WordPress options API.
 */
class tubepress_wordpress_impl_options_PersistenceBackend implements tubepress_core_api_options_PersistenceBackendInterface
{
    /*
