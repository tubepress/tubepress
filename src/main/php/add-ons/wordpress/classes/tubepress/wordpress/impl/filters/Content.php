...
class tubepress_wordpress_impl_filters_Content
{
     ...
     */
    public final function filter(tubepress_core_api_event_EventInterface $event)
    {
        $content = $event->getSubject();

        /* do as little work as possible here 'cause we might not even run */
        $trigger = $this->_persistence->fetch(tubepress_core_api_const_options_Names::KEYWORD);
