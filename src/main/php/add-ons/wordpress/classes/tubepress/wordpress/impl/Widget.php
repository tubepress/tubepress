...
class tubepress_wordpress_impl_Widget
{
    ...
    /**
     * @var tubepress_core_api_html_HtmlGeneratorInterface
     */
    ...
    public function __construct(tubepress_core_api_options_ContextInterface          $context,
                                ...
                                tubepress_core_api_html_HtmlGeneratorInterface       $htmlGenerator,
                                ...
                                tubepress_core_api_http_RequestParametersInterface   $requestParameters,
    ...
    public function printWidgetHtml($opts)
    {
        ...
        $defaultWidgetOptions = array(
            ...
            tubepress_core_api_const_options_Names::THUMB_WIDTH       => 135,
        ...
        $rawTag    = $this->_context->get(tubepress_wordpress_api_const_OptionNames::WIDGET_SHORTCODE);
        ...
        if ($this->_context->get(tubepress_core_api_const_options_Names::THEME) === '') {

            $this->_context->set(tubepress_core_api_const_options_Names::THEME, 'tubepress/legacy-sidebar');
        }
        ...
        echo $before_widget . $before_title .
            $this->_context->get(tubepress_wordpress_api_const_OptionNames::WIDGET_TITLE) .
    ...
    public function printControlHtml()
    {
        ...
        if ($this->_httpRequestParams->hasParam(self::WIDGET_SUBMIT_TAG)) {
            ...
            $this->_persistence->queueForSave(tubepress_wordpress_api_const_OptionNames::WIDGET_SHORTCODE, $this->_httpRequestParams->getParamValue('tubepress-widget-tagstring'));
            $this->_persistence->queueForSave(tubepress_wordpress_api_const_OptionNames::WIDGET_TITLE, $this->_httpRequestParams->getParamValue('tubepress-widget-title'));
        ...
        /* set up the template */
        $tpl->setVariable(self::WIDGET_TITLE, $this->_persistence->fetch(tubepress_wordpress_api_const_OptionNames::WIDGET_TITLE));
        ...
        $tpl->setVariable(self::WIDGET_SHORTCODE, $this->_persistence->fetch(tubepress_wordpress_api_const_OptionNames::WIDGET_SHORTCODE));
    ...
    private function _dispatchErrorAndGetMessage(Exception $e)
    {
        ...
        $this->_eventDispatcher->dispatch(tubepress_core_api_const_event_EventNames::ERROR_EXCEPTION_CAUGHT, $event);
