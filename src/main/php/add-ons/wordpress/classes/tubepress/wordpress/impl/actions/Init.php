...
class tubepress_wordpress_impl_actions_Init
{
     ...
     */
    public final function action(tubepress_core_api_event_EventInterface $event)
    {
        ...
        $jsUrl = $this->_wpFunctions->plugins_url("$baseName/src/main/web/js/tubepress.js", $baseName);
    ...
    private function _enqueueThemeResources(tubepress_wordpress_spi_WpFunctionsInterface $wpFunctions)
    {
        ...
        for ($x = 0; $x < $scriptCount; $x++) {
            ...
            if ($this->_stringUtils->endsWith($scripts[$x]->toString(), '/src/main/web/js/tubepress.js')) {
