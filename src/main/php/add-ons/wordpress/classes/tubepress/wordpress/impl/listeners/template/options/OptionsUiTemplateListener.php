...
class tubepress_wordpress_impl_listeners_template_options_OptionsUiTemplateListener
{
    ...
    public function __construct(tubepress_core_api_environment_EnvironmentInterface $environment,
    ...
    public function onOptionsUiTemplate(tubepress_core_api_event_EventInterface $event)
    {
        /**
