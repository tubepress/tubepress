 ...
 */
class tubepress_plugins_jwflvplayer_impl_options_ui_JwFlvPlayerOptionsPageParticipant implements tubepress_spi_options_ui_PluggableOptionsPageParticipant
{
    /**
    ...
    {
        return 'JW FLV Player';     //>(translatable)<
    }
