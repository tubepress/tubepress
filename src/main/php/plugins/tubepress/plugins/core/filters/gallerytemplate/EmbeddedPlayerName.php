 ...
 */
class tubepress_plugins_core_filters_gallerytemplate_EmbeddedPlayerName
{
    ...
    private static function _getEmbeddedServiceName($providerName)
    {
        ...
        $longTailWithYouTube = $stored === tubepress_api_const_options_values_PlayerImplementationValue::LONGTAIL
            && $providerName === tubepress_spi_provider_Provider::YOUTUBE;

        $embedPlusWithYouTube = $stored === tubepress_api_const_options_values_PlayerImplementationValue::EMBEDPLUS
            && $providerName === tubepress_spi_provider_Provider::YOUTUBE;
