 ...
 */
class tubepress_plugins_core_filters_videogallerypage_VideoPrepender
{
    private $_logger;
    ...
    private function _prependVideo($id, tubepress_api_event_VideoGalleryPageConstruction $event)
    {
