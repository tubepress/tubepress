...
<object classid='clsid:D27CDB6E-AE6D-11cf-96B8-444553540000' width='<?php echo ${tubepress_api_const_template_Variable::EMBEDDED_WIDTH}; ?>' height='<?php echo ${tubepress_api_const_template_Variable::EMBEDDED_HEIGHT}; ?>'>
    ...
    <param name='flashvars' value='file=<?php echo ${tubepress_api_const_template_Variable::EMBEDDED_DATA_URL}; ?>&amp;autostart=<?php echo ${tubepress_api_const_template_Variable::EMBEDDED_AUTOSTART}; ?>&amp;backcolor=<?php echo ${tubepress_plugins_jwplayer_api_const_template_Variable::COLOR_BACK}; ?>&amp;frontcolor=<?php echo ${tubepress_plugins_jwplayer_api_const_template_Variable::COLOR_FRONT}; ?>&amp;lightcolor=<?php echo ${tubepress_plugins_jwplayer_api_const_template_Variable::COLOR_LIGHT}; ?>&amp;screencolor=<?php echo ${tubepress_plugins_jwplayer_api_const_template_Variable::COLOR_SCREEN}; ?>'>
