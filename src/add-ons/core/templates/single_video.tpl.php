 ...
 *
 * ${tubepress_app_api_template_VariableNames::MEDIA_ITEM}
 *    An instance of tubepress_app_api_media_MediaItem representing the video.
 *
 ...
 *     each element of ${tubepress_app_api_template_VariableNames::GALLERY_MEDIA_ITEM_ARRAY}
 *
 ...
 *
 * ${tubepress_app_api_template_VariableNames::EMBEDDED_SOURCE}
 *     A string containing the HTML for the embedded media player.
 *
 * ${tubepress_app_api_template_VariableNames::EMBEDDED_WIDTH_PX}
