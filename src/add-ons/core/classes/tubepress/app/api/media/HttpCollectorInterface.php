...
interface tubepress_app_api_media_HttpCollectorInterface
{
     ...
     * @ignore
     */
    const _ = 'tubepress_app_api_media_HttpCollectorInterface';

    /**
     * Collects a media gallery page.
     *
     * @param int                                              $pageNumber The page number.
     * @param tubepress_app_api_media_HttpFeedHandlerInterface $feedHandler The feed handler.
     *
     ...
     * @since 4.0.0
     */
    function collectPage($pageNumber, tubepress_app_api_media_HttpFeedHandlerInterface $feedHandler);
     ...
     * @since 4.0.0
     */
    function collectSingle($id, tubepress_app_api_media_HttpFeedHandlerInterface $feedHandler);
}