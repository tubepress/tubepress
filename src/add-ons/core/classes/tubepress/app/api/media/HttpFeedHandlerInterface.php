...
interface tubepress_app_api_media_HttpFeedHandlerInterface
{
     ...
     * @since 4.0.0
     */
    function getNewItemEventArguments(tubepress_app_api_media_MediaItem $mediaItemId, $index);
     ...
     *
     * @return tubepress_platform_api_url_UrlInterface The URL for the single media item given.
     *
     * @api
     * @since 4.0.0
     */
