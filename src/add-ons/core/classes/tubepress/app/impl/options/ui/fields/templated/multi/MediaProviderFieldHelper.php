 ...
 *
 */
class tubepress_app_impl_options_ui_fields_templated_multi_MediaProviderFieldHelper
{
    /**
     * @return array An associative array of translated group names to associative array of
     *               value => translated display names
     */
    public static function getGroupedChoicesArray(tubepress_app_impl_options_ui_fields_templated_multi_MediaProviderFieldInterface $mpfi)
    {
        ...
        usort($sortedLabels, array('tubepress_app_impl_options_ui_fields_templated_multi_MediaProviderFieldHelper', '__sortByMostSlashes'));
