 ...
 *
 * ${tubepress_app_api_template_VariableNames::GALLERY_MEDIA_ITEM_ARRAY}
 *     An array of tubepress_app_api_media_MediaItem instances representing the videos in the gallery.
 *     This array may be empty.
 *
 * ${tubepress_app_api_template_VariableNames::HTML_WIDGET_ID}
 *     A string representing the page-unique ID for this gallery. Typically this is just a random number.
 *
 * ${tubepress_app_api_template_VariableNames::GALLERY_PLAYER_HTML}
 *     A string containing HTML for the embedded media player. This may be empty as some players
 *     don't generate HTML.
 *
 * ${tubepress_app_api_template_VariableNames::GALLERY_PAGINATION_TOP}
 * ${tubepress_app_api_template_VariableNames::GALLERY_PAGINATION_BOTTOM}
 ...
 *
 * ${tubepress_app_api_template_VariableNames::GALLERY_THUMBNAIL_WIDTH_PX}
 * ${tubepress_app_api_template_VariableNames::GALLERY_THUMBNAIL_HEIGHT_PX}
 ...
 *     each item in ${tubepress_app_api_template_VariableNames::GALLERY_MEDIA_ITEM_ARRAY}
 *
 ...
 *
 * $translator
 *     An instance of tubepress_lib_api_translation_TranslatorInterface
 */
 ...
 */
?>
<div class="tubepress-youtube js-tubepress-gallery js-tubepress-gallery-<?php echo ${tubepress_app_api_template_VariableNames::HTML_WIDGET_ID}; ?>"><?php
...
if (empty(${tubepress_app_api_template_VariableNames::GALLERY_MEDIA_ITEM_ARRAY})):
     ...
     */
    echo ${tubepress_app_api_template_VariableNames::GALLERY_PLAYER_HTML};
    ...
    <div class="tubepress-pagination-and-thumbs js-tubepress-pagination-and-thumbs">
         ...
         */
        if (isset(${tubepress_app_api_template_VariableNames::GALLERY_PAGINATION_TOP})) :
            echo ${tubepress_app_api_template_VariableNames::GALLERY_PAGINATION_TOP};
        endif;
        ...
        <div class="tubepress-thumbs">
            ...
            ?>
            <div class="tubepress-thumb js-tubepress-fluid-thumb-adjustable"
                style="width: <?php echo ${tubepress_app_api_template_VariableNames::GALLERY_THUMBNAIL_WIDTH_PX}; ?>px">

                <div class="tubepress-youtube-thumbnail"  style="width: <?php echo ${tubepress_app_api_template_VariableNames::GALLERY_THUMBNAIL_WIDTH_PX}; ?>px">
                    ...
                    <img class="tubepress-thumbnail-image js-tubepress-fluid-thumb-reference"
                         alt="<?php echo htmlspecialchars($mediaItem->getAttribute(tubepress_app_api_media_MediaItem::ATTRIBUTE_TITLE), ENT_QUOTES, 'UTF-8'); ?>"
                         src="<?php echo $mediaItem->getAttribute(tubepress_app_api_media_MediaItem::ATTRIBUTE_THUMBNAIL_URL); ?>"
                         width="<?php echo ${tubepress_app_api_template_VariableNames::GALLERY_THUMBNAIL_WIDTH_PX}; ?>"
                     ...
                     */
                    if (in_array(tubepress_app_api_media_MediaItem::ATTRIBUTE_DURATION_FORMATTED, ${tubepress_app_api_template_VariableNames::MEDIA_ITEM_ATTRIBUTES_TO_SHOW})): ?>
                ...
                <dl class="tubepress-meta-group"
                    style="width: <?php echo ${tubepress_app_api_template_VariableNames::GALLERY_THUMBNAIL_WIDTH_PX}; ?>px">
                         ...
                         */
                        if (in_array(tubepress_app_api_media_MediaItem::ATTRIBUTE_TITLE, ${tubepress_app_api_template_VariableNames::MEDIA_ITEM_ATTRIBUTES_TO_SHOW})):

                            if (strlen($mediaItem->getAttribute(tubepress_app_api_media_MediaItem::ATTRIBUTE_TITLE)) > 35) {

                                $mediaItem->setAttribute(tubepress_app_api_media_MediaItem::ATTRIBUTE_TITLE,
                                    substr($mediaItem->getAttribute(tubepress_app_api_media_MediaItem::ATTRIBUTE_TITLE), 0, 35) . ' ...');
                            }
                        endif;
                         ...
                         */
                        if (in_array(tubepress_app_api_media_MediaItem::ATTRIBUTE_VIEW_COUNT, ${tubepress_app_api_template_VariableNames::MEDIA_ITEM_ATTRIBUTES_TO_SHOW})):

                            $attributeName = tubepress_app_api_media_MediaItem::ATTRIBUTE_VIEW_COUNT;
                            ${tubepress_app_api_template_VariableNames::MEDIA_ITEM_ATTRIBUTE_LABELS}[$attributeName] = '';
                         ...
                         */
                        if (in_array(tubepress_app_api_media_MediaItem::ATTRIBUTE_TIME_PUBLISHED_FORMATTED, ${tubepress_app_api_template_VariableNames::MEDIA_ITEM_ATTRIBUTES_TO_SHOW})):

                            $attributeName = tubepress_app_api_media_MediaItem::ATTRIBUTE_TIME_PUBLISHED_FORMATTED;
                            ${tubepress_app_api_template_VariableNames::MEDIA_ITEM_ATTRIBUTE_LABELS}[$attributeName] = '';
                        endif;
                         ...
                         */
                        $modifiedAttributeNames = array(tubepress_app_api_media_MediaItem::ATTRIBUTE_TITLE, tubepress_app_api_media_MediaItem::ATTRIBUTE_AUTHOR_DISPLAY_NAME, tubepress_app_api_media_MediaItem::ATTRIBUTE_VIEW_COUNT, tubepress_app_api_media_MediaItem::ATTRIBUTE_TIME_PUBLISHED_FORMATTED,
                        );
                        $modifiedAttributeNames = array_intersect($modifiedAttributeNames, ${tubepress_app_api_template_VariableNames::MEDIA_ITEM_ATTRIBUTES_TO_SHOW});
                        ${tubepress_app_api_template_VariableNames::MEDIA_ITEM_ATTRIBUTES_TO_SHOW} = array_diff(${tubepress_app_api_template_VariableNames::MEDIA_ITEM_ATTRIBUTES_TO_SHOW}, $modifiedAttributeNames);
                        ${tubepress_app_api_template_VariableNames::MEDIA_ITEM_ATTRIBUTES_TO_SHOW} = array_merge($modifiedAttributeNames, ${tubepress_app_api_template_VariableNames::MEDIA_ITEM_ATTRIBUTES_TO_SHOW});

                        /**
                         * Loop over the attributes for this media item.
                         */
                        foreach (${tubepress_app_api_template_VariableNames::MEDIA_ITEM_ATTRIBUTES_TO_SHOW} as $attributeName):

                            /**
                             * We already showed the runtime.
                             */
                            if ($attributeName === tubepress_app_api_media_MediaItem::ATTRIBUTE_DURATION_FORMATTED) {
                                continue;
                            }
         ...
         */
        if (isset(${tubepress_app_api_template_VariableNames::GALLERY_PAGINATION_BOTTOM})) :
            echo ${tubepress_app_api_template_VariableNames::GALLERY_PAGINATION_BOTTOM};
        endif; ?>
