 ...
 */
  ...
  * @since 4.0.0
  *
  * @deprecated Use tubepress_spi_ioc_CompilerPassInterface instead.
  */
interface tubepress_platform_api_ioc_CompilerPassInterface extends tubepress_spi_ioc_CompilerPassInterface
{
