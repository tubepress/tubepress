 ...
 */
class tubepress_youtube2_impl_media_MediaProvider implements tubepress_app_api_media_MediaProviderInterface
{
    ...
    {
        return tubepress_youtube2_api_Constants::GALLERYSOURCE_YOUTUBE_SEARCH;
    }
    ...
    {
        return tubepress_youtube2_api_Constants::OPTION_YOUTUBE_TAG_VALUE;
    }
