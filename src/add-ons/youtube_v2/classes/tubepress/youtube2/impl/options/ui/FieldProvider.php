 ...
 * 
 */
class tubepress_youtube2_impl_options_ui_FieldProvider implements tubepress_app_api_options_ui_FieldProviderInterface
{
    /**
    ...
    public function getCategoryIdsToFieldIdsMap()
    {
        return array(
            ...
            tubepress_app_api_options_ui_CategoryNames::EMBEDDED => array(
                ...
                tubepress_youtube2_api_Constants::OPTION_AUTOHIDE,
                tubepress_youtube2_api_Constants::OPTION_CLOSED_CAPTIONS,
                tubepress_youtube2_api_Constants::OPTION_DISABLE_KEYBOARD,
                tubepress_youtube2_api_Constants::OPTION_FULLSCREEN,
                tubepress_youtube2_api_Constants::OPTION_MODEST_BRANDING,
                tubepress_youtube2_api_Constants::OPTION_SHOW_ANNOTATIONS,
                tubepress_youtube2_api_Constants::OPTION_SHOW_RELATED,
            ...
            tubepress_app_api_options_ui_CategoryNames::FEED => array(
                ...
                tubepress_youtube2_api_Constants::OPTION_FILTER,
                tubepress_youtube2_api_Constants::OPTION_DEV_KEY,
                tubepress_youtube2_api_Constants::OPTION_EMBEDDABLE_ONLY,
            )
        );
    }
