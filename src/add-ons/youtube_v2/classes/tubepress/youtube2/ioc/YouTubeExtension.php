 ...
 */
class tubepress_youtube2_ioc_YouTubeExtension implements tubepress_platform_api_ioc_ContainerExtensionInterface
{
    /**
    ...
    private function _registerMediaProvider(tubepress_platform_api_ioc_ContainerBuilderInterface $containerBuilder)
    {
        ...
        $containerBuilder->register(
         ...
         ->addArgument(new tubepress_platform_api_ioc_Reference('tubepress_youtube2_impl_media_FeedHandler'))
    ...
    private function _registerOptionsUi(tubepress_platform_api_ioc_ContainerBuilderInterface $containerBuilder)
    {
        ...
        $containerBuilder->register(
         ...
         ->addArgument(tubepress_youtube2_api_Constants::OPTION_DEV_KEY)
         ->addArgument('text')
