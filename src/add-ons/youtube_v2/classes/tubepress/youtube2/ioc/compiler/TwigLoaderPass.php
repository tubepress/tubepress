...
class tubepress_youtube2_ioc_compiler_TwigLoaderPass implements tubepress_platform_api_ioc_CompilerPassInterface
{
    ...
    public function process(tubepress_platform_api_ioc_ContainerBuilderInterface $containerBuilder)
    {
        ...
        $twigFsLoader->addMethodCall('addPath', array(TUBEPRESS_ROOT . '/src/add-ons/youtube_v2/templates'));
    }
}