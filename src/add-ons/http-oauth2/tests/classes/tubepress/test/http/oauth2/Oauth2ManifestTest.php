...
class tubepress_test_http_oauth2_ManifestTest extends tubepress_api_test_contrib_AbstractManifestTest
{
    public function testManifest()
    {
        ...
        $this->assertEquals('tubepress/http-oauth2', $addon->getName());
        $this->assertEquals('99.99.99', $addon->getVersion());
        $this->assertEquals('TubePress OAuth2 Services', $addon->getTitle());
    ...
    {
        return TUBEPRESS_ROOT . '/src/add-ons/http-oauth2/manifest.json';
    }
}
