...
class tubepress_wordpress_impl_listeners_template_options_OptionsUiTemplateListener
{
    const TEMPLATE_VAR_BOX_ARRAY = 'tubepress_wordpress_impl_listeners_template_options_OptionsUiTemplateListener__boxArray';
    ...
    public function onOptionsUiTemplate(tubepress_lib_api_event_EventInterface $event)
    {
        /**
        ...
        if (! $this->_environment->getAsBoolean(tubepress_app_api_environment_EnvironmentInterface::PROPERTY_IS_PRO)) {
