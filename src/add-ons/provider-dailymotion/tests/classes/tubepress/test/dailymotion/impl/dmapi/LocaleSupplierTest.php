...
/**
 * @covers tubepress_dailymotion_impl_dmapi_LocaleSupplier<extended>
 */
class tubepress_test_dailymotion_impl_dmapi_LocaleSupplierTest extends tubepress_api_test_TubePressUnitTest
{
    /**
    ...
    public function testFetch($codeKey, $apiResponse, $expected)
    {
        ...
        $sut = new tubepress_dailymotion_impl_dmapi_LocaleSupplier(
