...
interface tubepress_api_event_Events
{
     ...
     *
     * @argument <var>mediaPage</var> (`{@link tubepress_api_media_MediaPage}`): The backing {@link tubepress_api_media_MediaPage}.
     ...
     *
     * @subject `tubepress_api_url_UrlInterface[]` An array of URLs for the scripts that TubePress will print in the HTML <head>
     ...
     *
     * @subject `tubepress_api_url_UrlInterface[]` An array of URLs for the stylesheets that TubePress will print in the HTML <head>
     *
     * @api
     * @since 4.0.0
     */
     ...
     *
     * @subject `tubepress_api_media_MediaItem` The media item being constructed.
     *
     ...
     *
     * @subject {@tubepress_api_url_UrlInterface} The URL for the media item.
     *
     ...
     *
     * @subject {@link tubepress_api_media_MediaItem} The media item.
     *
     * @api
     * @since 4.0.0
     */
     ...
     *
     * @subject {@tubepress_api_url_UrlInterface} The URL for the media page.
     *
    ...
    /**
     * This event is fired when a TubePress collects a new tubepress_api_media_MediaPage.
     *
     * @subject {@tubepress_api_media_MediaPage} The page being built.
     *
