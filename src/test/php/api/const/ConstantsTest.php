 ...
 *
 */
class tubepress_api_const_ConstantsTest extends PHPUnit_Framework_TestCase
{
    function testConstants()
    {
        $toTest = array(
            ...
            'tubepress_api_const_options_names_WordPress'			        => array('widget-tagstring', 'widget-title', 'showVimeoOptions', 'showYouTubeOptions'),
            ...
            'tubepress_api_const_options_values_SafeSearchValue'			=> array('moderate', 'none', 'strict'),
            'tubepress_api_const_options_values_TimeFrameValue'				=> array('all_time', 'this_month', 'this_week', 'today'),
