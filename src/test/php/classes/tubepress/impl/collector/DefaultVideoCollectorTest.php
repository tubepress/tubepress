...
class tubepress_impl_collector_DefaultVideoCollectorTest extends TubePressUnitTest
{
    ...
    public function testProviderHandles()
    {
        ...
        $this->_mockEventDispatcher->shouldReceive('dispatch')->once()->with(tubepress_api_const_event_CoreEventNames::VIDEO_GALLERY_PAGE_CONSTRUCTION, ehough_mockery_Mockery::on(function ($arg) use ($mockPage) {
    ...
    public function testMultipleNoProvidersCouldHandle()
    {
        ...
        $this->_mockEventDispatcher->shouldReceive('dispatch')->once()->with(tubepress_api_const_event_CoreEventNames::VIDEO_GALLERY_PAGE_CONSTRUCTION, ehough_mockery_Mockery::on(function ($arg) {
