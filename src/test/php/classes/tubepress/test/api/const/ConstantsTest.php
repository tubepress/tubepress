...
class tubepress_test_api_const_ConstantsTest extends tubepress_test_TubePressUnitTest
{
    public function testConstants()
    {
        $toTest = array(
            ...
            'tubepress_api_const_template_Variable'                        => array(
                'videoDomId', 'videoProviderName', 'autostart', 'bottomPagination', 'embeddedColorHightlight',
                'embeddedColorPrimary', 'embeddedFullscreen', 'embeddedHeight', 'embeddedImplementationName',
                'embeddedSource', 'embeddedWidth', 'galleryId', 'homeURL', 'metaLabels', 'playerName', 'preGallery',
                'searchButton', 'searchHandlerUrl', 'searchHiddenInputs', 'searchTargetDomId', 'searchTerms',
                'shouldShow', 'thumbHeight', 'thumbWidth', 'topPagination', 'tubepressBaseUrl', 'video', 'videoArray',
                'videoId', 'paginationCurrentPage', 'paginationTotalItems', 'paginationResultsPerPage',
                'paginationTextNext', 'paginationTextPrev', 'paginationHrefFormat')
