...
class tubepress_test_impl_ioc_IconicContainerTest extends tubepress_test_TubePressUnitTest
{
    ...
    public function onSetup()
    {
        ...
        $this->_mockContainer->shouldReceive('set')->once()->with('ehough_iconic_ContainerInterface', $this->_mockContainer);
        $this->_sut           = new tubepress_impl_ioc_IconicContainer($this->_mockContainer);
    }
