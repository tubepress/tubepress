...
/**
 * @covers tubepress_impl_ioc_IconicContainer
 */
class tubepress_test_impl_ioc_IconicContainerTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_impl_ioc_IconicContainer
     */
    private $_sut;

    public function onSetup()
    {
        $this->_sut = new tubepress_impl_ioc_IconicContainer();
    }
    ...
    public function testGetDelegateContainerBuilder()
    {
        $this->assertTrue($this->_sut->getDelegateIconicContainerBuilder() instanceof ehough_iconic_ContainerBuilder);
    }
    ...
    public function testMergeFrozen()
    {
        ...
        $mockContainer = ehough_mockery_Mockery::mock('tubepress_api_ioc_ContainerInterface');
        ...
        $mockExtension->shouldReceive('load')->once()->with(ehough_mockery_Mockery::any('tubepress_impl_ioc_IconicContainer'));
