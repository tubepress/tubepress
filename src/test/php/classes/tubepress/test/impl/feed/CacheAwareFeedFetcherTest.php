...
class tubepress_test_impl_feed_CacheAwareFeedFetcherTest extends tubepress_test_TubePressUnitTest
{
    ...
    private function _setupHttpExecution()
    {
        ...
        $this->_mockEventDispatcher->shouldReceive('publish')->once()->with(tubepress_api_const_event_EventNames::HTTP_RESPONSE, ehough_mockery_Mockery::on(array($this, '_callbackHttpResponse')));
    }
}
