...
class tubepress_test_impl_boot_helper_secondary_IocCompilerTest extends tubepress_test_TubePressUnitTest
{
    ...
    public function testCompile()
    {
        ...
        $this->_mockLogger->shouldReceive('error')->once()->with('(Add-on 2 of 2: mock add-on 2) Failed to load no such class as an IoC compiler pass: Class no such class does not exist');
