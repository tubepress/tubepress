 ...
 */
class tubepress_addons_wordpress_impl_patterns_ioc_WordPressIocContainerExtensionTest extends tubepress_test_TubePressUnitTest
{
    /**
    ...
    {
        $this->_sut = new tubepress_addons_wordpress_impl_patterns_ioc_WordPressIocContainerExtension();
    ...
    private function _getExpectedServices()
    {
        $map = array(
            ...
            array(tubepress_spi_message_MessageService::_, 'tubepress_addons_wordpress_impl_message_WordPressMessageService'),
            ...
            array(tubepress_addons_wordpress_spi_WpAdminHandler::_, 'tubepress_addons_wordpress_impl_DefaultWpAdminHandler'),
            array(tubepress_addons_wordpress_spi_WordPressFunctionWrapper::_, 'tubepress_addons_wordpress_impl_DefaultWordPressFunctionWrapper')
        );
