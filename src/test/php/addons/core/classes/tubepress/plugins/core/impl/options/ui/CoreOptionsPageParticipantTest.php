 ...
 */
class tubepress_plugins_core_impl_options_ui_CoreOptionsPageParticipantTest extends TubePressUnitTest
{
    /**
     * @var tubepress_plugins_core_impl_options_ui_CoreOptionsPageParticipant
     */
    private $_sut;
    ...
    {
        $this->_sut = new tubepress_plugins_core_impl_options_ui_CoreOptionsPageParticipant();
