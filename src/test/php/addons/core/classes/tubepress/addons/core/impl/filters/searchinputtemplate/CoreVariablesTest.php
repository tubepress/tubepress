 ...
 */
class tubepress_addons_core_impl_filters_searchinputtemplate_CoreVariablesTest extends TubePressUnitTest
{
    /**
     * @var tubepress_addons_core_impl_filters_searchinputtemplate_CoreVariables
     */
    private $_sut;
