 ...
 */
class tubepress_addons_core_impl_listeners_gallerytemplate_VideoMetaTest extends TubePressUnitTest
{
    /**
     * @var tubepress_addons_core_impl_listeners_gallerytemplate_VideoMeta
     */
    private $_sut;
    ...
    {
        $this->_sut = new tubepress_addons_core_impl_listeners_gallerytemplate_VideoMeta();
