 ...
 */
class tubepress_addons_core_impl_shortcode_commands_SingleVideoPluggableShortcodeHandlerServiceTest extends tubepress_test_TubePressUnitTest
{
    /**
    ...
    public function testExecute()
    {
        ...
        $this->_mockEventDispatcher->shouldReceive('publish')->once()->with(tubepress_api_const_event_EventNames::TEMPLATE_SINGLE_VIDEO, ehough_mockery_Mockery::on(function ($arg) use ($mockTemplate) {
        ...
        $this->_mockEventDispatcher->shouldReceive('publish')->once()->with(tubepress_api_const_event_EventNames::HTML_SINGLE_VIDEO, ehough_mockery_Mockery::on(function ($arg) use ($mockTemplate) {
