 ...
 */
class tubepress_addons_core_impl_listeners_gallerytemplate_CoreVariablesTest extends TubePressUnitTest
{
    /**
     * @var tubepress_addons_core_impl_listeners_gallerytemplate_CoreVariables
     */
    private $_sut;
    ...
    {
        $this->_sut = new tubepress_addons_core_impl_listeners_gallerytemplate_CoreVariables();
