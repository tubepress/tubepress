 ...
 */
class tubepress_addons_core_impl_filters_embeddedhtml_PlayerJavaScriptApiTest extends TubePressUnitTest
{
    /**
     * @var tubepress_addons_core_impl_filters_embeddedhtml_PlayerJavaScriptApi
     */
    private $_sut;
