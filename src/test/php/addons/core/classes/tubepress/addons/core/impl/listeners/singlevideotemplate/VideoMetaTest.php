 ...
 */
class tubepress_addons_core_impl_listeners_singlevideotemplate_VideoMetaTest extends TubePressUnitTest
{
    /**
     * @var tubepress_addons_core_impl_listeners_singlevideotemplate_VideoMeta
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_addons_core_impl_listeners_singlevideotemplate_VideoMeta();
    }
