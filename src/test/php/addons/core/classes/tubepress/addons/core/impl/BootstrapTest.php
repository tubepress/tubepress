...
class tubepress_addons_core_impl_BootstrapTest extends TubePressUnitTest
{
    ...
    private function _testEventListeners()
    {
        $testMap = array(
            ...
            array('tubepress_addons_core_impl_filters_variablereadfromexternalinput_StringMagic', 'onIncomingInput', tubepress_api_const_event_EventNames::VARIABLE_READ_FROM_EXTERNAL_INPUT),
            array('tubepress_addons_core_impl_filters_singlevideotemplate_CoreVariables', 'onSingleVideoTemplate', tubepress_api_const_event_EventNames::SINGLE_VIDEO_TEMPLATE_CONSTRUCTION),
            array('tubepress_addons_core_impl_filters_singlevideotemplate_VideoMeta', 'onSingleVideoTemplate', tubepress_api_const_event_EventNames::SINGLE_VIDEO_TEMPLATE_CONSTRUCTION),
            array('tubepress_addons_core_impl_filters_searchinputtemplate_CoreVariables', 'onSearchInputTemplate', tubepress_api_const_event_EventNames::SEARCH_INPUT_TEMPLATE_CONSTRUCTION),
            array('tubepress_addons_core_impl_filters_videogallerypage_PerPageSorter', 'onVideoGalleryPage', tubepress_api_const_event_EventNames::VIDEO_GALLERY_PAGE_CONSTRUCTION),
            array('tubepress_addons_core_impl_filters_videogallerypage_ResultCountCapper', 'onVideoGalleryPage', tubepress_api_const_event_EventNames::VIDEO_GALLERY_PAGE_CONSTRUCTION),
            array('tubepress_addons_core_impl_filters_videogallerypage_VideoBlacklist', 'onVideoGalleryPage', tubepress_api_const_event_EventNames::VIDEO_GALLERY_PAGE_CONSTRUCTION),
            array('tubepress_addons_core_impl_filters_videogallerypage_VideoPrepender', 'onVideoGalleryPage', tubepress_api_const_event_EventNames::VIDEO_GALLERY_PAGE_CONSTRUCTION),
            array('tubepress_addons_core_impl_filters_prevalidationoptionset_StringMagic', 'onPreValidationOptionSet', tubepress_api_const_event_EventNames::PRE_VALIDATION_OPTION_SET),
            array('tubepress_addons_core_impl_filters_prevalidationoptionset_YouTubePlaylistPlPrefixRemover', 'onPreValidationOptionSet', tubepress_api_const_event_EventNames::PRE_VALIDATION_OPTION_SET),
            array('tubepress_addons_core_impl_filters_playertemplate_CoreVariables', 'onPlayerTemplate', tubepress_api_const_event_EventNames::PLAYER_TEMPLATE_CONSTRUCTION),
            array('tubepress_addons_core_impl_filters_gallerytemplate_CoreVariables', 'onGalleryTemplate', tubepress_api_const_event_EventNames::THUMBNAIL_GALLERY_TEMPLATE_CONSTRUCTION),
            array('tubepress_addons_core_impl_filters_gallerytemplate_EmbeddedPlayerName', 'onGalleryTemplate', tubepress_api_const_event_EventNames::THUMBNAIL_GALLERY_TEMPLATE_CONSTRUCTION),
            array('tubepress_addons_core_impl_filters_gallerytemplate_Pagination', 'onGalleryTemplate', tubepress_api_const_event_EventNames::THUMBNAIL_GALLERY_TEMPLATE_CONSTRUCTION),
            array('tubepress_addons_core_impl_filters_gallerytemplate_Player', 'onGalleryTemplate', tubepress_api_const_event_EventNames::THUMBNAIL_GALLERY_TEMPLATE_CONSTRUCTION),
            array('tubepress_addons_core_impl_filters_gallerytemplate_VideoMeta', 'onGalleryTemplate', tubepress_api_const_event_EventNames::THUMBNAIL_GALLERY_TEMPLATE_CONSTRUCTION),
            array('tubepress_addons_core_impl_filters_galleryinitjs_GalleryInitJsBaseParams', 'onGalleryInitJs', tubepress_api_const_event_EventNames::GALLERY_INIT_JS_CONSTRUCTION),
            array('tubepress_addons_core_impl_filters_galleryhtml_GalleryJs', 'onGalleryHtml', tubepress_api_const_event_EventNames::THUMBNAIL_GALLERY_HTML_CONSTRUCTION),
            array('tubepress_addons_core_impl_filters_embeddedtemplate_CoreVariables', 'onEmbeddedTemplate', tubepress_api_const_event_EventNames::EMBEDDED_TEMPLATE_CONSTRUCTION),
            array('tubepress_addons_core_impl_filters_embeddedhtml_PlayerJavaScriptApi', 'onEmbeddedHtml', tubepress_api_const_event_EventNames::EMBEDDED_HTML_CONSTRUCTION),
        );
