 ...
 */
class tubepress_addons_core_impl_listeners_embeddedtemplate_CoreVariablesTest extends TubePressUnitTest
{
    /**
     * @var tubepress_addons_core_impl_listeners_embeddedtemplate_CoreVariables
     */
    private $_sut;
    ...
    {
        $this->_sut = new tubepress_addons_core_impl_listeners_embeddedtemplate_CoreVariables();
