...
class tubepress_addons_core_impl_patterns_ioc_IocContainerExtensionTest extends TubePressUnitTest
{
    ...
    private function _getExpectedAliases()
    {
        return array(
            ...
            array('ehough_tickertape_EventDispatcherInterface', 'ehough_tickertape_EventDispatcher'),
    ...
    private function _getExpectedServices()
    {
        $map = array(
            ...
            array('tubepress_addons_core_impl_filters_embeddedhtml_PlayerJavaScriptApi','tubepress_addons_core_impl_filters_embeddedhtml_PlayerJavaScriptApi'),
            array('tubepress_addons_core_impl_filters_embeddedtemplate_CoreVariables', 'tubepress_addons_core_impl_filters_embeddedtemplate_CoreVariables'),
            array('tubepress_addons_core_impl_filters_galleryhtml_GalleryJs', 'tubepress_addons_core_impl_filters_galleryhtml_GalleryJs'),
            array('tubepress_addons_core_impl_filters_galleryinitjs_GalleryInitJsBaseParams', 'tubepress_addons_core_impl_filters_galleryinitjs_GalleryInitJsBaseParams'),
            array('tubepress_addons_core_impl_filters_gallerytemplate_CoreVariables', 'tubepress_addons_core_impl_filters_gallerytemplate_CoreVariables'),
            array('tubepress_addons_core_impl_filters_gallerytemplate_EmbeddedPlayerName', 'tubepress_addons_core_impl_filters_gallerytemplate_EmbeddedPlayerName'),
            array('tubepress_addons_core_impl_filters_gallerytemplate_Pagination', 'tubepress_addons_core_impl_filters_gallerytemplate_Pagination'),
            array('tubepress_addons_core_impl_filters_gallerytemplate_Player', 'tubepress_addons_core_impl_filters_gallerytemplate_Player'),
            array('tubepress_addons_core_impl_filters_gallerytemplate_VideoMeta', 'tubepress_addons_core_impl_filters_gallerytemplate_VideoMeta'),
            array('tubepress_addons_core_impl_filters_playertemplate_CoreVariables', 'tubepress_addons_core_impl_filters_playertemplate_CoreVariables'),
            array('tubepress_addons_core_impl_filters_prevalidationoptionset_StringMagic', 'tubepress_addons_core_impl_filters_prevalidationoptionset_StringMagic'),
            array('tubepress_addons_core_impl_filters_prevalidationoptionset_YouTubePlaylistPlPrefixRemover', 'tubepress_addons_core_impl_filters_prevalidationoptionset_YouTubePlaylistPlPrefixRemover'),
            array('tubepress_addons_core_impl_filters_searchinputtemplate_CoreVariables', 'tubepress_addons_core_impl_filters_searchinputtemplate_CoreVariables'),
            array('tubepress_addons_core_impl_filters_singlevideotemplate_CoreVariables', 'tubepress_addons_core_impl_filters_singlevideotemplate_CoreVariables'),
            array('tubepress_addons_core_impl_filters_singlevideotemplate_VideoMeta', 'tubepress_addons_core_impl_filters_singlevideotemplate_VideoMeta'),
            array('tubepress_addons_core_impl_filters_variablereadfromexternalinput_StringMagic', 'tubepress_addons_core_impl_filters_variablereadfromexternalinput_StringMagic'),
            array('tubepress_addons_core_impl_filters_videogallerypage_PerPageSorter', 'tubepress_addons_core_impl_filters_videogallerypage_PerPageSorter'),
            array('tubepress_addons_core_impl_filters_videogallerypage_ResultCountCapper', 'tubepress_addons_core_impl_filters_videogallerypage_ResultCountCapper'),
            array('tubepress_addons_core_impl_filters_videogallerypage_VideoBlacklist', 'tubepress_addons_core_impl_filters_videogallerypage_VideoBlacklist'),
            array('tubepress_addons_core_impl_filters_videogallerypage_VideoPrepender', 'tubepress_addons_core_impl_filters_videogallerypage_VideoPrepender'),
        );
