 ...
 */
class tubepress_addons_core_impl_listeners_embeddedhtml_PlayerJavaScriptApiTest extends TubePressUnitTest
{
    /**
     * @var tubepress_addons_core_impl_listeners_embeddedhtml_PlayerJavaScriptApi
     */
    private $_sut;
    ...
    {
        $this->_sut = new tubepress_addons_core_impl_listeners_embeddedhtml_PlayerJavaScriptApi();
