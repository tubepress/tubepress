 ...
 */
class tubepress_addons_core_impl_listeners_gallerytemplate_PlayerTest extends TubePressUnitTest
{
    /**
     * @var tubepress_addons_core_impl_listeners_gallerytemplate_Player
     */
    private $_sut;
    ...
    {
        $this->_sut = new tubepress_addons_core_impl_listeners_gallerytemplate_Player();
