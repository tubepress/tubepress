 ...
 */
class tubepress_addons_core_impl_listeners_galleryinitjs_GalleryInitJsBaseParamsTest extends TubePressUnitTest
{
    /**
     * @var tubepress_addons_core_impl_listeners_galleryinitjs_GalleryInitJsBaseParams
     */
    private $_sut;
