 ...
 */
class tubepress_addons_core_impl_listeners_searchinputtemplate_CoreVariablesTest extends TubePressUnitTest
{
    /**
     * @var tubepress_addons_core_impl_listeners_searchinputtemplate_CoreVariables
     */
    private $_sut;
    ...
    {
        $this->_sut = new tubepress_addons_core_impl_listeners_searchinputtemplate_CoreVariables();
