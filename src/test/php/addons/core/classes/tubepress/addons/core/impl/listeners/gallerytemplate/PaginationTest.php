 ...
 */
class tubepress_addons_core_impl_listeners_gallerytemplate_PaginationTest extends TubePressUnitTest
{
    /**
     * @var tubepress_addons_core_impl_listeners_gallerytemplate_Pagination
     */
    private $_sut;
    ...
    {
        $this->_sut = new tubepress_addons_core_impl_listeners_gallerytemplate_Pagination();
...
';
        ...
        $this->_mockEventDispatcher->shouldReceive('dispatch')->once()->with(tubepress_api_const_event_EventNames::PAGINATION_HTML_CONSTRUCTION, ehough_mockery_Mockery::on(function ($arg) use ($expectedHtml) {
