 ...
 */
class tubepress_addons_core_impl_listeners_gallerytemplate_EmbeddedPlayerNameTest extends TubePressUnitTest
{
    /**
     * @var tubepress_addons_core_impl_listeners_gallerytemplate_EmbeddedPlayerName
     */
    private $_sut;
    ...
    {
        $this->_sut = new tubepress_addons_core_impl_listeners_gallerytemplate_EmbeddedPlayerName();
