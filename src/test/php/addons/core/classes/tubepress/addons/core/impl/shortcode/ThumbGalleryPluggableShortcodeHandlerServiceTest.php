...
class tubepress_addons_core_impl_shortcode_ThumbGalleryPluggableShortcodeHandlerServiceTest extends tubepress_test_TubePressUnitTest
{
    ...
    public function testExecuteGenerateGalleryId()
    {
        ...
        $this->_mockEventDispatcher->shouldReceive('publish')->once()->with(tubepress_api_const_event_EventNames::TEMPLATE_THUMBNAIL_GALLERY, ehough_mockery_Mockery::on(function ($arg) use ($mockTemplate) {
        ...
        $this->_mockEventDispatcher->shouldReceive('publish')->once()->with(tubepress_api_const_event_EventNames::HTML_THUMBNAIL_GALLERY, ehough_mockery_Mockery::on(function ($arg) use ($mockTemplate) {
