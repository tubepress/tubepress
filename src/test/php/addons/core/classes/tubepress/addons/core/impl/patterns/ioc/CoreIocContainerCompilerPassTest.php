 ...
 */
class tubepress_addons_core_impl_patterns_ioc_CoreIocContainerCompilerPassTest extends TubePressUnitTest
{
    /**
     * @var tubepress_addons_core_impl_patterns_ioc_CoreIocContainerCompilerPass
     */
    private $_sut;
    ...
    {
        $this->_sut = new tubepress_addons_core_impl_patterns_ioc_CoreIocContainerCompilerPass();
