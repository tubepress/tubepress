 ...
 */
class tubepress_addons_youtube_impl_listeners_boot_YouTubeOptionsRegistrarTest extends tubepress_test_TubePressUnitTest
{
    /**
    ...
    /**
     * @var tubepress_addons_youtube_impl_listeners_boot_YouTubeOptionsRegistrar
     */
    private $_sut;
    ...
    private static $_valueMapTime = array(
        ...
        tubepress_addons_youtube_api_const_options_values_YouTube::TIMEFRAME_THIS_MONTH => 'this month',      //>(translatable)<
        tubepress_addons_youtube_api_const_options_values_YouTube::TIMEFRAME_THIS_WEEK  => 'this week',       //>(translatable)<
    ...
    public function onSetup()
    {
        ...
        $this->_sut                            = new tubepress_addons_youtube_impl_listeners_boot_YouTubeOptionsRegistrar();
    }
