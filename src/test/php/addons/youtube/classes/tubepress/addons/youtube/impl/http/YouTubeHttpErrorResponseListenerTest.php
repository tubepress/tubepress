 ...
 */
class tubepress_addons_youtube_impl_http_YouTubeHttpErrorResponseListenerTest extends TubePressUnitTest
{
    /**
     * @var tubepress_addons_youtube_impl_http_YouTubeHttpErrorResponseListener
     */
    private $_sut;

    public function onSetup()
    {
        $this->_sut = new tubepress_addons_youtube_impl_http_YouTubeHttpErrorResponseListener();
    }
