 ...
 */
class tubepress_addons_jwplayer_impl_embedded_JwPlayerTemplateVarsTest extends TubePressUnitTest
{
    /**
     * @var tubepress_addons_jwplayer_impl_listeners_embeddedtemplate_JwPlayerTemplateVars
     */
    private $_sut;
    ...
    public function onSetup() {
        ...
        $this->_sut = new tubepress_addons_jwplayer_impl_listeners_embeddedtemplate_JwPlayerTemplateVars();
