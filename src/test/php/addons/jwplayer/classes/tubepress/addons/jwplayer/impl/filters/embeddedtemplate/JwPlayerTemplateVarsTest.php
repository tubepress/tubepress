...
{
    /**
     * @var tubepress_addons_jwplayer_impl_filters_embeddedtemplate_JwPlayerTemplateVars
     */
    private $_sut;
    ...
    public function onSetup() {
        ...
        $this->_sut = new tubepress_addons_jwplayer_impl_filters_embeddedtemplate_JwPlayerTemplateVars();
