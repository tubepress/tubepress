...
/**
 * @covers tubepress_wordpress_impl_OptionsPage
 */
class tubepress_test_wordpress_impl_OptionsPageTest extends tubepress_test_TubePressUnitTest
{
    ...
    public function onSetup()
    {
        ...
        $this->_mockFormHandler                 = $this->mock('tubepress_core_api_options_ui_FormInterface');
        $this->_mockEnvironmentDetector         = $this->mock(tubepress_core_api_environment_EnvironmentInterface::_);

        $this->_sut = new tubepress_wordpress_impl_OptionsPage(
