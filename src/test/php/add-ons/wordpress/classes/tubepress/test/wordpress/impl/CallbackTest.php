...
class tubepress_test_wordpress_impl_CallbackTest extends tubepress_test_TubePressUnitTest
{
    ...
    {
        $mockEnvironmentDetector    = $this->mock(tubepress_core_api_environment_EnvironmentInterface::_);
    ...
    public function testFilter()
    {
        ...
        $mockFilterEvent = $this->mock('tubepress_core_api_event_EventInterface');
    ...
    {
        $mockActionEvent = $this->mock('tubepress_core_api_event_EventInterface');
    ...
    {
        return $event instanceof tubepress_core_api_event_EventInterface
