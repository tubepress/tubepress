...
/**
 * @covers tubepress_wordpress_impl_actions_AdminNotices
 */
class tubepress_test_wordpress_impl_actions_AdminNoticesTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_wordpress_impl_actions_AdminNotices
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_mockQss                         = $this->mock(tubepress_core_api_url_UrlFactoryInterface::_);
        $this->_sut                             = new tubepress_wordpress_impl_actions_AdminNotices(
