...
class tubepress_test_addons_wordpress_impl_WidgetTest extends tubepress_test_TubePressUnitTest
{
    ...
    public function testPrintWidgetControl()
    {
        ...
        $mockTemplate->shouldReceive('setVariable')->once()->with(tubepress_addons_wordpress_impl_DefaultWidgetHandler::WIDGET_CONTROL_SHORTCODE, '<<TubePress shortcode for the widget. See the <a href="http://docs.tubepress.com/" target="_blank">documentation</a>.>>');
