...
/**
 * @covers tubepress_addons_puzzle_impl_url_PuzzleBasedUrl<extended>
 */
class tubepress_test_addons_puzzle_impl_url_PuzzleBasedUrlTest extends tubepress_test_TubePressUnitTest
{
    const RFC3986_BASE = "http://a/b/c/d;p?q";

    public function testEmptyUrl()
    {
        $url = new tubepress_addons_puzzle_impl_url_PuzzleBasedUrl(puzzle_Url::fromString(''));
        $this->assertEquals('', (string) $url);
    }

    public function testPortIsDeterminedFromScheme()
    {
        $u = new tubepress_addons_puzzle_impl_url_PuzzleBasedUrl(puzzle_Url::fromString('http://www.test.com/'));
        $this->assertEquals(80, $u->getPort());
        $u = new tubepress_addons_puzzle_impl_url_PuzzleBasedUrl(puzzle_Url::fromString('https://www.test.com/'));
        $this->assertEquals(443, $u->getPort());
        $u = new tubepress_addons_puzzle_impl_url_PuzzleBasedUrl(puzzle_Url::fromString('ftp://www.test.com/'));
        $this->assertEquals(21, $u->getPort());
        $u = new tubepress_addons_puzzle_impl_url_PuzzleBasedUrl(puzzle_Url::fromString('http://www.test.com:8192/'));
        $this->assertEquals(8192, $u->getPort());
        $u = new tubepress_addons_puzzle_impl_url_PuzzleBasedUrl(puzzle_Url::fromString('foo://www.test.com/'));
        $this->assertEquals(null, $u->getPort());
    }

    public function testRemovesDefaultPortWhenSettingScheme()
    {
        $url = new tubepress_addons_puzzle_impl_url_PuzzleBasedUrl(puzzle_Url::fromString('http://www.test.com/'));
        $url->setPort(80);
        $url->setScheme('https');
    ...
    {
        $url = new tubepress_addons_puzzle_impl_url_PuzzleBasedUrl(puzzle_Url::fromString('/index.php'));
        $this->assertEquals('/index.php', (string) $url);
        $this->assertFalse($url->isAbsolute());

        $url = 'http://michael:test@test.com:80/path/123?q=abc#test';
        $u = new tubepress_addons_puzzle_impl_url_PuzzleBasedUrl(puzzle_Url::fromString($url));
    ...
    {
        $url = new tubepress_addons_puzzle_impl_url_PuzzleBasedUrl(puzzle_Url::fromString('http://a:50/0?0#0'));
        ...
        $url = new tubepress_addons_puzzle_impl_url_PuzzleBasedUrl(puzzle_Url::fromString('0'));
    ...
    {
        $url = new tubepress_addons_puzzle_impl_url_PuzzleBasedUrl(puzzle_Url::fromString('http://test:pass@www.test.com:8081/path/path2/?a=1&b=2#fragment'));
    ...
    {
        // Does nothing here
        $this->assertEquals('http://e.com/base?a=1', (string) new tubepress_addons_puzzle_impl_url_PuzzleBasedUrl(puzzle_Url::fromString('http://e.com/base?a=1')->addPath(false)));
        $this->assertEquals('http://e.com/base?a=1', (string) new tubepress_addons_puzzle_impl_url_PuzzleBasedUrl(puzzle_Url::fromString('http://e.com/base?a=1')->addPath('')));
        $this->assertEquals('http://e.com/base?a=1', (string) new tubepress_addons_puzzle_impl_url_PuzzleBasedUrl(puzzle_Url::fromString('http://e.com/base?a=1')->addPath('/')));
        $this->assertEquals('http://e.com/base/0', (string) new tubepress_addons_puzzle_impl_url_PuzzleBasedUrl(puzzle_Url::fromString('http://e.com/base')->addPath('0')));

        $this->assertEquals('http://e.com/base/relative?a=1', (string) new tubepress_addons_puzzle_impl_url_PuzzleBasedUrl(puzzle_Url::fromString('http://e.com/base?a=1')->addPath('relative')));
        $this->assertEquals('http://e.com/base/relative?a=1', (string) new tubepress_addons_puzzle_impl_url_PuzzleBasedUrl(puzzle_Url::fromString('http://e.com/base?a=1')->addPath('/relative')));
    }
    ...
    {
        $this->assertEquals($c, (string) new tubepress_addons_puzzle_impl_url_PuzzleBasedUrl(puzzle_Url::fromString($a)->combine($b)));
    }
    ...
    public function testHasGettersAndSetters()
    {
        ...
        $this->assertEquals('b=boo', (string) $url->setQuery(new tubepress_addons_puzzle_impl_url_PuzzleBasedQuery(new puzzle_Query(array(
            'b' => 'boo'
        ))))->getQuery());
    ...
    {
        $url = new tubepress_addons_puzzle_impl_url_PuzzleBasedUrl(puzzle_Url::fromString('http://www.test.com'));
        $url->setQuery(new tubepress_addons_puzzle_impl_url_PuzzleBasedQuery(new puzzle_Query(array('a' => 'b'))));
    ...
    {
        $url = new tubepress_addons_puzzle_impl_url_PuzzleBasedUrl(puzzle_Url::fromString('http://www.example.com'));
    ...
    {
        new tubepress_addons_puzzle_impl_url_PuzzleBasedUrl(puzzle_Url::fromString('foo:////'));
    }

    public function testConvertsSpecialCharsInPathWhenCastingToString()
    {
        $url = new tubepress_addons_puzzle_impl_url_PuzzleBasedUrl(puzzle_Url::fromString('http://foo.com/baz bar?a=b'));
        $url->addPath('?');
    ...
    {
        $url = new tubepress_addons_puzzle_impl_url_PuzzleBasedUrl(puzzle_Url::fromString('http://eric:pass@foo.com:344/baz/bar?a=b'));
