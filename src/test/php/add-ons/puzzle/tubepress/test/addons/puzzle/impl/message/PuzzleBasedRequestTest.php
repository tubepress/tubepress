...
/**
 * @covers tubepress_addons_puzzle_impl_message_PuzzleBasedRequest<extended>
 */
class tubepress_test_addons_puzzle_impl_message_PuzzleRequestTest extends tubepress_test_TubePressUnitTest
{
    public function testConfig()
    {
        $r = new puzzle_message_Request('PUT', '/test', array('test' => '123'), puzzle_stream_Stream::factory('foo'));
        $r = new tubepress_addons_puzzle_impl_message_PuzzleBasedRequest($r);
    ...
    public function testQueryCanChange()
    {
        ...
        $r->getUrl()->setQuery(new tubepress_addons_puzzle_impl_url_PuzzleBasedQuery(new puzzle_Query(array('foo' => 'bar'))));
