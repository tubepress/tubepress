...
/**
 * @covers tubepress_addons_core_impl_listeners_videogallerypage_ResultCountCapper
 */
class tubepress_test_addons_core_impl_listeners_videogallerypage_ResultCountCapperTest extends tubepress_test_TubePressUnitTest
{
    /**
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_addons_core_impl_listeners_videogallerypage_ResultCountCapper($this->_mockExecutionContext);
    }
