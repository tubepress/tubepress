...
/**
 * @covers tubepress_core_impl_options_ui_fields_provided_SpectrumColorField<extended>
 */
class tubepress_test_core_impl_options_ui_fields_SpectrumColorFieldTest extends tubepress_test_core_impl_options_ui_fields_provided_AbstractProvidedOptionBasedFieldTest
{
    protected function buildSut()
    {
        return new tubepress_core_impl_options_ui_fields_provided_SpectrumColorField(
