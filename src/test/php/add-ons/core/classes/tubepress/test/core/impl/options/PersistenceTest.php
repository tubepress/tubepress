...
/**
 * @covers tubepress_core_impl_options_Persistence<extended>
 */
class tubepress_test_core_impl_options_PersistenceTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_impl_options_Persistence
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_mockBackend         = $this->mock(tubepress_core_api_options_PersistenceBackendInterface::_);
        $this->_mockStringUtils     = $this->mock(tubepress_api_util_StringUtilsInterface::_);
        $this->_mockLogger          = $this->mock(tubepress_api_log_LoggerInterface::_);

        $this->_sut = new tubepress_core_impl_options_Persistence(
    ...
    {
        $this->_mockLogger->shouldReceive('isEnabled')->once()->andReturn(true);
        $this->_mockLogger->shouldReceive('debug')->once();
    ...
    private function _setupFilters($name, $value)
    {
        ...
        //$this->_mockEventDispatcher->shouldReceive('dispatch')->once()->with(tubepress_core_api_const_event_EventNames::OPTION_ANY_PRE_VALIDATION_SET, ehough_mockery_Mockery::type('tubepress_core_api_event_EventInterface'));
        //$this->_mockEventDispatcher->shouldReceive('dispatch')->once()->with(tubepress_core_api_const_event_EventNames::OPTION_SINGLE_PRE_VALIDATION_SET . ".$name", ehough_mockery_Mockery::type('tubepress_core_api_event_EventInterface'));
    }
}
