...
/**
 * @covers tubepress_core_impl_http_puzzle_PuzzleHttpClient
 */
class tubepress_test_core_impl_http_puzzle_http_PuzzleHttpClientTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_impl_http_puzzle_PuzzleHttpClient
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $mockEmitter->shouldReceive('attach')->once()->with(ehough_mockery_Mockery::type('tubepress_core_impl_http_puzzle_PuzzleHttpClient'));

        $this->_sut = new tubepress_core_impl_http_puzzle_PuzzleHttpClient(
    ...
    {
        $mockBody = $this->mock('tubepress_core_api_stream_StreamInterface');
        ...
        } catch (tubepress_core_api_http_RequestException $e) {

            $this->assertEquals('something bad', $e->getMessage());
            $this->assertTrue($e->getRequest() instanceof tubepress_core_api_http_RequestInterface);
            $this->assertTrue($e->getResponse() instanceof tubepress_core_api_http_ResponseInterface);
            return;
        }
    ...
    public function tesjtSendNormal()
    {
        ...
        $this->assertInstanceOf('tubepress_core_api_http_ResponseInterface', $response);
    ...
    public function tjestCreateRequest()
    {
        ...
        $this->assertInstanceOf('tubepress_core_api_http_RequestInterface', $request);
