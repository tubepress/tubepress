...
/**
 * @covers tubepress_core_impl_stream_puzzle_FlexibleStream<extended>
 */
class tubepress_test_core_impl_stream_puzzle_FlexibleStreamTest extends tubepress_test_TubePressUnitTest
{
    /**
    ...
    /**
     * @var tubepress_core_impl_stream_puzzle_FlexibleStream
     */
    private $_sut;

    public function onSetup()
    {
        $this->_mock = $this->mock('tubepress_core_api_stream_StreamInterface');
        $this->_sut  = new tubepress_core_impl_stream_puzzle_FlexibleStream($this->_mock);
    }

    /**
     * @expectedException InvalidArgumentException
     * @expectedExceptionMessage tubepress_core_impl_stream_puzzle_FlexibleStream must be constructed with instance of either puzzle_stream_StreamInterface or tubepress_core_api_stream_StreamInterface
     *
     */
    public function testNonStreamArg()
    {
        new tubepress_core_impl_stream_puzzle_FlexibleStream(array('foo'));
    }
