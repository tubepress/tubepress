...
/**
 * @covers tubepress_core_impl_theme_ThemesPrimerPass<extended>
 */
class tubepress_test_core_impl_ioc_compiler_ThemesPrimerPassTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_impl_theme_ThemesPrimerPass
     */
    private $_sut;
    ...
    {
        $this->_sut                  = new tubepress_core_impl_theme_ThemesPrimerPass();
    ...
    public function testProcess()
    {
        ...
        $mockThemeFinder   = $this->mock(tubepress_api_contrib_RegistryInterface::_);
        ...
        $this->_mockContainerBuilder->shouldReceive('get')->once()->with(tubepress_api_log_LoggerInterface::_)->andReturn($mockLogger);
        $this->_mockContainerBuilder->shouldReceive('findTaggedServiceIds')->once()->with(tubepress_api_contrib_RegistryInterface::_)->andReturn(array(
            'x' => array('type' => tubepress_core_api_theme_ThemeInterface::_)
        ));

        $mockTheme  = $this->mock(tubepress_core_api_theme_ThemeInterface::_);
        ...
        $mockTemplate = $this->mock('SplFileInfo');
