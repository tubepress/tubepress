...
/**
 * @covers tubepress_core_impl_options_ui_fields_ParticipantFilterField<extended>
 */
class tubepress_test_core_impl_options_ui_fields_ParticipantFilterFieldTest extends tubepress_test_core_impl_options_ui_fields_AbstractMultiSelectFieldTest
{
    /**
    ...
    /**
     * @var tubepress_core_api_options_ui_FieldProviderInterface[]
     */
    private $_mockOptionsPageParticipants;

    /**
     * @return tubepress_core_impl_options_ui_fields_AbstractOptionsPageField
     */
    protected function buildSut()
    {
        $sut = new tubepress_core_impl_options_ui_fields_ParticipantFilterField(
    ...
    protected function onAfterTemplateBasedFieldSetup()
    {
        ...
        $this->_mockOptionProvider->shouldReceive('getLabel')->once()->with(tubepress_core_api_const_options_Names::DISABLED_OPTIONS_PAGE_PARTICIPANTS)->andReturn('mock label');
        $this->_mockOptionProvider->shouldReceive('getDescription')->once()->with(tubepress_core_api_const_options_Names::DISABLED_OPTIONS_PAGE_PARTICIPANTS)->andReturn('mock desc');

        $this->_mockOptionsPageParticipants = array();

        foreach (array('a', 'b', 'c', 'd') as $letter) {

            $participant = $this->mock('tubepress_core_api_options_ui_FieldProviderInterface');
    ...
    {
        $this->getMockPersistence()->shouldReceive('queueForSave')->once()->with(tubepress_core_api_const_options_Names::DISABLED_OPTIONS_PAGE_PARTICIPANTS, 'a;b;d')->andReturn($errorMessage);
    }

    protected function setupExpectationsForGoodStorageWhenAllMissing()
    {
        $this->getMockPersistence()->shouldReceive('queueForSave')->once()->with(tubepress_core_api_const_options_Names::DISABLED_OPTIONS_PAGE_PARTICIPANTS, 'a;b;d')->andReturn(null);
    }
    ...
    {
        $this->getMockPersistence()->shouldReceive('fetch')->once()->with(tubepress_core_api_const_options_Names::DISABLED_OPTIONS_PAGE_PARTICIPANTS)->andReturn('a;b;c');
    ...
    protected function setupExpectationsForFailedStorageWhenMixed($errorMessage)
    {
        ...
        $this->getMockPersistence()->shouldReceive('queueForSave')->once()->with(tubepress_core_api_const_options_Names::DISABLED_OPTIONS_PAGE_PARTICIPANTS, 'd')->andReturn($errorMessage);
    }
    ...
    protected function setupExpectationsForGoodStorageWhenMixed()
    {
        ...
        $this->getMockPersistence()->shouldReceive('queueForSave')->once()->with(tubepress_core_api_const_options_Names::DISABLED_OPTIONS_PAGE_PARTICIPANTS, 'd')->andReturn(null);
    }
