...
/**
 * @covers tubepress_addons_core_impl_listeners_html_EmbeddedPlayerApiJs
 */
class tubepress_test_addons_core_impl_listeners_html_EmbeddedPlayerApiJsTest extends tubepress_test_TubePressUnitTest
{
    /**
