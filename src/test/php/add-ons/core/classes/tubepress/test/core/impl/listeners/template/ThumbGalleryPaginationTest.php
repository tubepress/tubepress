...
/**
 * @covers tubepress_core_impl_listeners_template_ThumbGalleryPagination
 */
class tubepress_test_core_impl_listeners_template_ThumbGalleryPaginationTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_impl_listeners_template_ThumbGalleryPagination
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_mockCurrentUrlService           = $this->mock(tubepress_core_api_url_UrlFactoryInterface::_);
        $messageService                         = $this->mock(tubepress_core_api_translation_TranslatorInterface::_);
        ...
        $this->_mockUrlUtils                    = $this->mock('tubepress_core_api_util_UrlUtilsInterface');
        $this->_mockThemeLibrary                = $this->mock(tubepress_core_api_theme_ThemeLibraryInterface::_);

        $this->_mockExecutionContext->shouldReceive('get')->once()->with(tubepress_core_api_const_options_Names::PAGINATE_ABOVE)->andReturn(true);
        $this->_mockExecutionContext->shouldReceive('get')->once()->with(tubepress_core_api_const_options_Names::PAGINATE_BELOW)->andReturn(true);
        $this->_mockExecutionContext->shouldReceive('get')->once()->with(tubepress_core_api_const_options_Names::RESULTS_PER_PAGE)->andReturn(4);
        ...
        $this->_mockFullUrl = $this->mock('tubepress_core_api_url_UrlInterface');
        $this->_mockFullQuery = $this->mock('tubepress_core_api_url_QueryInterface');
        ...
        $this->_mockTemplate->shouldReceive('getContext')->twice()->andReturn(array('x' => 'z'));
        $this->_mockTemplate->shouldReceive('setContext')->once()->with(array(

            'x' => 'z',
            tubepress_core_api_const_template_Variable::PAGINATION_BOTTOM => 'pagination-html',
            tubepress_core_api_const_template_Variable::PAGINATION_TOP    => 'pagination-html'
        ));

        $this->_sut = new tubepress_core_impl_listeners_template_ThumbGalleryPagination(
    ...
    public function testModern()
    {
        ...
        $this->_mockTemplateFactory->shouldReceive('fromFilesystem')->once()->with(array('pagination.tpl.php', TUBEPRESS_ROOT . '/src/main/web/themes/default/pagination.tpl.php'))->andReturn($mockTemplate);
        $expectedTemplateVars = array(

            tubepress_core_api_const_template_Variable::PAGINATION_CURRENT_PAGE     => 25,
            tubepress_core_api_const_template_Variable::PAGINATION_TOTAL_ITEMS      => 500,
            tubepress_core_api_const_template_Variable::PAGINATION_HREF_FORMAT      => 'foobar',
            tubepress_core_api_const_template_Variable::PAGINATION_RESULTS_PER_PAGE => 4,
            tubepress_core_api_const_template_Variable::PAGINATION_TEXT_NEXT        => '##next##',
            tubepress_core_api_const_template_Variable::PAGINATION_TEXT_PREV        => '##prev##',
        );
        ...
        $this->_mockEventDispatcher->shouldReceive('dispatch')->once()->with(tubepress_core_api_const_event_EventNames::TEMPLATE_PAGINATION, $mockTemplateEvent);
        ...
        $this->_mockEventDispatcher->shouldReceive('dispatch')->once()->with(tubepress_core_api_const_event_EventNames::HTML_PAGINATION, $mockHtmlEvent);

        $this->_mockHttpRequestParameterService->shouldReceive('getParamValueAsInt')->once()->with(tubepress_core_api_const_http_ParamName::PAGE, 1)->andReturn(25);
    ...
    public function testLegacyMiddlePage()
    {
        ...
        $this->_mockHttpRequestParameterService->shouldReceive('getParamValueAsInt')->once()->with(tubepress_core_api_const_http_ParamName::PAGE, 1)->andReturn(12);
    ...
    public function testLegacy()
    {
        ...
        $this->_mockEventDispatcher->shouldReceive('newEventInstance')->once()->with($expectedHtml)->andReturn($mockHtmlEvent);
        $this->_mockEventDispatcher->shouldReceive('dispatch')->once()->with(tubepress_core_api_const_event_EventNames::HTML_PAGINATION, $mockHtmlEvent);
        $this->_mockHttpRequestParameterService->shouldReceive('getParamValueAsInt')->once()->with(tubepress_core_api_const_http_ParamName::PAGE, 1)->andReturn(1);
    ...
    private function _test()
    {
        ...
        $event->shouldReceive('getArgument')->with('page')->andReturn(1);
        $event->shouldReceive('getArgument')->with('providerName')->andReturn('provider-name');
        $event->shouldReceive('getArgument')->with('videoGalleryPage')->andReturn($this->_providerResult);
