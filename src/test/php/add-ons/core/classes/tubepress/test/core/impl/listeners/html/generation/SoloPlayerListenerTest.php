...
/**
 * @covers tubepress_core_impl_listeners_html_generation_SoloPlayerListener
 */
class tubepress_test_core_impl_shortcode_SoloPlayerCommandTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_impl_listeners_html_generation_SoloPlayerListener
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_mockSingleVideoShortcodeHandler = $this->mock('tubepress_core_impl_listeners_html_generation_SingleVideoListener');
        ...
        $this->_sut = new tubepress_core_impl_listeners_html_generation_SoloPlayerListener(
    ...
    {
        $this->_mockExecutionContext->shouldReceive('get')->once()->with(tubepress_core_api_const_options_Names::PLAYER_LOCATION)->andReturn('shadowbox');
    ...
    {
        $this->_mockExecutionContext->shouldReceive('get')->once()->with(tubepress_core_api_const_options_Names::PLAYER_LOCATION)->andReturn('solo');
    ...
    public function testExecute()
    {
        ...
        $this->_mockExecutionContext->shouldReceive('set')->once()->with(tubepress_core_api_const_options_Names::VIDEO, 'video-id')->andReturn(true);

        $this->_mockHttpRequestParameterService->shouldReceive('getParamValue')->twice()->with(tubepress_core_api_const_http_ParamName::VIDEO)->andReturn('video-id');
