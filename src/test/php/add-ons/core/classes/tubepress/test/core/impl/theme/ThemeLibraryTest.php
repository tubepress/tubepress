...
/**
 * @covers tubepress_core_impl_theme_ThemeLibrary<extended>
 */
class tubepress_test_core_impl_theme_ThemeHandlerTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_impl_theme_ThemeLibrary
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_core_impl_theme_ThemeLibrary(array(
    ...
    {
        $this->_mockContext->shouldReceive('get')->once()->with(tubepress_core_api_const_options_Names::THEME)->andReturn('cool/theme');
    ...
    {
        $this->_mockContext->shouldReceive('get')->once()->with(tubepress_core_api_const_options_Names::THEME)->andReturn('some/theme');
        ...
        foreach ($expected as $url) {
            $mockUrl = $this->mock('tubepress_core_api_url_UrlString');
    ...
    {
        $this->_mockContext->shouldReceive('get')->once()->with(tubepress_core_api_const_options_Names::THEME)->andReturn('tubepress/default');
        $mockBaseUrl = $this->mock('tubepress_core_api_url_UrlInterface');
        $mockBaseUrl->shouldReceive('toString')->twice()->andReturn('http://foo.bar/hello');
        $this->_mockEnvironmentDetector->shouldReceive('getBaseUrl')->times(2)->andReturn($mockBaseUrl);
