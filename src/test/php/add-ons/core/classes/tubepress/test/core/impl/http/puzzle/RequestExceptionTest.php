...
/**
 * @covers tubepress_core_impl_http_puzzle_RequestException
 */
class tubepress_test_core_impl_http_puzzle_exception_RequestExceptionTest extends tubepress_test_TubePressUnitTest
{
    /**
    ...
    /**
     * @var tubepress_core_impl_http_puzzle_RequestException
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_core_impl_http_puzzle_RequestException($this->_mockPuzzleException);
    }
    ...
    public function testGetResponse()
    {
        ...
        $this->assertInstanceOf('tubepress_core_api_http_ResponseInterface', $request);
