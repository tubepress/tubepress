...
/**
 * @covers tubepress_core_impl_options_ui_Form<extended>
 */
class tubepress_test_core_impl_options_ui_FormTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_impl_options_ui_Form
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_mockTemplate            = $this->mock(tubepress_core_api_template_TemplateInterface::_);

        $mockFieldA        = $this->mock('tubepress_core_api_options_ui_FieldInterface');
        $mockFieldB        = $this->mock('tubepress_core_api_options_ui_FieldInterface');
        $this->_mockFields = array($mockFieldA, $mockFieldB);

        $mockParticipant  = $this->mock('tubepress_core_api_options_ui_FieldProviderInterface');
        $mockParticipant->shouldReceive('getFields')->once()->andReturn($this->_mockFields);
        $this->_mockParticipants = array($mockParticipant);

        $this->_sut = new tubepress_core_impl_options_ui_Form(
    ...
    {
        $mockCategory   = $this->mock('tubepress_core_api_options_ui_ElementInterface');
        ...
        $this->_mockEventDispatcher->shouldReceive('dispatch')->once()
            ->with(tubepress_core_api_const_event_EventNames::OPTIONS_PAGE_TEMPLATE, $mockEvent);
