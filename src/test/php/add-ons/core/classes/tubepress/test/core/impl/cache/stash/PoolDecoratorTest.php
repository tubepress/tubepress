...
/**
 * @covers tubepress_core_impl_cache_stash_PoolDecorator
 */
class tubepress_test_core_impl_cache_stash_PoolDecoratorTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_impl_cache_stash_PoolDecorator
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut         = new tubepress_core_impl_cache_stash_PoolDecorator($this->_mockContext, $this->_mockPool);
    }
    ...
    public function testGetItem()
    {
        ...
        $this->assertInstanceOf('tubepress_core_impl_cache_stash_ItemDecorator', $item);
    }
