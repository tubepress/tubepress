...
/**
 * @covers tubepress_core_impl_util_TimeUtils
 */
class tubepress_test_core_impl_util_TimeUtilsTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_impl_util_TimeUtils
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_core_impl_util_TimeUtils($stringUtils);
    }
