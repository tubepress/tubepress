...
/**
 * @covers tubepress_core_impl_shortcode_ShortcodeExtension
 */
class tubepress_test_core_impl_shortcode_ShortcodeExtensionTest extends tubepress_test_impl_ioc_AbstractIocContainerExtensionTest
{

    /**
     * @return tubepress_core_impl_shortcode_ShortcodeExtension
     */
    protected function buildSut()
    {
        return  new tubepress_core_impl_shortcode_ShortcodeExtension();
    }
    ...
    protected function prepareForLoad()
    {
        $this->expectRegistration(
            ...
            tubepress_core_api_shortcode_ParserInterface::_,
            'tubepress_core_impl_shortcode_Parser'
    ...
    protected function getExpectedServiceContructionMap()
    {
        return array(
            ...
            tubepress_core_api_shortcode_ParserInterface::_ => 'tubepress_core_impl_shortcode_Parser'
        );
    }
