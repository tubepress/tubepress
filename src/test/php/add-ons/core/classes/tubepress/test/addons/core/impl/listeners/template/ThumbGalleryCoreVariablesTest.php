...
/**
 * @covers tubepress_addons_core_impl_listeners_template_ThumbGalleryCoreVariables
 */
class tubepress_test_addons_core_impl_listeners_template_ThumbGalleryCoreVariablesTest extends tubepress_test_TubePressUnitTest
{
    /**
