 ...
 */ 
class tubepress_test_core_impl_http_puzzle_message_MessageTest extends tubepress_test_TubePressUnitTest
{
    public function testHasProtocolVersion()
    {
        $m = new tubepress_test_core_impl_http_puzzle_message_MessageTest__foo(new tubepress_test_core_impl_http_puzzle_message_MessageTest__bar());
    ...
    public function testHasBody()
    {
        ...
        $s = new tubepress_core_impl_stream_puzzle_FlexibleStream(puzzle_stream_Stream::factory('test'));
        $m->setBody($s);
    ...
    {
        $m = new tubepress_test_core_impl_http_puzzle_message_MessageTest__foo(new tubepress_test_core_impl_http_puzzle_message_MessageTest__bar());
        $m->setBody(new tubepress_core_impl_stream_puzzle_FlexibleStream(puzzle_stream_Stream::factory('foo')));
    ...
    public function testCastsToString()
    {
        $m = new tubepress_test_core_impl_http_puzzle_message_MessageTest__foo(new tubepress_test_core_impl_http_puzzle_message_MessageTest__bar());
        $m->setHeader('foo', 'bar');
        $m->setBody(new tubepress_core_impl_stream_puzzle_FlexibleStream(puzzle_stream_Stream::factory('baz')));
        $this->assertEquals("foobar\r\nfoo: bar\r\n\r\nbaz", (string) $m);
    }

    public function testAddsHeadersWhenNotPresent()
    {
        $h = new tubepress_test_core_impl_http_puzzle_message_MessageTest__foo(new tubepress_test_core_impl_http_puzzle_message_MessageTest__bar());
        $h->addHeader('foo', 'bar');
...
class tubepress_test_core_impl_http_puzzle_message_MessageTest__bar extends puzzle_message_AbstractMessage
{
    /**
...
class tubepress_test_core_impl_http_puzzle_message_MessageTest__foo extends tubepress_core_impl_http_puzzle_AbstractMessage
{
