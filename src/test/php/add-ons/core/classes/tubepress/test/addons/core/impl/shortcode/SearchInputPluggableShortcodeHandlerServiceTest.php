...
/**
 * @covers tubepress_addons_core_impl_shortcode_SearchInputPluggableShortcodeHandlerService
 */
class tubepress_test_addons_core_impl_shortcode_SearchInputPluggableShortcodeHandlerServiceTest extends tubepress_test_TubePressUnitTest
{
    /**
    ...
    public function testExecute()
    {
        ...
        $this->_mockThemeHandler->shouldReceive('getTemplateInstance')->once()->with('search/search_input.tpl.php', TUBEPRESS_ROOT . '/src/main/web/themes/default')->andReturn($mockTemplate);
