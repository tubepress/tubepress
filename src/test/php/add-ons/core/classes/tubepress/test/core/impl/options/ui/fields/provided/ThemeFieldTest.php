...
/**
 * @covers tubepress_core_impl_options_ui_fields_provided_ThemeField<extended>
 */
class tubepress_test_core_impl_options_ui_fields_ThemeFieldTest extends tubepress_test_core_impl_options_ui_fields_provided_DropdownFieldTest
{
    /**
    ...
    {
        return new tubepress_core_impl_options_ui_fields_provided_ThemeField(
