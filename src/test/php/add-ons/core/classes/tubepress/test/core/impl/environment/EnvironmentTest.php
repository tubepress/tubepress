...
/**
 * @covers tubepress_core_impl_environment_Environment<extended>
 */
class tubepress_test_core_impl_environment_EnvironmentTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_impl_environment_Environment
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut            = new tubepress_core_impl_environment_Environment($this->_mockUrlFactory);
    }

    public function testVersion()
    {
        $latest = tubepress_core_api_version_Version::parse('9.9.9');
        $current = $this->_sut->getVersion();
        $this->assertTrue($current instanceof tubepress_core_api_version_Version);
     ...
     * @expectedExceptionMessage Invalid argument to tubepress_core_impl_environment_Environment::setWpFunctionsInterface
     */
    ...
    public function testDetectUserContentUrlNonWp()
    {
        ...
        $mockContentUrl = $this->mock('tubepress_core_api_url_UrlInterface');
