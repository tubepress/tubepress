...
/**
 * @covers tubepress_addons_core_impl_listeners_videogallerypage_VideoBlacklist
 */
class tubepress_test_addons_core_impl_listeners_videogallerypage_VideoBlacklistTest extends tubepress_test_TubePressUnitTest
{
    /**
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_addons_core_impl_listeners_videogallerypage_VideoBlacklist($this->_mockExecutionContext);
    }
