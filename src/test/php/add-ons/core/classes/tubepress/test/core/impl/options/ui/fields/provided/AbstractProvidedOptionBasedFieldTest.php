 ...
 */
abstract class tubepress_test_core_impl_options_ui_fields_provided_AbstractProvidedOptionBasedFieldTest extends tubepress_test_core_impl_options_ui_fields_AbstractTemplateBasedOptionsPageFieldTest
{
    /**
    ...
    public function testBadOptionName()
    {
        ...
        new tubepress_core_impl_options_ui_fields_provided_TextField(
