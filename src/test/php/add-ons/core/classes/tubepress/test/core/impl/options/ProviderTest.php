...
/**
 * @covers tubepress_core_impl_options_Provider<extended>
 */
class tubepress_test_core_impl_options_ProviderTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_impl_options_Provider
     */
    private $_sut;
    ...
    {
        $this->_mockOptionProvider1 = $this->mock(tubepress_core_api_options_ProviderInterface::_);
        $this->_mockOptionProvider2 = $this->mock(tubepress_core_api_options_ProviderInterface::_);
        ...
        $this->_sut = new tubepress_core_impl_options_Provider();
