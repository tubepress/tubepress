...
/**
 * @covers tubepress_core_impl_ioc_TaggedServicesConsumerPass<extended>
 */
class tubepress_test_core_impl_ioc_compiler_TaggedServicesConsumerPassTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_impl_ioc_TaggedServicesConsumerPass
     */
    private $_sut;
    ...
    {
        $this->_sut           = new tubepress_core_impl_ioc_TaggedServicesConsumerPass();
    ...
    public function testProcessMultiple()
    {
        ...
        $this->_mockContainer->shouldReceive('findTaggedServiceIds')->once()->with(tubepress_core_api_const_ioc_Tags::TAGGED_SERVICES_CONSUMER)
