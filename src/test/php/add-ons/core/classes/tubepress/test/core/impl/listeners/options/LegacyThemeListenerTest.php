...
/**
 * @covers tubepress_core_impl_listeners_options_LegacyThemeListener
 */
class tubepress_test_core_impl_listeners_options_LegacyThemeListenerTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_impl_listeners_options_LegacyThemeListener
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_mockThemeHandler = $this->mock(tubepress_core_api_theme_ThemeLibraryInterface::_);
        $this->_mockLogger       = $this->mock(tubepress_api_log_LoggerInterface::_);

        $this->_mockLogger->shouldReceive('isEnabled')->once()->andReturn(true);
        $this->_mockLogger->shouldReceive('debug')->atLeast(1);

        $this->_sut = new tubepress_core_impl_listeners_options_LegacyThemeListener(
