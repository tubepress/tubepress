...
/**
 * @covers tubepress_addons_core_impl_listeners_html_ThumbGalleryBaseJs
 */
class tubepress_test_addons_core_impl_listeners_html_ThumbGalleryBaseJsTest extends tubepress_test_TubePressUnitTest
{
    /**
