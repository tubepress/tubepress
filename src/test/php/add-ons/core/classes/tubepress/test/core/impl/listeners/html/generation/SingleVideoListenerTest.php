...
/**
 * @covers tubepress_core_impl_listeners_html_generation_SingleVideoListener
 */
class tubepress_test_core_impl_shortcode_commands_SingleVideoCommandTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_impl_listeners_html_generation_SingleVideoListener
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_core_impl_listeners_html_generation_SingleVideoListener(
    ...
    {
        $this->_mockExecutionContext->shouldReceive('get')->once()->with(tubepress_core_api_const_options_Names::VIDEO)->andReturn('');
    ...
    public function testExecute()
    {
        ...
        $this->_mockExecutionContext->shouldReceive('get')->twice()->with(tubepress_core_api_const_options_Names::VIDEO)->andReturn('video-id');
        ...
        $this->_mockTemplateFactory->shouldReceive('fromFilesystem')->once()->with(array(
            'single_video.tpl.php', TUBEPRESS_ROOT . '/src/main/web/themes/default/single_video.tpl.php'
        ...
        $this->_mockEventDispatcher->shouldReceive('hasListeners')->once()->with(tubepress_core_api_const_event_EventNames::TEMPLATE_SINGLE_VIDEO)->andReturn(true);
        $this->_mockEventDispatcher->shouldReceive('dispatch')->once()->with(tubepress_core_api_const_event_EventNames::TEMPLATE_SINGLE_VIDEO, $mockTemplateEvent);
        ...
        $this->_mockEventDispatcher->shouldReceive('hasListeners')->once()->with(tubepress_core_api_const_event_EventNames::HTML_SINGLE_VIDEO)->andReturn(true);
        $this->_mockEventDispatcher->shouldReceive('dispatch')->once()->with(tubepress_core_api_const_event_EventNames::HTML_SINGLE_VIDEO, $mockHtmlEvent);
