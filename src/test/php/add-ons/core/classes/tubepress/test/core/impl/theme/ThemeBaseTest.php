...
/**
 * @covers tubepress_core_impl_theme_ThemeBase
 */
class tubepress_test_core_impl_theme_ThemeBaseTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_impl_theme_ThemeBase
     */
    private $_sut;
    ...
    {
        $this->_sut = new tubepress_core_impl_theme_ThemeBase(
            'my/theme',
            '3.2.1',
            'my theme',
    ...
    public function testBadRootPath()
    {
        ...
        new tubepress_core_impl_theme_ThemeBase(
            'my/theme',
            '3.2.1',
            'my theme',
            array('name' => 'foo', 'url' => 'http://bar.com/hello'),
