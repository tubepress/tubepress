...
class tubepress_test_addons_core_CoreManifestValidityTest extends tubepress_test_impl_addon_AbstractManifestValidityTest
{
    ...
    private function _getExpectedClassMap()
    {
        return array(
            ...
            'tubepress_addons_core_impl_ioc_BuildOptionNamesParameterCompilerPass'              => 'classes/tubepress/addons/core/impl/ioc/BuildOptionNamesParameterCompilerPass.php',
            ...
            'tubepress_addons_core_impl_options_CoreOptionProvider'                             => 'classes/tubepress/addons/core/impl/options/CoreOptionProvider.php',
