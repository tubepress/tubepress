 ...
 *
 */
class tubepress_impl_env_wordpress_WordPressFormHandlerTest extends PHPUnit_Framework_TestCase
{
    private $_sut;
    ...
    function setUp()
    {
        ...
        $this->_mockFilter = Mockery::mock(tubepress_spi_options_ui_Field::__);
    ...
    function testGetHtml()
    {
        ...
        $this->_mockTemplateBuilder->shouldReceive('getNewTemplateInstance')->once()->with('<<basepath>>/src/main/resources/system-templates/wordpress/options_page.tpl.php')->andReturn($template);
