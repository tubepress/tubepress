 ...
 *
 */
class tubepress_impl_wordpress_DefaultWpAdminHandlerTest extends PHPUnit_Framework_TestCase
{
    private $_sut;
    ...
    function testInit()
    {
        ...
        $this->_mockWpFunctionWrapper->shouldReceive('plugins_url')->once()->with("base_name/sys/ui/static/css/jquery-ui-flick/jquery-ui-1.8.16.custom.css", "base_name")->andReturn('y');
        $this->_mockWpFunctionWrapper->shouldReceive('plugins_url')->once()->with("base_name/sys/ui/static/css/wordpress-options-page.css", "base_name")->andReturn('z');
        $this->_mockWpFunctionWrapper->shouldReceive('plugins_url')->once()->with("base_name/sys/ui/static/css/jquery-ui-multiselect-widget/jquery.multiselect.css", "base_name")->andReturn('x');
        $this->_mockWpFunctionWrapper->shouldReceive('plugins_url')->once()->with("base_name/sys/ui/static/js/jscolor/jscolor.js", "base_name")->andReturn('a');
        $this->_mockWpFunctionWrapper->shouldReceive('plugins_url')->once()->with("base_name/sys/ui/static/js/jquery-ui/jquery-ui-1.8.16.custom.min.js", "base_name")->andReturn('b');
        $this->_mockWpFunctionWrapper->shouldReceive('plugins_url')->once()->with("base_name/sys/ui/static/js/jquery-ui-multiselect-widget/jquery.multiselect.min.js", "base_name")->andReturn('c');
