...
class tubepress_impl_options_ui_fields_CheckboxFieldTest extends tubepress_impl_options_ui_fields_AbstractOptionDescriptorBasedFieldTest
{
    ...
    {
        return new tubepress_impl_options_ui_fields_BooleanField($messageService, $optionDescriptorReference,
            $storageManager, $optionValidator, $hrps, $environmentDetector, $templateBuilder, $name);
    }
