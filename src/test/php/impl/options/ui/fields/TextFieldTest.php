 ...
 *
 */
class tubepress_impl_options_ui_fields_TextFieldTest extends tubepress_impl_options_ui_fields_AbstractOptionDescriptorBasedFieldTest
{
    ...
    {
        return new tubepress_impl_options_ui_fields_TextField($messageService, $optionDescriptorReference, $storageManager,
            $optionValidator, $hrps, $environmentDetector, $templateBuilder, $name);
    }
