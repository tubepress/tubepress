...
class fullClassMapTest extends tubepress_test_TubePressUnitTest
{
    ...
    private static $_classesWeDontCareAbout = array(
        ...
        'ehough_epilog_formatter_FlowdockFormatter',
        'ehough_epilog_formatter_GelfMessageFormatter',
        'ehough_epilog_formatter_HtmlFormatter',
        'ehough_epilog_formatter_JsonFormatter',
        'ehough_epilog_formatter_LogglyFormatter',
        ...
        'ehough_epilog_handler_BrowserConsoleHandler',
        ...
        'ehough_epilog_handler_FilterHandler',
        ...
        'ehough_epilog_handler_RollbarHandler',
