 ...
 *
 */
class tubepress_plugins_core_filters_searchinputtemplate_CoreVariablesTest extends PHPUnit_Framework_TestCase
{
	private $_sut;
	...
	function setup()
	{
		$this->_sut = new tubepress_plugins_core_filters_searchinputtemplate_CoreVariables();
	...
	function testYouTubeFavorites()
	{
        ...
        $event = new tubepress_api_event_SearchInputTemplateConstruction($mockTemplate);
