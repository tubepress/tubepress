...
class tubepress_plugins_core_CoreTest extends TubePressUnitTest
{
    ...
    private function _testEventListeners()
    {
        $testMap = array(
            ...
            array('tubepress_plugins_core_impl_filters_variablereadfromexternalinput_StringMagic', 'onIncomingInput', tubepress_api_const_event_CoreEventNames::VARIABLE_READ_FROM_EXTERNAL_INPUT),
            array('tubepress_plugins_core_impl_filters_singlevideotemplate_CoreVariables', 'onSingleVideoTemplate', tubepress_api_const_event_CoreEventNames::SINGLE_VIDEO_TEMPLATE_CONSTRUCTION),
            array('tubepress_plugins_core_impl_filters_singlevideotemplate_VideoMeta', 'onSingleVideoTemplate', tubepress_api_const_event_CoreEventNames::SINGLE_VIDEO_TEMPLATE_CONSTRUCTION),
            array('tubepress_plugins_core_impl_filters_searchinputtemplate_CoreVariables', 'onSearchInputTemplate', tubepress_api_const_event_CoreEventNames::SEARCH_INPUT_TEMPLATE_CONSTRUCTION),
            array('tubepress_plugins_core_impl_filters_videogallerypage_PerPageSorter', 'onVideoGalleryPage', tubepress_api_const_event_CoreEventNames::VIDEO_GALLERY_PAGE_CONSTRUCTION),
            array('tubepress_plugins_core_impl_filters_videogallerypage_ResultCountCapper', 'onVideoGalleryPage', tubepress_api_const_event_CoreEventNames::VIDEO_GALLERY_PAGE_CONSTRUCTION),
            array('tubepress_plugins_core_impl_filters_videogallerypage_VideoBlacklist', 'onVideoGalleryPage', tubepress_api_const_event_CoreEventNames::VIDEO_GALLERY_PAGE_CONSTRUCTION),
            array('tubepress_plugins_core_impl_filters_videogallerypage_VideoPrepender', 'onVideoGalleryPage', tubepress_api_const_event_CoreEventNames::VIDEO_GALLERY_PAGE_CONSTRUCTION),
            array('tubepress_plugins_core_impl_filters_prevalidationoptionset_StringMagic', 'onPreValidationOptionSet', tubepress_api_const_event_CoreEventNames::PRE_VALIDATION_OPTION_SET),
            array('tubepress_plugins_core_impl_filters_prevalidationoptionset_YouTubePlaylistPlPrefixRemover', 'onPreValidationOptionSet', tubepress_api_const_event_CoreEventNames::PRE_VALIDATION_OPTION_SET),
            array('tubepress_plugins_core_impl_filters_playertemplate_CoreVariables', 'onPlayerTemplate', tubepress_api_const_event_CoreEventNames::PLAYER_TEMPLATE_CONSTRUCTION),
            array('tubepress_plugins_core_impl_filters_gallerytemplate_CoreVariables', 'onGalleryTemplate', tubepress_api_const_event_CoreEventNames::THUMBNAIL_GALLERY_TEMPLATE_CONSTRUCTION),
            array('tubepress_plugins_core_impl_filters_gallerytemplate_EmbeddedPlayerName', 'onGalleryTemplate', tubepress_api_const_event_CoreEventNames::THUMBNAIL_GALLERY_TEMPLATE_CONSTRUCTION),
            array('tubepress_plugins_core_impl_filters_gallerytemplate_Pagination', 'onGalleryTemplate', tubepress_api_const_event_CoreEventNames::THUMBNAIL_GALLERY_TEMPLATE_CONSTRUCTION),
            array('tubepress_plugins_core_impl_filters_gallerytemplate_Player', 'onGalleryTemplate', tubepress_api_const_event_CoreEventNames::THUMBNAIL_GALLERY_TEMPLATE_CONSTRUCTION),
            array('tubepress_plugins_core_impl_filters_gallerytemplate_VideoMeta', 'onGalleryTemplate', tubepress_api_const_event_CoreEventNames::THUMBNAIL_GALLERY_TEMPLATE_CONSTRUCTION),
            array('tubepress_plugins_core_impl_filters_galleryinitjs_GalleryInitJsBaseParams', 'onGalleryInitJs', tubepress_api_const_event_CoreEventNames::GALLERY_INIT_JS_CONSTRUCTION),
            array('tubepress_plugins_core_impl_filters_galleryhtml_GalleryJs', 'onGalleryHtml', tubepress_api_const_event_CoreEventNames::THUMBNAIL_GALLERY_HTML_CONSTRUCTION),
            array('tubepress_plugins_core_impl_filters_embeddedtemplate_CoreVariables', 'onEmbeddedTemplate', tubepress_api_const_event_CoreEventNames::EMBEDDED_TEMPLATE_CONSTRUCTION),
            array('tubepress_plugins_core_impl_filters_embeddedhtml_PlayerJavaScriptApi', 'onEmbeddedHtml', tubepress_api_const_event_CoreEventNames::EMBEDDED_HTML_CONSTRUCTION),
        );
