 ...
 *
 */
class tubepress_plugins_core_impl_listeners_PlayerLocationsRegistrarTest extends TubePressUnitTest
{
    private $_sut;
    ...
    {
        $this->_sut = new tubepress_plugins_core_impl_listeners_PlayerLocationsRegistrar();
