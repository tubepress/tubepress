 ...
 *
 */
class tubepress_plugins_core_impl_filters_videogallerypage_PerPageSorterTest extends TubePressUnitTest
{
	private $_sut;
	...
	function setup()
	{
		...
		$this->_sut = new tubepress_plugins_core_impl_filters_videogallerypage_PerPageSorter();
		$this->_buildVideos();
	}
