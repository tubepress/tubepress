 ...
 *
 */
class tubepress_plugins_core_impl_listeners_AjaxCommandsRegistrarTest extends TubePressUnitTest
{
    private $_sut;
    ...
    {
        $this->_sut = new tubepress_plugins_core_impl_listeners_AjaxCommandsRegistrar();
