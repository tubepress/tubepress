...
class tubepress_plugins_youtube_api_const_ConstantsTest extends TubePressUnitTest
{
    function testConstants()
    {
        $toTest = array(
            ...
            'tubepress_plugins_youtube_api_const_options_values_YouTube'            => array('moderate', 'none', 'strict', 'dark', 'light', 'fadeNone', 'fadeBoth', 'fadeOnlyProgressBar', 'hide', 'showImmediate', 'showDelayed', 'all_time', 'this_month', 'this_week', 'today'),
