...
class tubepress_plugins_wordpress_impl_DefaultWpAdminHandlerTest extends TubePressUnitTest
{
    ...
    function testInit()
    {
        ...
        $this->_mockWpFunctionWrapper->shouldReceive('plugins_url')->once()->with("base_name/src/main/web/css/jquery-ui-flick/jquery-ui-1.8.24.custom.css", "base_name")->andReturn('y');
        ...
        $this->_mockWpFunctionWrapper->shouldReceive('plugins_url')->once()->with("base_name/src/main/web/js/jquery-ui/jquery-ui-1.8.24.custom.min.js", "base_name")->andReturn('b');
