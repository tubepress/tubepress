 ...
 *
 */
class tubepress_plugins_youtube_impl_listeners_YouTubeEmbeddedPlayerRegistrarTest extends TubePressUnitTest
{
    private $_sut;
    ...
    {
        $this->_sut = new tubepress_plugins_youtube_impl_listeners_YouTubeEmbeddedPlayerRegistrar();
    ...
    public function testBoot()
    {
        $this->_mockVideoProviderRegistry->shouldReceive('registerService')->once()->with(
            ...
            Mockery::type('tubepress_plugins_youtube_impl_embedded_YouTubePluggableEmbeddedPlayer'));
