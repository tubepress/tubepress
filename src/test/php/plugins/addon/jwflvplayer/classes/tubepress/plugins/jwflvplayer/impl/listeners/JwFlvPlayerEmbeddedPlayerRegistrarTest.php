 ...
 *
 */
class tubepress_plugins_jwflvplayer_impl_listeners_JwFlvPlayerEmbeddedPlayerRegistrarTest extends TubePressUnitTest
{
    private $_sut;
    ...
    {
        $this->_sut = new tubepress_plugins_jwflvplayer_impl_listeners_JwFlvPlayerRegistrar();
