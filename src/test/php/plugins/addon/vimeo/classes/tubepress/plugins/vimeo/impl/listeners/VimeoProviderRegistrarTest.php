 ...
 *
 */
class tubepress_plugins_vimeo_impl_listeners_VimeoProviderRegistrarTest extends TubePressUnitTest
{
    private $_sut;
    ...
    {
        $this->_sut = new tubepress_plugins_vimeo_impl_listeners_VimeoProviderRegistrar();
