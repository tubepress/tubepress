 ...
 *
 */
class tubepress_plugins_vimeo_impl_listeners_VimeoEmbeddedPlayerRegistrarTest extends TubePressUnitTest
{
    private $_sut;
    ...
    {
        $this->_sut = new tubepress_plugins_vimeo_impl_listeners_VimeoEmbeddedPlayerRegistrar();
