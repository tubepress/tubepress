 ...
 *
 */
class tubepress_plugins_wordpresscore_listeners_WordPressOptionsRegistrarTest extends TubePressUnitTest
{
    private $_sut;
    ...
    {
        $this->_sut = new tubepress_plugins_wordpresscore_listeners_WordPressOptionsRegistrar();
