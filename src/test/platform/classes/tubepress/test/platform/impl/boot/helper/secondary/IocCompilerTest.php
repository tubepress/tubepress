...
/**
 * @covers tubepress_impl_boot_helper_secondary_IocCompiler<extended>
 */
class tubepress_test_impl_boot_helper_secondary_IocCompilerTest extends tubepress_test_TubePressUnitTest
{
    ...
    public function onSetup()
    {
        ...
        $this->_mockIocContainer = $this->mock('tubepress_impl_ioc_ContainerBuilder');
        $this->_sut              = new tubepress_impl_boot_helper_secondary_IocCompiler($this->_mockLogger);
    }
    ...
    public static function setUpBeforeClass()
    {
        ...
        require_once TUBEPRESS_ROOT . '/src/test/platform/fixtures/classes/tubepress/test/impl/ioc/FakeCompilerPass.php';
        require_once TUBEPRESS_ROOT . '/src/test/platform/fixtures/classes/tubepress/test/impl/ioc/FakeExtension.php';
    }
