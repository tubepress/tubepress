...
class tubepress_test_core_html_gallery_impl_listeners_template_ThumbGalleryPaginationTest extends tubepress_test_TubePressUnitTest
{
    ...
    public function testLegacyHighPage()
    {
        ...
        $expectedHtml = file_get_contents(TUBEPRESS_ROOT . '/src/test/add-ons/html-gallery/fixtures/pagination/pagination/legacy-high.html');
    ...
    {
        $this->_mockThemeLibrary->shouldReceive('getAbsolutePathToTemplate')->once()->with('pagination.tpl.php')->andReturnNull();
        $expectedHtml = file_get_contents(TUBEPRESS_ROOT . '/src/test/add-ons/html-gallery/fixtures/pagination/pagination/legacy-middle.html');
    ...
    {
        $this->_mockThemeLibrary->shouldReceive('getAbsolutePathToTemplate')->once()->with('pagination.tpl.php')->andReturnNull();
        $expectedHtml = file_get_contents(TUBEPRESS_ROOT . '/src/test/add-ons/html-gallery/fixtures/pagination/pagination/legacy-low.html');
