...
/**
 * @covers tubepress_core_html_gallery_impl_listeners_template_PlayerLocation
 */
class tubepress_test_core_html_gallery_impl_listeners_template_ThumbGalleryPlayerLocationTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_html_gallery_impl_listeners_template_PlayerLocation
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_core_html_gallery_impl_listeners_template_PlayerLocation($this->_mockExecutionContext,
