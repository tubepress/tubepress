...
/**
 * @covers tubepress_core_html_gallery_impl_listeners_html_AsyncJsInjector
 */
class tubepress_test_core_html_gallery_impl_listeners_html_ThumbGalleryBaseJsTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_html_gallery_impl_listeners_html_AsyncJsInjector
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut                  = new tubepress_core_html_gallery_impl_listeners_html_AsyncJsInjector($this->_mockExecutionContext, $this->_mockEventDispatcher);
    }
