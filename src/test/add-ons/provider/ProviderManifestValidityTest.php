...
class tubepress_test_core_player_ProviderManifestValidityTest extends tubepress_test_core_ioc_AbstractManifestValidityTest
{
    public function testManifest()
    {
        ...
        $this->assertEquals('tubepress/core-provider', $addon->getName());
    ...
    {
        return TUBEPRESS_ROOT . '/src/main/add-ons/provider/manifest.json';
    }
}