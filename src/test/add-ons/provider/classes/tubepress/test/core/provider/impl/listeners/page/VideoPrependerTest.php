...
/**
 * @covers tubepress_core_provider_impl_listeners_page_ItemPrepender
 */
class tubepress_test_core_provider_impl_listeners_page_VideoPrependerTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_provider_impl_listeners_page_ItemPrepender
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_mockVideoProvider = $this->mock(tubepress_core_provider_api_CollectorInterface::_);

        $this->_sut = new tubepress_core_provider_impl_listeners_page_ItemPrepender($this->_mockLogger, $this->_mockHttpRequestParameterService, $this->_mockVideoProvider);
    }
    ...
    public function testCustomVideo()
    {
        ...
        $video->setAttribute(tubepress_core_provider_api_Constants::ATTRIBUTE_PROVIDER, $mockMediaProvider);
