...
/**
 * @covers tubepress_core_provider_ioc_compiler_EasyHttpProvidersPass<extended>
 */
class tubepress_test_core_provider_ioc_compiler_EasyHttpProvidersPassTest extends tubepress_test_TubePressUnitTest
{
    public function testProcess()
    {
        $sut = new tubepress_core_provider_ioc_compiler_EasyHttpProvidersPass();
        ...
        $mockContainerBuilder->shouldReceive('findTaggedServiceIds')->once()
            ->with(tubepress_core_provider_api_HttpProviderInterface::_)
        ...
        $mockDef->shouldReceive('addTag')->once()->with(tubepress_core_provider_api_MediaProviderInterface::_);
