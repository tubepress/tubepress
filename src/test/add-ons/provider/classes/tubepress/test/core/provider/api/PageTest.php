...
/**
 * @covers tubepress_core_provider_api_Page
 */
class tubepress_test_core_provider_api_PageTest extends tubepress_test_TubePressUnitTest
{
    /**
    ...
    {
        $this->_sut = new tubepress_core_provider_api_Page();
    }
