...
/**
 * @covers tubepress_core_provider_api_MediaItem
 */
class tubepress_test_core_provider_api_MediaItemTest extends tubepress_test_TubePressUnitTest
{
    /**
    ...
    {
        $this->_vid = new tubepress_core_provider_api_MediaItem();
    }
