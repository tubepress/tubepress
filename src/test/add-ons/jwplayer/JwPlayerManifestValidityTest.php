...
class tubepress_test_core_JwPlayerManifestValidityTest extends tubepress_test_core_ioc_AbstractManifestValidityTest
{
    ...
    {
        return TUBEPRESS_ROOT . '/src/main/add-ons/jwplayer/manifest.json';
    }
}