 ...
 */
class tubepress_test_core_translation_support_GreppedCode extends tubepress_test_core_translation_support_AbstractTranslation
{
    ...
    public function fetchStrings()
    {
        $codeBaseDirectories = array(
            ...
            TUBEPRESS_ROOT . '/src/main/add-ons'
        );

        $toReturn = array_map('rtrim', file(TUBEPRESS_ROOT . '/src/test/add-ons/translation/extra-strings.txt'));
