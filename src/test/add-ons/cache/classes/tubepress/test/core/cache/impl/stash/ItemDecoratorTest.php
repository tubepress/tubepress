...
/**
 * @covers tubepress_core_cache_impl_stash_ItemDecorator
 */
class tubepress_test_core_cache_impl_stash_ItemDecoratorTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_cache_impl_stash_ItemDecorator
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut         = new tubepress_core_cache_impl_stash_ItemDecorator($this->_mockContext, $this->_mockItem, $this->_mockPool);
    }
    ...
    {
        $this->_mockContext->shouldReceive('get')->once()->with(tubepress_core_cache_api_Constants::CLEANING_FACTOR)->andReturn('0');
