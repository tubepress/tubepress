...
class tubepress_test_core_WordPressManifestValidityTest extends tubepress_test_core_ioc_AbstractManifestValidityTest
{
    ...
    {
        return TUBEPRESS_ROOT . '/src/main/add-ons/wordpress/manifest.json';
    }
