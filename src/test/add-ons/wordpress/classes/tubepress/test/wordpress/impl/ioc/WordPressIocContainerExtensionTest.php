...
class tubepress_test_wordpress_ioc_WordPressIocContainerExtensionTest extends tubepress_test_core_ioc_AbstractIocContainerExtensionTest
{
    ...
    protected function prepareForLoad()
    {
        ...
        $this->expectRegistration(
            ...
            ->withArgument(array(TUBEPRESS_ROOT . '/src/main/add-ons/wordpress/resources/templates/options_page.tpl.php'))
    ...
    protected function getExpectedExternalServicesMap()
    {
        ...
        $mockTemplateFactory->shouldReceive('fromFilesystem')->once()->with(array(TUBEPRESS_ROOT . '/src/main/add-ons/wordpress/resources/templates/options_page.tpl.php'))->andReturn($mockTemplate);
