...
class tubepress_test_wordpress_impl_CallbackTest extends tubepress_test_TubePressUnitTest
{
    ...
    public function testFilter()
    {
        ...
        $mockFilterEvent = $this->mock('tubepress_core_event_api_EventInterface');
    ...
    {
        $mockActionEvent = $this->mock('tubepress_core_event_api_EventInterface');
    ...
    {
        return $event instanceof tubepress_core_event_api_EventInterface
