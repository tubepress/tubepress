...
class tubepress_test_core_template_TemplateManifestValidityTest extends tubepress_test_core_ioc_AbstractManifestValidityTest
{
    public function testManifest()
    {
        ...
        $this->assertEquals('tubepress/core-template', $addon->getName());
        ...
        $this->assertEquals('TubePress core template functionality.', $addon->getDescription());
    }

    protected function getPathToManifest()
    {
        return TUBEPRESS_ROOT . '/src/main/add-ons/template/manifest.json';
    }
}