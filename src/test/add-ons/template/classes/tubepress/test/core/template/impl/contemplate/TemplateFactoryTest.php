...
/**
 * @covers tubepress_core_template_impl_contemplate_TemplateFactory
 */
class tubepress_test_core_template_impl_contemplate_TemplateFactoryTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_template_impl_contemplate_TemplateFactory
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_core_template_impl_contemplate_TemplateFactory(
            $this->_mockLogger,
            $this->_mockLangUtils,
    ...
    public function testFromTheme()
    {
        ...
        $this->assertInstanceOf('tubepress_core_template_impl_contemplate_Template', $result);
    }
