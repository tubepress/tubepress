...
class tubepress_test_core_html_HtmlManifestValidityTest extends tubepress_test_core_ioc_AbstractManifestValidityTest
{
    public function testManifest()
    {
        ...
        $this->assertEquals('tubepress/core-html', $addon->getName());
        $this->assertEquals('1.0.0', $addon->getVersion());
        $this->assertEquals('TubePress HTML Generator', $addon->getTitle());
        ...
        $this->assertEquals('TubePress HTML generator.', $addon->getDescription());
    }

    protected function getPathToManifest()
    {
        return TUBEPRESS_ROOT . '/src/main/add-ons/html/manifest.json';
    }
}