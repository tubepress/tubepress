...
/**
 * @covers tubepress_core_media_single_impl_listeners_template_SingleVideoCoreVariables
 */
class tubepress_test_core_impl_listeners_template_SingleVideoCoreVariablesTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_media_single_impl_listeners_template_SingleVideoCoreVariables
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_core_media_single_impl_listeners_template_SingleVideoCoreVariables($this->_mockExecutionContext, $this->_mockEmbeddedHtmlGenerator);
    }
    ...
    public function testYouTubeFavorites()
    {
        ...
        $video->setAttribute(tubepress_core_provider_api_Constants::ATTRIBUTE_ID, 'video-id');
        ...
        $mockTemplate->shouldReceive('setVariable')->once()->with(tubepress_core_template_api_const_VariableNames::EMBEDDED_WIDTH, 889);
