...
/**
 * @covers tubepress_core_media_single_impl_listeners_html_SingleVideoListener
 */
class tubepress_test_core_impl_shortcode_commands_SingleVideoCommandTest extends tubepress_test_TubePressUnitTest
{
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_core_media_single_impl_listeners_html_SingleVideoListener(
    ...
    {
        $this->_mockExecutionContext->shouldReceive('get')->once()->with(tubepress_core_media_single_api_Constants::OPTION_VIDEO)->andReturn('');
    ...
    public function testExecute()
    {
        ...
        $this->_mockExecutionContext->shouldReceive('get')->twice()->with(tubepress_core_media_single_api_Constants::OPTION_VIDEO)->andReturn('video-id');
        ...
        $this->_mockEventDispatcher->shouldReceive('hasListeners')->once()->with(tubepress_core_media_single_api_Constants::EVENT_SINGLE_ITEM_TEMPLATE)->andReturn(true);
        $this->_mockEventDispatcher->shouldReceive('dispatch')->once()->with(tubepress_core_media_single_api_Constants::EVENT_SINGLE_ITEM_TEMPLATE, $mockTemplateEvent);
        ...
        $this->_mockEventDispatcher->shouldReceive('hasListeners')->once()->with(tubepress_core_media_single_api_Constants::EVENT_SINGLE_ITEM_HTML)->andReturn(true);
        $this->_mockEventDispatcher->shouldReceive('dispatch')->once()->with(tubepress_core_media_single_api_Constants::EVENT_SINGLE_ITEM_HTML, $mockHtmlEvent);
