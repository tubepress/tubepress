...
class tubepress_test_core_YouTubeManifestValidityTest extends tubepress_test_core_ioc_AbstractManifestValidityTest
{
    ...
    {
        return TUBEPRESS_ROOT . '/src/main/add-ons/youtube/manifest.json';
    }
}