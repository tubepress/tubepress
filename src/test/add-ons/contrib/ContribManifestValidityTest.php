...
class tubepress_test_core_contrib_ContribManifestValidityTest extends tubepress_test_core_ioc_AbstractManifestValidityTest
{
    ...
    {
        return TUBEPRESS_ROOT . '/src/main/add-ons/contrib/manifest.json';
    }
}