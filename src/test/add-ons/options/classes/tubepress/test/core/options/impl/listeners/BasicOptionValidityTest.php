...
/**
 * @covers tubepress_core_options_impl_listeners_BasicOptionValidity<extended>
 */
class tubepress_test_core_options_impl_listeners_BasicOptionValidityTest extends tubepress_test_TubePressUnitTest
{
    /**
    ...
    /**
     * @var tubepress_core_options_impl_listeners_BasicOptionValidity
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_core_options_impl_listeners_BasicOptionValidity(
