...
class tubepress_test_core_options_CoreOptionsManifestValidityTest extends tubepress_test_core_ioc_AbstractManifestValidityTest
{
    public function testManifest()
    {
        ...
        $this->assertEquals('tubepress/core-options', $addon->getName());
        $this->assertEquals('1.0.0', $addon->getVersion());
        $this->assertEquals('TubePress Core Options Functionality', $addon->getTitle());
        ...
        $this->assertEquals('TubePress core options functionality.', $addon->getDescription());
    }

    protected function getPathToManifest()
    {
        return TUBEPRESS_ROOT . '/src/main/add-ons/options/manifest.json';
    }
