...
class tubepress_test_core_media_gallery_MediaGalleryManifestValidityTest extends tubepress_test_core_ioc_AbstractManifestValidityTest
{
    public function testManifest()
    {
        ...
        $this->assertEquals('tubepress/core-media-gallery', $addon->getName());
        $this->assertEquals('1.0.0', $addon->getVersion());
        $this->assertEquals('TubePress Media Gallery Functionality', $addon->getTitle());
    ...
    {
        return TUBEPRESS_ROOT . '/src/main/add-ons/media-gallery/manifest.json';
    }
}