...
/**
 * @covers tubepress_core_media_gallery_impl_listeners_template_EmbeddedVars
 */
...
{
    /**
     * @var tubepress_core_media_gallery_impl_listeners_template_EmbeddedVars
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_core_media_gallery_impl_listeners_template_EmbeddedVars($this->_mockExecutionContext);
    }
    ...
    public function testAlterTemplateProviderDefault()
    {
        ...
        $video->setAttribute(tubepress_core_provider_api_Constants::ATTRIBUTE_PROVIDER_NAME, 'provider-name');
    ...
    private function _testCustomYouTube($name)
    {
        ...
        $video = new tubepress_core_provider_api_MediaItem();
        $video->setAttribute(tubepress_core_provider_api_Constants::ATTRIBUTE_PROVIDER_NAME, $name);
