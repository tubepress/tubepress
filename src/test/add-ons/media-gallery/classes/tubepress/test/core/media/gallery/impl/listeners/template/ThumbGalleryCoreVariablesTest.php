...
/**
 * @covers tubepress_core_media_gallery_impl_listeners_template_CoreVariables
 */
class tubepress_test_core_impl_listeners_template_ThumbGalleryCoreVariablesTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_media_gallery_impl_listeners_template_CoreVariables
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_core_media_gallery_impl_listeners_template_CoreVariables($this->_mockExecutionContext);
    }

    public function testAlterTemplate()
    {
        $this->_mockExecutionContext->shouldReceive('get')->once()->with(tubepress_core_media_gallery_api_Constants::OPTION_THUMB_WIDTH)->andReturn(556);
        $this->_mockExecutionContext->shouldReceive('get')->once()->with(tubepress_core_media_gallery_api_Constants::OPTION_THUMB_HEIGHT)->andReturn(984);
