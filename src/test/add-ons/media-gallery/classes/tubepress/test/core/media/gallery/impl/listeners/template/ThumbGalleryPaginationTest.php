...
/**
 * @covers tubepress_core_media_gallery_impl_listeners_template_Pagination
 */
class tubepress_test_core_impl_listeners_template_ThumbGalleryPaginationTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_media_gallery_impl_listeners_template_Pagination
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_mockExecutionContext->shouldReceive('get')->once()->with(tubepress_core_media_gallery_api_Constants::OPTION_PAGINATE_ABOVE)->andReturn(true);
        $this->_mockExecutionContext->shouldReceive('get')->once()->with(tubepress_core_media_gallery_api_Constants::OPTION_PAGINATE_BELOW)->andReturn(true);
        $this->_mockExecutionContext->shouldReceive('get')->once()->with(tubepress_core_provider_api_Constants::OPTION_RESULTS_PER_PAGE)->andReturn(4);
        ...
        $this->_sut = new tubepress_core_media_gallery_impl_listeners_template_Pagination(
    ...
    public function testModern()
    {
        ...
        $this->_mockEventDispatcher->shouldReceive('dispatch')->once()->with(tubepress_core_media_gallery_api_Constants::EVENT_TEMPLATE_PAGINATION, $mockTemplateEvent);
        ...
        $this->_mockEventDispatcher->shouldReceive('dispatch')->once()->with(tubepress_core_media_gallery_api_Constants::EVENT_HTML_PAGINATION, $mockHtmlEvent);
    ...
    public function testLegacyHighPage()
    {
        ...
        $expectedHtml = file_get_contents(TUBEPRESS_ROOT . '/src/test/add-ons/media-gallery/fixtures/pagination/pagination/legacy-high.html');
    ...
    {
        $this->_mockThemeLibrary->shouldReceive('getAbsolutePathToTemplate')->once()->with('pagination.tpl.php')->andReturnNull();
        $expectedHtml = file_get_contents(TUBEPRESS_ROOT . '/src/test/add-ons/media-gallery/fixtures/pagination/pagination/legacy-middle.html');
    ...
    {
        $this->_mockThemeLibrary->shouldReceive('getAbsolutePathToTemplate')->once()->with('pagination.tpl.php')->andReturnNull();
        $expectedHtml = file_get_contents(TUBEPRESS_ROOT . '/src/test/add-ons/media-gallery/fixtures/pagination/pagination/legacy-low.html');
