...
/**
 * @covers tubepress_core_media_gallery_impl_listeners_template_VideoMeta
 */
class tubepress_test_core_impl_listeners_template_ThumbGalleryVideoMetaTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_media_gallery_impl_listeners_template_VideoMeta
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_mockVideoProvider = $this->mock(tubepress_core_provider_api_MediaProviderInterface::_);
        $this->_sut = new tubepress_core_media_gallery_impl_listeners_template_VideoMeta(
            $this->_mockExecutionContext,
            $this->_mockMessageService,
            $this->_mockOptionProvider
        );
        $this->_sut->setVideoProviders(array($this->_mockVideoProvider));
    }
    ...
    public function testVideoMetaAboveAndBelow()
    {
        ...
        $this->_mockVideoProvider->shouldReceive('getMapOfMetaOptionNamesToUntranslatedLabels')->once()->andReturn(array(
