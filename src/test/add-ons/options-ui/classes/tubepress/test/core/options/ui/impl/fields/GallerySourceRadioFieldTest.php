...
/**
 * @covers tubepress_core_options_ui_impl_fields_GallerySourceRadioField<extended>
 */
class tubepress_test_core_options_ui_impl_fields_GallerySourceRadioFieldTest extends tubepress_test_core_options_ui_impl_fields_AbstractTemplateBasedOptionsPageFieldTest
{
    /**
    ...
    /**
     * @return tubepress_core_options_ui_impl_fields_GallerySourceRadioField
     */
    ...
    protected function onAfterTemplateBasedFieldSetup()
    {
        ...
        $this->_mockAdditionalField = $this->mock('tubepress_core_options_ui_api_FieldInterface');
    }

    /**
     * @return tubepress_core_options_ui_impl_BaseElement
     */
    ...
    {
        $this->_mockContext->shouldReceive('get')->once()->with(tubepress_core_media_gallery_api_Constants::OPTION_GALLERY_SOURCE)->andReturn('somethin');
