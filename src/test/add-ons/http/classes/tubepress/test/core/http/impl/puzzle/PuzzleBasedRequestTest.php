...
/**
 * @covers tubepress_core_http_impl_puzzle_PuzzleBasedRequest<extended>
 */
class tubepress_test_core_http_impl_puzzle_message_PuzzleRequestTest extends tubepress_test_TubePressUnitTest
{
    public function testConfig()
    {
        $r = new puzzle_message_Request('PUT', '/test', array('test' => '123'), puzzle_stream_Stream::factory('foo'));
        $r = new tubepress_core_http_impl_puzzle_PuzzleBasedRequest($r);
    ...
    public function testQueryIsMutable()
    {
        ...
        $this->assertInstanceOf('tubepress_core_url_api_QueryInterface', $r->getUrl()->getQuery());
    }
    ...
    public function testQueryCanChange()
    {
        ...
        $r->getUrl()->setQuery(new tubepress_core_url_impl_puzzle_PuzzleBasedQuery(new puzzle_Query(array('foo' => 'bar'))));
