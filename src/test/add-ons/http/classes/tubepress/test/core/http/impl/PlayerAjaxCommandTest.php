...
/**
 * @covers tubepress_core_http_impl_PlayerAjaxCommand<extended>
 */
class tubepress_test_core_http_impl_PlayerAjaxCommandTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_http_impl_PlayerAjaxCommand
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_core_http_impl_PlayerAjaxCommand(
            $this->_mockLogger,
    ...
    public function testVideoFound()
    {
        ...
        $this->_mockHttpRequestParameterService->shouldReceive('getParamValue')->once()->with(tubepress_core_http_api_Constants::PARAM_NAME_VIDEO)->andReturn('-video-');
    ...
    public function testLazyPlay()
    {
        ...
        $this->_mockExecutionContext->shouldReceive('setEphemeralOptions')->once()->with($queryParams);
        $this->_mockExecutionContext->shouldReceive('get')->once()->with(tubepress_core_embedded_api_Constants::OPTION_LAZYPLAY)->andReturn(true);
        $this->_mockExecutionContext->shouldReceive('setEphemeralOption')->once()->with(tubepress_core_embedded_api_Constants::OPTION_AUTOPLAY, true);
