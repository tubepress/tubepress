...
class tubepress_test_core_http_HttpManifestValidityTest extends tubepress_test_core_ioc_AbstractManifestValidityTest
{
    ...
    {
        return TUBEPRESS_ROOT . '/src/main/add-ons/http/manifest.json';
    }
}