...
{   
    ...
    {
        if ($context->getProviderName() !== $this->_getHandledProviderName()) {
            return false;
        }
        ...
        if ($context->isSingle()) {
            ...
            $context->setReturnValue($this->_buildSingleVideoUrl($context->getArg()));
        } else {
            
            $context->setReturnValue($this->_buildGalleryUrl($context->getArg()));
        }
