 ...
 */
class org_tubepress_impl_options_ui_widgets_MetaMultiSelectInput extends org_tubepress_impl_options_ui_widgets_AbstractMultiSelectInput
{
    public function __construct($optionDescriptors, $name, $description = '')
    {
        ...
        parent::__construct(array(
            ...
            $odr->findOneByName(org_tubepress_api_const_options_names_Meta::TAGS),
    ...
    {
        return 'Meta-information to display with each video';
    }
