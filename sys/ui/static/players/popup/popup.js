 ...
 */
function tubepress_popup_player(title, html, height, width, videoId) {
	var top			= (screen.height / 2) - (height / 2),
		left		= (screen.width / 2) - (width / 2),
		win		= window.open('', '', 'location=0,directories=0,menubar=0,scrollbars=0,status=0,toolbar=0,width=' + width + ',height=' + height + ',top=' + top + ',left=' + left),
