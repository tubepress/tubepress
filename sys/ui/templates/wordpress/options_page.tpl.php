...
<div class="wrap">
  <form method="post">
	...
	<div style="float: right; vertical-align: middle; padding: 6px">
		<input type="checkbox" id="youtube-checkbox" /><img src="<?php echo ${org_tubepress_api_const_template_Variable::TUBEPRESS_BASE_URL}; ?>/ui/lib/options_page/images/youtube.png" style="margin: 0 1em -5px 3px" alt="YouTube"/>
		<input type="checkbox" id="vimeo-checkbox" /><img src="<?php echo ${org_tubepress_api_const_template_Variable::TUBEPRESS_BASE_URL}; ?>/ui/lib/options_page/images/vimeo.png" style="margin: 0 0 -8px 3px"/ alt="Vimeo">
	</div>
    </div>
        ...
        <table class="form-table" style="margin: 0">
          ...
          <tr valign="top" class="<?php $classes = array(); if ($optionArray[org_tubepress_api_const_template_Variable::OPTIONS_PAGE_YOUTUBE_OPTION]) { $classes[] = 'tubepress-youtube-option'; } if ($optionArray[org_tubepress_api_const_template_Variable::OPTIONS_PAGE_VIMEO_OPTION]) { $classes[] = "tubepress-vimeo-option"; } echo join(" ", $classes); ?>">
            ...
            <?php if ($optionArray[org_tubepress_api_const_template_Variable::OPTIONS_PAGE_YOUTUBE_OPTION]): ?>
                <img src="<?php echo ${org_tubepress_api_const_template_Variable::TUBEPRESS_BASE_URL}; ?>/ui/lib/options_page/images/youtube.png" alt="YouTube" class="tubepress-youtube-option"/>
            <?php endif; ?>
            </td>
            <td style="padding: 2px; vertical-align: top">
            <?php if ($optionArray[org_tubepress_api_const_template_Variable::OPTIONS_PAGE_VIMEO_OPTION]): ?>
                <img src="<?php echo ${org_tubepress_api_const_template_Variable::TUBEPRESS_BASE_URL}; ?>/ui/lib/options_page/images/vimeo.png" alt="Vimeo" class="tubepress-vimeo-option"/>
            <?php endif; ?>
            </td>  
          </tr>
            <?php endforeach; ?>
          ...
          <tr valign="top"><?php endif; ?>
            ...
            <?php if ($optionArray[org_tubepress_api_const_template_Variable::OPTIONS_PAGE_YOUTUBE_OPTION]): ?>
                <img class="tubepress-youtube-option" src="<?php echo ${org_tubepress_api_const_template_Variable::TUBEPRESS_BASE_URL}; ?>/ui/lib/options_page/images/youtube.png" alt="YouTube"/>
            <?php endif; ?>
            </td>
            <td style="padding: 2px; vertical-align: middle; width: 25px">
            <?php if ($optionArray[org_tubepress_api_const_template_Variable::OPTIONS_PAGE_VIMEO_OPTION]): ?>
                <img class="tubepress-vimeo-option" src="<?php echo ${org_tubepress_api_const_template_Variable::TUBEPRESS_BASE_URL}; ?>/ui/lib/options_page/images/vimeo.png" alt="Vimeo"/>
            <?php endif; ?>
            </td>
