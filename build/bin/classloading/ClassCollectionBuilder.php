...
class tubepress_build_ClassCollectionBuilder
{
    ...
    {
        @unlink(TUBEPRESS_ROOT . '/src/platform/scripts/class-collections/minimal-boot.php');

        $bootClasses = require __DIR__ . '/sets/minimal-boot.php';

        self::load(
            $bootClasses,
            TUBEPRESS_ROOT . '/src/platform/scripts/class-collections',
            'minimal-boot',
            false
        );
    }
