...
EOT;
    ...
    public static $CLASSES = array(
        ...
        'ehough_epilog_formatter_FormatterInterface',
        'ehough_epilog_formatter_LineFormatter',
        'ehough_epilog_formatter_NormalizerFormatter',
        'ehough_epilog_handler_AbstractHandler',
        'ehough_epilog_handler_AbstractProcessingHandler',
        'ehough_epilog_handler_HandlerInterface',
        'ehough_epilog_psr_LoggerInterface',
