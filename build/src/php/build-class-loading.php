...
class tubepress_build_ClassCollectionBuilder
{
    ...
    public static function build()
    {
        ...
        $classes = require TUBEPRESS_ROOT . '/build/config/boot-classes.php';

        $classes = self::load(
            $classes,
            realpath(__DIR__) . '/../../target/stage/tubepress/src/php/scripts/classloading',
            'classes',
            false
        );
        ...
        foreach ($classes as $class) {
            ...
            $stagedPath   = realpath(__DIR__) . '/../../target/stage/tubepress/' . $relativePath;
        ...
        file_put_contents(realpath(__DIR__) . '/../../target/stage/tubepress/src/php/scripts/classloading/classmap.php', $linesToKeep);
    }
