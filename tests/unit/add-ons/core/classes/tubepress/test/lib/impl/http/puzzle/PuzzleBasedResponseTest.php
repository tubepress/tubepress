...
/**
 * @covers tubepress_lib_impl_http_puzzle_PuzzleBasedResponse<extended>
 */
class tubepress_test_lib_http_impl_puzzle_message_PuzzleResponseTest extends tubepress_test_TubePressUnitTest
{
    ...
    {
        $response = new tubepress_lib_impl_http_puzzle_PuzzleBasedResponse(new puzzle_message_Response(999, array(), null, array('reason_phrase' => 'hi!')));
    ...
    public function testConvertsToString()
    {
        ...
        // Add another header
        $response = new tubepress_lib_impl_http_puzzle_PuzzleBasedResponse(new puzzle_message_Response(200, array('X-Test' => 'Guzzle')));
        $this->assertEquals("HTTP/1.1 200 OK\r\nX-Test: Guzzle\r\n\r\n", (string) $response);
        $response = new tubepress_lib_impl_http_puzzle_PuzzleBasedResponse(new puzzle_message_Response(200, array('Content-Length' => 4), puzzle_stream_Stream::factory('test')));
    ...
    {
        $json = '{"foo": "bar"}';
        $response = new tubepress_lib_impl_http_puzzle_PuzzleBasedResponse(new puzzle_message_Response(200, array(), puzzle_stream_Stream::factory($json)));
    ...
    {
        try {
            $response = new tubepress_lib_impl_http_puzzle_PuzzleBasedResponse(new puzzle_message_Response(200, array(), puzzle_stream_Stream::factory('{"foo": "')));
            $response->toJson();
    ...
    {
        $r = new tubepress_lib_impl_http_puzzle_PuzzleBasedResponse(new puzzle_message_Response(200));
        ...
        $r = new tubepress_lib_impl_http_puzzle_PuzzleBasedResponse($r);
        $this->assertInstanceOf('tubepress_platform_api_url_UrlInterface', $r->getEffectiveUrl());
    }
}