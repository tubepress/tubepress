...
/**
 * @covers tubepress_lib_impl_http_puzzle_RequestException
 */
class tubepress_test_lib_http_impl_puzzle_exception_RequestExceptionTest extends tubepress_test_TubePressUnitTest
{
    ...
    /**
     * @var tubepress_lib_impl_http_puzzle_RequestException
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_lib_impl_http_puzzle_RequestException($this->_mockPuzzleException);
    }
