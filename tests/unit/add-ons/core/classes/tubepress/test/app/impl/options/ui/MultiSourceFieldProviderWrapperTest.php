...
/**
 * @covers tubepress_app_impl_options_ui_MultiSourceFieldProviderWrapper<extended>
 */
class tubepress_test_app_impl_options_ui_MultiSourceFieldProviderWrapperTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_app_impl_options_ui_MultiSourceFieldProviderWrapper
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_app_impl_options_ui_MultiSourceFieldProviderWrapper(
            $this->_mockDelegate,
            $this->_mockFields
        );
    }
