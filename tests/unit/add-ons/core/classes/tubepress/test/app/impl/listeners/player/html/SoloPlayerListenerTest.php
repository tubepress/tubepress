...
/**
 * @covers tubepress_app_impl_listeners_player_html_SoloPlayerListener
 */
class tubepress_test_app_impl_listeners_player_html_SoloPlayerListenerTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_app_impl_listeners_player_html_SoloPlayerListener
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_app_impl_listeners_player_html_SoloPlayerListener(
