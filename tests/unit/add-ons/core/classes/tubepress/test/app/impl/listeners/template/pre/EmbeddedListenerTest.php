...
/**
 * @covers tubepress_app_impl_listeners_template_pre_EmbeddedListener
 */
class tubepress_test_app_impl_listeners_template_pre_EmbeddedListenerTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_app_impl_listeners_template_pre_EmbeddedListener
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_app_impl_listeners_template_pre_EmbeddedListener(
