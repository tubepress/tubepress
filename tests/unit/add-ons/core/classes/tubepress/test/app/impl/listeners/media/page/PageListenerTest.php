...
/**
 * @covers tubepress_app_impl_listeners_media_page_PageListener
 */
class tubepress_test_app_impl_listeners_media_page_PageListenerTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_app_impl_listeners_media_page_PageListener
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_app_impl_listeners_media_page_PageListener(
            $this->_mockLogger,
