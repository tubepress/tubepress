...
/**
 * @covers tubepress_app_impl_listeners_html_scripts_GlobalJsConfigListener
 */
class tubepress_test_app_impl_listeners_html_scripts_GlobalJsConfigListenerTest extends tubepress_test_TubePressUnitTest
{
    /**
    ...
    /**
     * @var tubepress_app_impl_listeners_html_scripts_GlobalJsConfigListener
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut                     = new tubepress_app_impl_listeners_html_scripts_GlobalJsConfigListener(
