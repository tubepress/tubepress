...
/**
 * @covers tubepress_app_impl_listeners_gallery_js_GalleryOptionsListener<extended>
 */
class tubepress_test_app_impl_listeners_gallery_js_GalleryOptionsListenerTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_app_impl_listeners_gallery_js_GalleryOptionsListener
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_app_impl_listeners_gallery_js_GalleryOptionsListener(
