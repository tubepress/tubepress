...
/**
 * @covers tubepress_app_impl_listeners_gallery_html_NoRobotsListener<extended>
 */
class tubepress_test_app_impl_listeners_gallery_html_NoRobotsListenerTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_app_impl_listeners_gallery_html_NoRobotsListener
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_app_impl_listeners_gallery_html_NoRobotsListener(
