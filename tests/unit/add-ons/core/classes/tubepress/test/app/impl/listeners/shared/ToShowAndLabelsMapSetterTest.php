...
/**
 * @covers tubepress_app_impl_listeners_shared_ToShowAndLabelsMapSetter
 */
class tubepress_test_app_impl_listeners_shared_ToShowAndLabelsMapSetter extends tubepress_test_TubePressUnitTest
{
    /**
    ...
    /**
     * @var tubepress_app_impl_listeners_shared_ToShowAndLabelsMapSetter
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_app_impl_listeners_shared_ToShowAndLabelsMapSetter(
            $this->_mockContext,
