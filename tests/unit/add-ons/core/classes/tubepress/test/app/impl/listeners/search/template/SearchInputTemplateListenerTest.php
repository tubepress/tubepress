...
/**
 * @covers tubepress_app_impl_listeners_search_template_SearchInputTemplateListener
 */
class tubepress_test_app_impl_listeners_search_template_SearchInputTemplateListenerTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_app_impl_listeners_search_template_SearchInputTemplateListener
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_app_impl_listeners_search_template_SearchInputTemplateListener(
            $this->_mockContext,
