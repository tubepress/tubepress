...
/**
 * @covers tubepress_app_impl_listeners_gallery_html_AsyncGalleryInitJsListener<extended>
 */
class tubepress_test_app_impl_listeners_gallery_html_AsyncGalleryInitJsListenerTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_app_impl_listeners_gallery_html_AsyncGalleryInitJsListener
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_app_impl_listeners_gallery_html_AsyncGalleryInitJsListener(
    ...
    public function testOnGalleryHtml()
    {
        ...
        $this->_sut->onGalleryTemplatePostRender($event);
