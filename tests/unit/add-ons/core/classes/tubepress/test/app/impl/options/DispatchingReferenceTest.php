...
/**
 * @covers tubepress_app_impl_options_DispatchingReference<extended>
 */
class tubepress_test_app_impl_options_DispatchingReferenceTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_app_impl_options_DispatchingReference
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_app_impl_options_DispatchingReference($this->_mockEventDispatcher);
