...
/**
 * @covers tubepress_app_impl_listeners_template_post_HtmlScriptsPostListener
 */
class tubepress_test_app_impl_listeners_template_post_HtmlScriptsPostListenerTest extends tubepress_test_TubePressUnitTest
{
    /**
    ...
    /**
     * @var tubepress_app_impl_listeners_template_post_HtmlScriptsPostListener
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut                     = new tubepress_app_impl_listeners_template_post_HtmlScriptsPostListener(
