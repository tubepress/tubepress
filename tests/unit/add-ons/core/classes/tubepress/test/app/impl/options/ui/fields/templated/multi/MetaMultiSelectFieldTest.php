...
/**
 * @covers tubepress_app_impl_options_ui_fields_templated_multi_MetaMultiSelectField<extended>
 */
class tubepress_test_app_impl_options_ui_fields_templated_multi_MetaMultiSelectFieldTest extends tubepress_test_app_impl_options_ui_fields_templated_multi_AbstractMultiSelectFieldTest
{
    ...
    protected function onAfterTemplateBasedFieldSetup()
    {
        ...
        $this->_mockVideoProvider1  = $this->mock(tubepress_app_api_media_MediaProviderInterface::__);
        $this->_mockVideoProvider2  = $this->mock(tubepress_app_api_media_MediaProviderInterface::__);
    }
    ...
    {
        $sut = new tubepress_app_impl_options_ui_fields_templated_multi_MetaMultiSelectField(
