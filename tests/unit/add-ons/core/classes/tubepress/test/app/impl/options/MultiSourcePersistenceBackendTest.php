...
/**
 * @covers tubepress_app_impl_options_MultiSourcePersistenceBackend<extended>
 */
class tubepress_test_app_options_MultiSourcePersistenceBackendTest extends tubepress_test_TubePressUnitTest
{
    /**
    ...
    {
        $this->_sut = new tubepress_app_impl_options_MultiSourcePersistenceBackend(array('foo' => 'bar'));
    }
