...
/**
 * @covers tubepress_app_impl_listeners_template_pre_SingleItemListener
 */
class tubepress_test_app_impl_listeners_template_pre_SingleItemListenerTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_app_impl_listeners_template_pre_SingleItemListener
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_app_impl_listeners_template_pre_SingleItemListener(
            $this->_mockContext,
    ...
    public function testOnSingleVideo()
    {
        ...
        $event->shouldReceive('hasArgument')->once()->with('mediaItem')->andReturn(true);
        $event->shouldReceive('getArgument')->once()->with('mediaItem')->andReturn($video);
