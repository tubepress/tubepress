...
/**
 * @covers tubepress_app_impl_options_Context<extended>
 */
class tubepress_test_app_impl_options_ContextTest extends tubepress_test_app_impl_options_AbstractOptionReaderTest
{
    /**
     * @var tubepress_app_impl_options_Context
     */
    private $_sut;
    ...
    protected function doSetup()
    {
        ...
        $this->_sut = new tubepress_app_impl_options_Context(
