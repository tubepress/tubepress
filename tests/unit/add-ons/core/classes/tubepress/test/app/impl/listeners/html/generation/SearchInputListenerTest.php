...
/**
 * @covers tubepress_app_impl_listeners_html_generation_SearchInputListener
 */
class tubepress_test_app_impl_listeners_html_generation_SearchInputListenerTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_app_impl_listeners_html_generation_SearchInputListener
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_app_impl_listeners_html_generation_SearchInputListener(
