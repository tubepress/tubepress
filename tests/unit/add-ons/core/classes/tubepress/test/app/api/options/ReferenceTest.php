...
/**
 * @covers tubepress_app_api_options_Reference<extended>
 */
class tubepress_test_app_options_api_ReferenceTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_app_api_options_Reference
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $boolMap = array(
            ...
            tubepress_app_api_options_Reference::PROPERTY_NO_SHORTCODE => array()
        );

        $this->_sut = new tubepress_app_api_options_Reference(
