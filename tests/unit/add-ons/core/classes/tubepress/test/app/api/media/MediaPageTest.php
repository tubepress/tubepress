...
/**
 * @covers tubepress_app_api_media_MediaPage
 */
class tubepress_test_app_api_media_MediaPageTest extends tubepress_test_TubePressUnitTest
{
    /**
    ...
    {
        $this->_sut = new tubepress_app_api_media_MediaPage();
    }
