...
class tubepress_test_http_HttpManifestTest extends tubepress_test_platform_impl_boot_helper_uncached_contrib_AbstractManifestTest
{
    public function testManifest()
    {
        ...
        $this->assertEquals('tubepress/http', $addon->getName());
        $this->assertEquals('99.99.99', $addon->getVersion());
        $this->assertEquals('TubePress HTTP Services', $addon->getTitle());
    ...
    {
        return TUBEPRESS_ROOT . '/src/add-ons/http/manifest.json';
    }
}