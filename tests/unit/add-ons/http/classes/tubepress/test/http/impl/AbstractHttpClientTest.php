 ...
 */
class tubepress_test_http_impl_AbstractHttpClientest extends tubepress_test_TubePressUnitTest
{
    /**
    ...
    public function testSlowSend()
    {
        ...
        $mockBodyStream  = $this->mock('tubepress_lib_api_streams_StreamInterface');
