...
class tubepress_test_url_UrlManifestTest extends tubepress_test_platform_impl_boot_helper_uncached_contrib_AbstractManifestTest
{
    public function testManifest()
    {
        ...
        $this->assertEquals('tubepress/url', $addon->getName());
        $this->assertEquals('99.99.99', $addon->getVersion());
        $this->assertEquals('TubePress URL Services', $addon->getTitle());
    ...
    {
        return TUBEPRESS_ROOT . '/src/add-ons/url/manifest.json';
    }
}