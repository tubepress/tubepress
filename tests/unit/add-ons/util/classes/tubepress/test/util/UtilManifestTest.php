...
class tubepress_test_util_UtilManifestTest extends tubepress_test_platform_impl_boot_helper_uncached_contrib_AbstractManifestTest
{
    public function testManifest()
    {
        ...
        $this->assertEquals('tubepress/util', $addon->getName());
        $this->assertEquals('99.99.99', $addon->getVersion());
        $this->assertEquals('TubePress Low-Level Utilities', $addon->getTitle());
    ...
    {
        return TUBEPRESS_ROOT . '/src/add-ons/util/manifest.json';
    }
}