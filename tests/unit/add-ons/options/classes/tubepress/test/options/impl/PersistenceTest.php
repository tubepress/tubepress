...
/**
 * @covers tubepress_options_impl_Persistence<extended>
 */
class tubepress_test_options_impl_PersistenceTest extends tubepress_test_options_impl_AbstractOptionReaderTest
{
    /**
