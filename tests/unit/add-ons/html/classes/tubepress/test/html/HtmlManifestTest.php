...
class tubepress_test_html_HtmlManifestTest extends tubepress_test_platform_impl_boot_helper_uncached_contrib_AbstractManifestTest
{
    public function testManifest()
    {
        ...
        $this->assertEquals('tubepress/html', $addon->getName());
        $this->assertEquals('99.99.99', $addon->getVersion());
        $this->assertEquals('TubePress HTML Services and Templates', $addon->getTitle());
    ...
    {
        return TUBEPRESS_ROOT . '/src/add-ons/html/manifest.json';
    }
}