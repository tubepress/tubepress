...
class tubepress_test_app_VimeoManifestValidityTest extends tubepress_api_test_contrib_AbstractManifestTest
{
    ...
    {
        return TUBEPRESS_ROOT . '/src/add-ons/provider-vimeo-v2/manifest.json';
    }
