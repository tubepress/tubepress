...
class tubepress_test_vimeo2_impl_listeners_media_HttpItemListenerTest extends tubepress_test_TubePressUnitTest
{
    ...
    {
        $serial_str = file_get_contents(TUBEPRESS_ROOT . '/tests/unit/add-ons/provider-vimeo-v2/resources/vimeo-single-video.txt');
    ...
    {
        $serial_str = file_get_contents(TUBEPRESS_ROOT . '/tests/unit/add-ons/provider-vimeo-v2/resources/vimeo-gallery.txt');
