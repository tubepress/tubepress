...
class tubepress_test_JwPlayerManifestValidityTest extends tubepress_test_platform_impl_boot_helper_uncached_contrib_AbstractManifestTest
{
    ...
    {
        return TUBEPRESS_ROOT . '/src/add-ons/jwplayer5/manifest.json';
    }
}