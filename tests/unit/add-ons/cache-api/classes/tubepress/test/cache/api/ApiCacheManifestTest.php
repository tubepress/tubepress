...
class tubepress_test_cache_api_ApiCacheManifestTest extends tubepress_test_platform_impl_boot_helper_uncached_contrib_AbstractManifestTest
{
    public function testManifest()
    {
        ...
        $this->assertEquals('tubepress/cache-api', $addon->getName());
    ...
    {
        return TUBEPRESS_ROOT . '/src/add-ons/cache-api/manifest.json';
    }
}