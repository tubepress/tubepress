...
class tubepress_test_meta_MetaManifestTest extends tubepress_test_platform_impl_boot_helper_uncached_contrib_AbstractManifestTest
{
    public function testManifest()
    {
        ...
        $this->assertEquals('tubepress/meta', $addon->getName());
        $this->assertEquals('99.99.99', $addon->getVersion());
        $this->assertEquals('TubePress Metadata Functionality', $addon->getTitle());
    ...
    {
        return TUBEPRESS_ROOT . '/src/add-ons/meta/manifest.json';
    }
}