...
class tubepress_test_theme_ThemeManifestTest extends tubepress_test_platform_impl_boot_helper_uncached_contrib_AbstractManifestTest
{
    public function testManifest()
    {
        ...
        $this->assertEquals('tubepress/theme', $addon->getName());
        $this->assertEquals('99.99.99', $addon->getVersion());
        $this->assertEquals('TubePress Theme Services', $addon->getTitle());
    ...
    {
        return TUBEPRESS_ROOT . '/src/add-ons/theme/manifest.json';
    }
}