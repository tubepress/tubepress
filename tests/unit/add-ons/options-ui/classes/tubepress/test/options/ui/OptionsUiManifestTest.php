...
class tubepress_test_options_ui_OptionsUiManifestTest extends tubepress_test_platform_impl_boot_helper_uncached_contrib_AbstractManifestTest
{
    public function testManifest()
    {
        ...
        $this->assertEquals('tubepress/options-ui', $addon->getName());
        $this->assertEquals('99.99.99', $addon->getVersion());
        $this->assertEquals('TubePress Array Reader', $addon->getTitle());
    ...
    {
        return TUBEPRESS_ROOT . '/src/add-ons/options-ui/manifest.json';
    }
}