...
class tubepress_test_media_MediaManifestTest extends tubepress_test_platform_impl_boot_helper_uncached_contrib_AbstractManifestTest
{
    public function testManifest()
    {
        ...
        $this->assertEquals('tubepress/media', $addon->getName());
        $this->assertEquals('99.99.99', $addon->getVersion());
        $this->assertEquals('TubePress Media Collection and Preparation', $addon->getTitle());
    ...
    {
        return TUBEPRESS_ROOT . '/src/add-ons/media/manifest.json';
    }
}