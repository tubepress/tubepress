...
class tubepress_test_player_PlayerManifestTest extends tubepress_test_platform_impl_boot_helper_uncached_contrib_AbstractManifestTest
{
    public function testManifest()
    {
        ...
        $this->assertEquals('tubepress/player', $addon->getName());
        $this->assertEquals('99.99.99', $addon->getVersion());
        $this->assertEquals('TubePress Player Functionality and Default Players', $addon->getTitle());
    ...
    {
        return TUBEPRESS_ROOT . '/src/add-ons/player/manifest.json';
    }
}