...
class tubepress_test_shortcode_ShortcodeManifestTest extends tubepress_test_platform_impl_boot_helper_uncached_contrib_AbstractManifestTest
{
    public function testManifest()
    {
        ...
        $this->assertEquals('tubepress/shortcode', $addon->getName());
        $this->assertEquals('99.99.99', $addon->getVersion());
        $this->assertEquals('TubePress Shortcode Parser', $addon->getTitle());
    ...
    {
        return TUBEPRESS_ROOT . '/src/add-ons/shortcode/manifest.json';
    }
}