...
class tubepress_test_event_EventManifestTest extends tubepress_test_platform_impl_boot_helper_uncached_contrib_AbstractManifestTest
{
    public function testManifest()
    {
        ...
        $this->assertEquals('tubepress/event', $addon->getName());
    ...
    {
        return TUBEPRESS_ROOT . '/src/add-ons/event/manifest.json';
    }
}