...
class tubepress_test_environment_EnvironmentManifestTest extends tubepress_test_platform_impl_boot_helper_uncached_contrib_AbstractManifestTest
{
    public function testManifest()
    {
        ...
        $this->assertEquals('tubepress/environment', $addon->getName());
        $this->assertEquals('99.99.99', $addon->getVersion());
        $this->assertEquals('TubePress Environment Detection Services', $addon->getTitle());
    ...
    {
        return TUBEPRESS_ROOT . '/src/add-ons/environment/manifest.json';
    }
}