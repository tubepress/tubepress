...
class tubepress_test_array_ArrayManifestTest extends tubepress_test_platform_impl_boot_helper_uncached_contrib_AbstractManifestTest
{
    public function testManifest()
    {
        ...
        $this->assertEquals('tubepress/array', $addon->getName());
    ...
    {
        return TUBEPRESS_ROOT . '/src/add-ons/array/manifest.json';
    }
}