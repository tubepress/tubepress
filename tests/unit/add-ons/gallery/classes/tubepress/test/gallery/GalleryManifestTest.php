...
class tubepress_test_gallery_GalleryManifestTest extends tubepress_test_platform_impl_boot_helper_uncached_contrib_AbstractManifestTest
{
    public function testManifest()
    {
        ...
        $this->assertEquals('tubepress/gallery', $addon->getName());
        $this->assertEquals('99.99.99', $addon->getVersion());
        $this->assertEquals('TubePress Gallery Functionality', $addon->getTitle());
    ...
    {
        return TUBEPRESS_ROOT . '/src/add-ons/gallery/manifest.json';
    }
}