...
class tubepress_test_feed_FeedManifestTest extends tubepress_test_platform_impl_boot_helper_uncached_contrib_AbstractManifestTest
{
    public function testManifest()
    {
        ...
        $this->assertEquals('tubepress/feed', $addon->getName());
        $this->assertEquals('99.99.99', $addon->getVersion());
        $this->assertEquals('TubePress Feed Options', $addon->getTitle());
    ...
    {
        return TUBEPRESS_ROOT . '/src/add-ons/feed/manifest.json';
    }
}