 ...
 */
class tubepress_test_template_ioc_TemplateExtensionTest extends tubepress_test_platform_impl_ioc_AbstractContainerExtensionTest
{
    ...
    private function _expectTemplateService()
    {
        ...
        foreach ($parallelServices as $serviceSuffix) {
            ...
            )->withArgument(new tubepress_platform_api_ioc_Reference('tubepress_template_impl_ThemeTemplateLocator' . $serviceSuffix));
        ...
        $this->expectRegistration(
            ...
            'tubepress_template_impl_php_Support'
        )->withArgument(new tubepress_platform_api_ioc_Reference('tubepress_template_impl_ThemeTemplateLocator'));
        ...
        $this->expectRegistration(
            ...
            'tubepress_template_impl_php_PhpEngine'
        )->withArgument(new tubepress_platform_api_ioc_Reference('tubepress_template_impl_php_Support'))
            ->withArgument(new tubepress_platform_api_ioc_Reference('tubepress_template_impl_php_Support'));
        ...
        )->withArgument(new tubepress_platform_api_ioc_Reference('tubepress_template_impl_DelegatingEngine'))
        ...
        $this->expectRegistration(
            ...
            'tubepress_template_impl_TemplatingService'
        )->withArgument(new tubepress_platform_api_ioc_Reference('tubepress_template_impl_twig_Engine.admin'))
            ->withArgument(new tubepress_platform_api_ioc_Reference(tubepress_lib_api_event_EventDispatcherInterface::_));
    }
