...
class tubepress_test_logger_LoggerManifestTest extends tubepress_test_platform_impl_boot_helper_uncached_contrib_AbstractManifestTest
{
    public function testManifest()
    {
        ...
        $this->assertEquals('tubepress/logger', $addon->getName());
    ...
    {
        return TUBEPRESS_ROOT . '/src/add-ons/logger/manifest.json';
    }
}