 ...
 */
class tubepress_test_embedded_common_ioc_EmbeddedCommonExtensionTest extends tubepress_test_platform_impl_ioc_AbstractContainerExtensionTest
{
    /**
    ...
    private function _registerOptionsUi()
    {
        ...
        )->withArgument(tubepress_app_api_options_ui_CategoryNames::EMBEDDED)
