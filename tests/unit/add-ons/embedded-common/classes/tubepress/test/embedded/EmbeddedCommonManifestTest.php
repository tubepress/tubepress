...
class tubepress_test_embedded_common_EmbeddedCommonManifestTest extends tubepress_test_platform_impl_boot_helper_uncached_contrib_AbstractManifestTest
{
    public function testManifest()
    {
        ...
        $this->assertEquals('tubepress/embedded-common', $addon->getName());
        $this->assertEquals('99.99.99', $addon->getVersion());
        $this->assertEquals('TubePress Common Embedded Functionality', $addon->getTitle());
    ...
    {
        return TUBEPRESS_ROOT . '/src/add-ons/embedded-common/manifest.json';
    }
}