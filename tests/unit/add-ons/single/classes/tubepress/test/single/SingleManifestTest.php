...
class tubepress_test_single_SingleManifestTest extends tubepress_test_platform_impl_boot_helper_uncached_contrib_AbstractManifestTest
{
    public function testManifest()
    {
        ...
        $this->assertEquals('tubepress/single', $addon->getName());
        $this->assertEquals('99.99.99', $addon->getVersion());
        $this->assertEquals('TubePress Single Video Embeds', $addon->getTitle());
    ...
    {
        return TUBEPRESS_ROOT . '/src/add-ons/single/manifest.json';
    }
}