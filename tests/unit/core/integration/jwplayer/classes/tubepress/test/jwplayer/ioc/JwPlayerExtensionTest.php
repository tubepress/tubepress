 ...
 */
class tubepress_test_jwplayer_ioc_JwPlayerExtensionTest extends tubepress_test_ioc_AbstractIocContainerExtensionTest
{
    ...
    protected function prepareForLoad()
    {
        ...
        $this->expectParameter(tubepress_app_options_api_Constants::IOC_PARAM_EASY_REFERENCE . '_jwplayer', array(
        ...
        $this->expectParameter(tubepress_app_options_api_Constants::IOC_PARAM_EASY_VALIDATION . '_jwplayer', array(
            'priority' => 3000,
            'map' => array(
                'hexColor' => array(
        ...
        $this->expectParameter(tubepress_app_options_api_Constants::IOC_PARAM_EASY_TRIMMER . '_jwplayer', array(
    ...
    protected function getExpectedExternalServicesMap()
    {
        ...
        foreach ($colors as $color) {
            ...
            $mockSpectrumField = $this->mock('tubepress_app_options_ui_api_FieldInterface');
