...
class tubepress_test_wordpress_impl_WidgetTest extends tubepress_test_TubePressUnitTest
{
    ...
    public function onSetup()
    {
        ...
        $this->_mockTemplateBuilder             = $this->mock(tubepress_lib_template_api_TemplateFactoryInterface::_);
    ...
    public function testPrintWidgetControl()
    {
        ...
        $this->_mockTemplateBuilder->shouldReceive('fromFilesystem')->once()->with(array(TUBEPRESS_ROOT . '/src/core/integration/wordpress/resources/templates/widget_controls.tpl.php'))->andReturn($mockTemplate);
    ...
    public function testPrintWidget()
    {
        ...
        $this->_mockExecutionContext->shouldReceive('get')->once()->with(tubepress_app_theme_api_Constants::OPTION_THEME)->andReturn('theme');
        ...
        $this->_mockExecutionContext->shouldReceive('getEphemeralOptions')->once()->andReturn(array(tubepress_app_feature_gallery_api_Constants::OPTION_THUMB_WIDTH => 22135));
        $this->_mockExecutionContext->shouldReceive('setEphemeralOptions')->once()->with(array(
            ...
            tubepress_app_feature_gallery_api_Constants::OPTION_THUMB_WIDTH         => 22135,
