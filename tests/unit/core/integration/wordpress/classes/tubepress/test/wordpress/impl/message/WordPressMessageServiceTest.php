...
class tubepress_test_wordpress_impl_message_WordPressMessageServiceTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_wordpress_impl_message_WordPressMessageService
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_wordpress_impl_message_WordPressMessageService($wrapper);
    }
