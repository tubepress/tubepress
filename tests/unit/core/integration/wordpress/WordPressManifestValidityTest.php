...
class tubepress_test_app_WordPressManifestValidityTest extends tubepress_test_addon_AbstractManifestValidityTest
{
    ...
    {
        return TUBEPRESS_ROOT . '/src/core/integration/wordpress/manifest.json';
    }
