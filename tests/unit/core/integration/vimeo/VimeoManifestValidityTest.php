...
class tubepress_test_app_VimeoManifestValidityTest extends tubepress_test_addon_AbstractManifestValidityTest
{
    ...
    {
        return TUBEPRESS_ROOT . '/src/core/integration/vimeo/manifest.json';
    }
