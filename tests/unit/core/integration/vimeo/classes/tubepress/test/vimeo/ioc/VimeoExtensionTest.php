...
/**
 * @covers tubepress_vimeo_ioc_VimeoExtension
 */
class tubepress_test_vimeo_impl_ioc_VimeoExtensionTest extends tubepress_test_ioc_AbstractIocContainerExtensionTest
{
    ...
    protected function prepareForLoad()
    {
        ...
        $this->expectRegistration(
            ...
            'tubepress_vimeo_impl_listeners_http_VimeoOauthRequestListener'
        )->withArgument(new tubepress_platform_api_ioc_Reference(tubepress_lib_http_api_oauth_v1_ClientInterface::_))
            ->withArgument(new tubepress_platform_api_ioc_Reference(tubepress_app_options_api_ContextInterface::_))
        ...
        $this->expectParameter(tubepress_app_options_api_Constants::IOC_PARAM_EASY_TRIMMER . '_vimeo', array(
            'priority'    => 9500,
            'charlist'    => '#',
            'ltrim'       => true,
            'optionNames' => array(
        ...
        $this->expectRegistration(
            ...
            ->withArgument(new tubepress_platform_api_ioc_Reference(tubepress_app_options_api_ContextInterface::_))
            ->withArgument(new tubepress_platform_api_ioc_Reference(tubepress_app_media_provider_api_ItemSorterInterface::_))
        ...
        $this->expectParameter(tubepress_app_options_api_Constants::IOC_PARAM_EASY_REFERENCE . '_vimeo', array(
        ...
        $this->expectParameter(tubepress_app_media_item_api_Constants::IOC_PARAM_EASY_ATTRIBUTE_FORMATTER . '_vimeo', array(
        ...
        $this->expectParameter(tubepress_app_options_api_Constants::IOC_PARAM_EASY_VALIDATION . '_vimeo', array(
    ...
    protected function getExpectedExternalServicesMap()
    {
        ...
        $mockElementBuilder = $this->mock(tubepress_app_options_ui_api_ElementBuilderInterface::_);
        $mockElement = $this->mock('tubepress_app_options_ui_api_ElementInterface');
        ...
        return array(
            ...
            tubepress_lib_http_api_oauth_v1_ClientInterface::_ => tubepress_lib_http_api_oauth_v1_ClientInterface::_,
            ...
            tubepress_app_media_provider_api_ItemSorterInterface::_ => tubepress_app_media_provider_api_ItemSorterInterface::_,
            tubepress_app_options_ui_api_ElementBuilderInterface::_ => $mockElementBuilder,
        );
    }
}