...
class tubepress_test_youtube_impl_provider_YouTubeProviderTest extends tubepress_test_TubePressUnitTest
{
    ...
    public function onSetup()
    {
        ...
        $this->_mockExecutionContext->shouldReceive('get')->zeroOrMoreTimes()->with(tubepress_app_media_provider_api_Constants::OPTION_RESULTS_PER_PAGE)->andReturn(20);
    ...
    public function testSingleVideoUrl()
    {
        ...
        $mockQuery = $this->mock('tubepress_lib_url_api_QueryInterface');
    ...
    {
        $this->_mockExecutionContext->shouldReceive('get')->zeroOrMoreTimes()->with(tubepress_app_media_provider_api_Constants::OPTION_ORDER_BY)->andReturn('viewCount');

        $this->expectOptions(array(
            tubepress_app_media_provider_api_Constants::OPTION_GALLERY_SOURCE => tubepress_youtube_api_Constants::GALLERYSOURCE_YOUTUBE_USER,
            'userValue' => '3hough'
        ));
    ...
    public function testexecutePlaylist()
    {
        ...
        $this->expectOptions(array(
            tubepress_app_media_provider_api_Constants::OPTION_GALLERY_SOURCE => tubepress_youtube_api_Constants::GALLERYSOURCE_YOUTUBE_PLAYLIST,
    ...
    public function testexecuteFavorites()
    {
        ...
        $this->expectOptions(array(
            tubepress_app_media_provider_api_Constants::OPTION_GALLERY_SOURCE => tubepress_youtube_api_Constants::GALLERYSOURCE_YOUTUBE_FAVORITES,
    ...
    public function testexecuteTagWithDoubleQuotes()
    {
        ...
        $this->expectOptions(array(
            tubepress_app_media_provider_api_Constants::OPTION_GALLERY_SOURCE      => tubepress_youtube_api_Constants::GALLERYSOURCE_YOUTUBE_SEARCH,
    ...
    public function testexecuteTagWithUser()
    {
        ...
        $this->expectOptions(array(
            tubepress_app_media_provider_api_Constants::OPTION_GALLERY_SOURCE => tubepress_youtube_api_Constants::GALLERYSOURCE_YOUTUBE_SEARCH,
            tubepress_app_feature_search_api_Constants::OPTION_SEARCH_ONLY_USER => '3hough',
            'tagValue' => 'stewart daily show'
        ));
    ...
    public function testNewestSortOrderNonPlaylist()
    {
        $this->expectOptions(array(
            ...
            tubepress_app_media_provider_api_Constants::OPTION_ORDER_BY => tubepress_youtube_api_Constants::ORDER_BY_NEWEST
        ));
    ...
    public function testViewsSortOrderNonPlaylist()
    {
        $this->expectOptions(array(
            ...
            tubepress_app_media_provider_api_Constants::OPTION_GALLERY_SOURCE => tubepress_youtube_api_Constants::GALLERYSOURCE_YOUTUBE_USER,
            tubepress_youtube_api_Constants::OPTION_YOUTUBE_USER_VALUE => '3hough',
            tubepress_app_media_provider_api_Constants::OPTION_ORDER_BY => tubepress_youtube_api_Constants::ORDER_BY_VIEW_COUNT
        ));
    ...
    public function testRelevanceSortOrderNonPlaylist()
    {
        $this->expectOptions(array(
            ...
            tubepress_app_media_provider_api_Constants::OPTION_GALLERY_SOURCE => tubepress_youtube_api_Constants::GALLERYSOURCE_YOUTUBE_USER,
            tubepress_youtube_api_Constants::OPTION_YOUTUBE_USER_VALUE => '3hough',
            tubepress_app_media_provider_api_Constants::OPTION_ORDER_BY => tubepress_youtube_api_Constants::ORDER_BY_RELEVANCE
        ));
    ...
    public function testRatingSortOrderNonPlaylist()
    {
        $this->expectOptions(array(
            ...
            tubepress_app_media_provider_api_Constants::OPTION_GALLERY_SOURCE => tubepress_youtube_api_Constants::GALLERYSOURCE_YOUTUBE_USER,
            tubepress_youtube_api_Constants::OPTION_YOUTUBE_USER_VALUE => '3hough',
            tubepress_app_media_provider_api_Constants::OPTION_ORDER_BY => tubepress_youtube_api_Constants::ORDER_BY_RATING
        ));
    ...
    public function testPositionSortOrderNonPlaylist()
    {
        $this->expectOptions(array(
            ...
            tubepress_app_media_provider_api_Constants::OPTION_GALLERY_SOURCE => tubepress_youtube_api_Constants::GALLERYSOURCE_YOUTUBE_USER,
            tubepress_youtube_api_Constants::OPTION_YOUTUBE_USER_VALUE => '3hough',
            tubepress_app_media_provider_api_Constants::OPTION_ORDER_BY => tubepress_youtube_api_Constants::ORDER_BY_POSITION
        ));
    ...
    public function testCommentsSortOrderNonPlaylist()
    {
        $this->expectOptions(array(
            ...
            tubepress_app_media_provider_api_Constants::OPTION_GALLERY_SOURCE => tubepress_youtube_api_Constants::GALLERYSOURCE_YOUTUBE_USER,
            tubepress_youtube_api_Constants::OPTION_YOUTUBE_USER_VALUE => '3hough',
            tubepress_app_media_provider_api_Constants::OPTION_ORDER_BY => tubepress_youtube_api_Constants::ORDER_BY_COMMENT_COUNT
        ));
    ...
    public function testDurationSortOrderNonPlaylist()
    {
        $this->expectOptions(array(
            ...
            tubepress_app_media_provider_api_Constants::OPTION_GALLERY_SOURCE => tubepress_youtube_api_Constants::GALLERYSOURCE_YOUTUBE_USER,
            tubepress_youtube_api_Constants::OPTION_YOUTUBE_USER_VALUE => '3hough',
            tubepress_app_media_provider_api_Constants::OPTION_ORDER_BY => tubepress_youtube_api_Constants::ORDER_BY_DURATION
        ));
    ...
    public function testRevPositionSortOrderNonPlaylist()
    {
        $this->expectOptions(array(
            ...
            tubepress_app_media_provider_api_Constants::OPTION_GALLERY_SOURCE => tubepress_youtube_api_Constants::GALLERYSOURCE_YOUTUBE_USER,
            tubepress_youtube_api_Constants::OPTION_YOUTUBE_USER_VALUE => '3hough',
            tubepress_app_media_provider_api_Constants::OPTION_ORDER_BY => tubepress_youtube_api_Constants::ORDER_BY_REV_POSITION
        ));
    ...
    public function testTitleSortOrderNonPlaylist()
    {
        $this->expectOptions(array(
            ...
            tubepress_app_media_provider_api_Constants::OPTION_GALLERY_SOURCE => tubepress_youtube_api_Constants::GALLERYSOURCE_YOUTUBE_USER,
            tubepress_youtube_api_Constants::OPTION_YOUTUBE_USER_VALUE => '3hough',
            tubepress_app_media_provider_api_Constants::OPTION_ORDER_BY => tubepress_youtube_api_Constants::ORDER_BY_TITLE
        ));
