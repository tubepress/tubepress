...
class tubepress_test_youtube_impl_embedded_YouTubeEmbeddedProviderTest extends tubepress_test_TubePressUnitTest
{
    ...
    public function testGetTemplate()
    {
        $expected = array(
           'embedded/youtube.tpl.php',
            TUBEPRESS_ROOT . '/src/core/integration/youtube/resources/templates/embedded/youtube.tpl.php'
        );
    ...
    {
        $this->_mockContext->shouldReceive('get')->once()->with(tubepress_app_embedded_api_Constants::OPTION_AUTOPLAY)->andReturn(true);
        $this->_mockContext->shouldReceive('get')->once()->with(tubepress_app_embedded_api_Constants::OPTION_LOOP)->andReturn(false);
        $this->_mockContext->shouldReceive('get')->once()->with(tubepress_app_embedded_api_Constants::OPTION_SHOW_INFO)->andReturn(true);
        ...
        $mockFullUrl = $this->mock('tubepress_lib_url_api_UrlInterface');
        $mockUrl2 = $this->mock('tubepress_lib_url_api_UrlInterface');
