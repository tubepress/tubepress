...
class tubepress_test_app_YouTubeManifestValidityTest extends tubepress_test_addon_AbstractManifestValidityTest
{
    ...
    {
        return TUBEPRESS_ROOT . '/src/core/integration/youtube/manifest.json';
    }
}