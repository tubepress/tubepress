...
class tubepress_test_app_shortcode_impl_ParserTest extends tubepress_test_TubePressUnitTest
{
    ...
    public function onSetup()
    {
        ...
        $this->_mockExecutionContext->shouldReceive('get')->once()->with(tubepress_app_shortcode_api_Constants::OPTION_KEYWORD)->andReturn('butters');
        $this->_sut = new tubepress_app_shortcode_impl_Parser($this->_mockLogger, $this->_mockExecutionContext, $this->_mockEventDispatcher, $this->_mockStringUtils);
    }
    ...
    public function testMixedCommasWithAllSortsOfQuotes()
    {
        ...
        $expected = array(
            ...
            tubepress_app_media_provider_api_Constants::OPTION_RESULT_COUNT_CAP                => 200,
    ...
    public function testNoCommasWithAllSortsOfQuotes()
    {
        ...
        $expected = array(tubepress_app_media_provider_api_Constants::OPTION_GALLERY_SOURCE => tubepress_youtube_api_Constants::GALLERYSOURCE_YOUTUBE_PLAYLIST,
            tubepress_youtube_api_Constants::OPTION_YOUTUBE_PLAYLIST_VALUE => 'foobar',
            tubepress_app_media_item_api_Constants::OPTION_AUTHOR => 'true',
            tubepress_app_media_provider_api_Constants::OPTION_RESULT_COUNT_CAP => 200,
            tubepress_app_media_provider_api_Constants::OPTION_RESULTS_PER_PAGE => 3
        );
    ...
    private function _setupExpectedFilters($expected, $shortcode)
    {
        foreach ($expected as $name => $value) {
            ...
            $mockAnyEvent = $this->mock('tubepress_lib_event_api_EventInterface');
            ...
            $this->_mockEventDispatcher->shouldReceive('dispatch')->once()->with(tubepress_app_options_api_Constants::EVENT_NVP_READ_FROM_EXTERNAL_INPUT, $mockAnyEvent);

            $mockSingleEvent = $this->mock('tubepress_lib_event_api_EventInterface');
            ...
            $this->_mockEventDispatcher->shouldReceive('dispatch')->once()->with(tubepress_app_options_api_Constants::EVENT_NVP_READ_FROM_EXTERNAL_INPUT . ".$name", $mockSingleEvent);
