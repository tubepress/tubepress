...
class tubepress_test_app_feature_single_SingleItemManifestValidityTest extends tubepress_test_addon_AbstractManifestValidityTest
{
    public function testManifest()
    {
        ...
        $this->assertEquals('tubepress/core-html-single', $addon->getName());
    ...
    {
        return TUBEPRESS_ROOT . '/src/core/app/feature-single/manifest.json';
    }
}