...
/**
 * @covers tubepress_app_feature_single_impl_listeners_html_SingleVideoListener
 */
class tubepress_test_app_feature_single_impl_listeners_html_SingleVideoCommandTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_app_feature_single_impl_listeners_html_SingleVideoListener
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_mockProvider            = $this->mock(tubepress_app_media_provider_api_CollectorInterface::_);
        ...
        $this->_sut = new tubepress_app_feature_single_impl_listeners_html_SingleVideoListener(
    ...
    {
        $this->_mockExecutionContext->shouldReceive('get')->once()->with(tubepress_app_feature_single_api_Constants::OPTION_MEDIA_ITEM_ID)->andReturn('');
    ...
    public function testExecute()
    {
        ...
        $this->_mockExecutionContext->shouldReceive('get')->twice()->with(tubepress_app_feature_single_api_Constants::OPTION_MEDIA_ITEM_ID)->andReturn('video-id');
        ...
        $this->_mockTemplateFactory->shouldReceive('fromFilesystem')->once()->with(array(
            'single_video.tpl.php', TUBEPRESS_ROOT . '/web/themes/default/single_video.tpl.php'
        ...
        $this->_mockEventDispatcher->shouldReceive('hasListeners')->once()->with(tubepress_app_feature_single_api_Constants::EVENT_SINGLE_ITEM_TEMPLATE)->andReturn(true);
        $this->_mockEventDispatcher->shouldReceive('dispatch')->once()->with(tubepress_app_feature_single_api_Constants::EVENT_SINGLE_ITEM_TEMPLATE, $mockTemplateEvent);
        ...
        $this->_mockEventDispatcher->shouldReceive('hasListeners')->once()->with(tubepress_app_feature_single_api_Constants::EVENT_SINGLE_ITEM_HTML)->andReturn(true);
        $this->_mockEventDispatcher->shouldReceive('dispatch')->once()->with(tubepress_app_feature_single_api_Constants::EVENT_SINGLE_ITEM_HTML, $mockHtmlEvent);
