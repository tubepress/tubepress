...
/**
 * @covers tubepress_app_http_impl_PrimaryAjaxHandler
 */
class tubepress_test_lib_http_impl_PrimaryAjaxHandlerTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_app_http_impl_PrimaryAjaxHandler
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_mockHttpResponseCodeService     = $this->mock(tubepress_lib_http_api_ResponseCodeInterface::_);
        ...
        $this->_sut = new tubepress_app_http_impl_PrimaryAjaxHandler(
    ...
    {
        $this->_mockHttpRequestParameterService->shouldReceive('getParamValue')->once()->with('tubepress_action')->andReturn(null);
    ...
    {
        $mockHandler = $this->mock(tubepress_app_http_api_AjaxCommandInterface::_);
        $mockHandler->shouldReceive('getName')->andReturn('action');
        $mockHandler->shouldReceive('handle')->once();

        $this->_mockHttpRequestParameterService->shouldReceive('getParamValue')->once()->with('tubepress_action')->andReturn('action');
