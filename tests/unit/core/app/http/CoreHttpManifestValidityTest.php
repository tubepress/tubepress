...
class tubepress_test_app_http_CoreHttpManifestValidityTest extends tubepress_test_addon_AbstractManifestValidityTest
{
    public function testManifest()
    {
        ...
        $this->assertEquals('tubepress/core-http', $addon->getName());
        $this->assertEquals('1.0.0', $addon->getVersion());
        $this->assertEquals('TubePress Core HTTP Services', $addon->getTitle());
    ...
    {
        return TUBEPRESS_ROOT . '/src/core/app/http/manifest.json';
    }
}