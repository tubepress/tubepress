...
/**
 * @covers tubepress_app_options_impl_easy_EasyTrimmer<extended>
 */
class tubepress_test_app_options_impl_easy_EasyTrimmerTest extends tubepress_test_TubePressUnitTest
{
    /**
    ...
    {
        $sut = new tubepress_app_options_impl_easy_EasyTrimmer($charlist);
