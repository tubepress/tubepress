...
/**
 * @covers tubepress_app_options_impl_listeners_StringMagic
 */
class tubepress_test_app_options_impl_listeners_StringMagicTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_app_options_impl_listeners_StringMagic
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_app_options_impl_listeners_StringMagic(
    ...
    {
        $mockTopEvent = $this->mock('tubepress_lib_event_api_EventInterface');
