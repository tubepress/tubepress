...
abstract class tubepress_test_app_options_impl_internal_AbstractOptionReaderTest extends tubepress_test_TubePressUnitTest
{
    /**
    ...
    {
        $mockFirstEvent  = $this->mock('tubepress_lib_event_api_EventInterface');
        $mockSecondEvent = $this->mock('tubepress_lib_event_api_EventInterface');
        $mockThirdEvent  = $this->mock('tubepress_lib_event_api_EventInterface');
        ...
        $this->_mockEventDispatcher->shouldReceive('dispatch')->once()->with(
            tubepress_app_options_api_Constants::EVENT_NVP_READ_FROM_EXTERNAL_INPUT, $mockFirstEvent
        );
