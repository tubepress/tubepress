...
/**
 * @covers tubepress_app_options_impl_easy_EasyReference<extended>
 */
class tubepress_test_app_options_impl_easy_EasyReferenceTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_app_options_impl_easy_EasyReference
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $realLangUtils = new tubepress_platform_impl_util_LangUtils();
        ...
        $this->_sut = new tubepress_app_options_impl_easy_EasyReference(array(
