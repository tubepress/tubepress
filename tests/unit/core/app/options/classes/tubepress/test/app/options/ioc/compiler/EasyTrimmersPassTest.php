...
/**
 * @covers tubepress_app_options_ioc_compiler_EasyTrimmersPass<extended>
 */
class tubepress_test_app_options_ioc_compiler_EasyTrimmersPassTest extends tubepress_test_app_options_ioc_compiler_AbstractEasyPassTest
{
    public function testFullPass()
    {
        ...
        $mockDefinition->shouldReceive('addTag')->once()->with(tubepress_lib_ioc_api_Constants::TAG_EVENT_LISTENER, array(
            'event'    => tubepress_app_options_api_Constants::EVENT_OPTION_SET . '.' . 'foo',
            'priority' => 33,
            'method'   => 'onOption',
    ...
    {
        return new tubepress_app_options_ioc_compiler_EasyTrimmersPass();
    }

    protected function getPrefix()
    {
        return strtolower(tubepress_app_options_api_Constants::IOC_PARAM_EASY_TRIMMER);
    }
