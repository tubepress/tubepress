...
/**
 * @covers tubepress_app_options_impl_easy_EasyValidator<extended>
 */
class tubepress_test_app_options_impl_easy_EasyValidatorTest extends tubepress_test_TubePressUnitTest
{
    /**
    ...
    {
        $sut = new tubepress_app_options_impl_easy_EasyValidator($type, $this->_mockReference, $this->_mockTranslator);
