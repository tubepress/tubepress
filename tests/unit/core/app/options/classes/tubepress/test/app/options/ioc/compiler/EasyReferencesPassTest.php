...
/**
 * @covers tubepress_app_options_ioc_compiler_EasyReferencesPass<extended>
 */
class tubepress_test_app_options_ioc_compiler_EasyReferencesPassTest extends tubepress_test_app_options_ioc_compiler_AbstractEasyPassTest
{
    public function testFullProcess()
    {
        ...
        $mockDefinition->shouldReceive('addArgument')->once()->with(ehough_mockery_Mockery::on(function ($ref) {
            ...
            return $ref instanceof tubepress_platform_api_ioc_Reference && "$ref" === strtolower(tubepress_platform_api_util_LangUtilsInterface::_);
        }))->andReturn($mockDefinition);
        $mockDefinition->shouldReceive('addTag')->once()->with(tubepress_app_options_api_ReferenceInterface::_)->andReturn($mockDefinition);
        ...
        $this->getMockContainer()->shouldReceive('register')->once()->with('easy_reference_for_foo',
            'tubepress_app_options_impl_easy_EasyReference')->andReturn($mockDefinition);
    ...
    {
        return new tubepress_app_options_ioc_compiler_EasyReferencesPass();
    }

    protected function getPrefix()
    {
        return strtolower(tubepress_app_options_api_Constants::IOC_PARAM_EASY_REFERENCE);
    }
