...
/**
 * @covers tubepress_app_options_impl_listeners_Logger<extended>
 */
class tubepress_test_app_options_impl_listeners_LoggerTest extends tubepress_test_TubePressUnitTest
{
    /**
    ...
    /**
     * @var tubepress_app_options_impl_listeners_Logger
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_app_options_impl_listeners_Logger(
