...
/**
 * @covers tubepress_app_options_impl_easy_EasyAcceptableValuesListener<extended>
 */
class tubepress_test_app_options_impl_easy_EasyAcceptableValuesListenerTest extends tubepress_test_TubePressUnitTest
{
    /**
    ...
    {
        $sut = new tubepress_app_options_impl_easy_EasyAcceptableValuesListener($values);
