...
/**
 * @covers tubepress_app_options_impl_Reference<extended>
 */
class tubepress_test_app_options_impl_ReferenceTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_app_options_impl_Reference
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_app_options_impl_Reference(
    ...
    public function testBasics()
    {
        ...
        $this->_setupEventDispatcher('foo', 'foo label', tubepress_app_options_api_Constants::EVENT_OPTION_GET_LABEL);
        $this->assertEquals('foo label', $this->_sut->getUntranslatedLabel('foo'));

        $this->_setupEventDispatcher('fuzz', 'fuzz desc', tubepress_app_options_api_Constants::EVENT_OPTION_GET_DESCRIPTION);
        ...
        $this->_setupEventDispatcher('pro', 'hi', tubepress_app_options_api_Constants::EVENT_OPTION_GET_DEFAULT_VALUE);
