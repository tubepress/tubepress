...
class tubepress_test_app_media_item_MediaItemManifestValidityTest extends tubepress_test_addon_AbstractManifestValidityTest
{
    ...
    {
        return TUBEPRESS_ROOT . '/src/core/app/media-item/manifest.json';
    }
}