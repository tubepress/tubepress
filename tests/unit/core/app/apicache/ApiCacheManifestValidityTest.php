...
class tubepress_test_app_apicache_ApiCacheManifestValidityTest extends tubepress_test_addon_AbstractManifestValidityTest
{
    public function testManifest()
    {
        ...
        $this->assertEquals('tubepress/core-apicache', $addon->getName());
        $this->assertEquals('1.0.0', $addon->getVersion());
        $this->assertEquals('TubePress API Cache', $addon->getTitle());
        ...
        $this->assertEquals('TubePress API cache functionality.', $addon->getDescription());
    }

    protected function getPathToManifest()
    {
        return TUBEPRESS_ROOT . '/src/core/app/apicache/manifest.json';
    }
}