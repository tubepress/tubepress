...
/**
 * @covers tubepress_app_options_ui_impl_fields_provided_ThemeField<extended>
 */
class tubepress_test_app_options_ui_impl_fields_ThemeFieldTest extends tubepress_test_app_options_ui_impl_fields_provided_DropdownFieldTest
{
    /**
