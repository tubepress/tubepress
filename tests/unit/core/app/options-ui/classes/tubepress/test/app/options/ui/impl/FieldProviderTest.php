...
/**
 * @covers tubepress_app_options_ui_impl_FieldProvider<extended>
 */
class tubepress_test_app_options_ui_impl_FieldProviderTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_app_options_ui_impl_FieldProvider
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_app_options_ui_impl_FieldProvider(
