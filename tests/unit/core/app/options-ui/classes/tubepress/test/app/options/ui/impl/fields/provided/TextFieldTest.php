...
/**
 * @covers tubepress_app_options_ui_impl_fields_provided_TextField<extended>
 */
class tubepress_test_app_options_ui_impl_fields_provided_TextFieldTest extends tubepress_test_app_options_ui_impl_fields_provided_AbstractProvidedOptionBasedFieldTest
{
    public function testInvalidSize()
    {
        ...
        /**
         * @var $field tubepress_app_options_ui_impl_fields_provided_TextField
         */
        $field = $this->getSut();
    ...
    {
        $field = new tubepress_app_options_ui_impl_fields_provided_TextField(
    ...
    {
        return TUBEPRESS_ROOT . '/src/core/app/options-ui/resources/field-templates/text.tpl.php';
    }
