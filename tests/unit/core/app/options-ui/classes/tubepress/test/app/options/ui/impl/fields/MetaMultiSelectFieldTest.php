...
/**
 * @covers tubepress_app_options_ui_impl_fields_MetaMultiSelectField<extended>
 */
class tubepress_test_app_options_ui_impl_fields_MetaMultiSelectFieldTest extends tubepress_test_app_options_ui_impl_fields_AbstractMultiSelectFieldTest
{
    /**
    ...
    protected function onAfterTemplateBasedFieldSetup()
    {
        ...
        $this->_mockVideoProvider1  = $this->mock(tubepress_app_media_provider_api_MediaProviderInterface::_);
        $this->_mockVideoProvider2  = $this->mock(tubepress_app_media_provider_api_MediaProviderInterface::_);
    }
    ...
    {
        $sut = new tubepress_app_options_ui_impl_fields_MetaMultiSelectField(
