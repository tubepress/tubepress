...
/**
 * @covers tubepress_app_options_ui_impl_fields_provided_SpectrumColorField<extended>
 */
class tubepress_test_app_options_ui_impl_fields_SpectrumColorFieldTest extends tubepress_test_app_options_ui_impl_fields_provided_AbstractProvidedOptionBasedFieldTest
{
    protected function buildSut()
    {
        return new tubepress_app_options_ui_impl_fields_provided_SpectrumColorField(
