...
/**
 * @covers tubepress_app_media_provider_impl_Collector<extended>
 */
class tubepress_test_app_media_provider_impl_CollectorTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_app_media_provider_impl_Collector
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_app_media_provider_impl_Collector(
    ...
    {
        $this->_mockProvider = $this->mock(tubepress_app_media_provider_api_MediaProviderInterface::_);
    ...
    {
        $mockPage = new tubepress_app_media_provider_api_Page();
        ...
        $this->_mockExecutionContext->shouldReceive('get')->once()->with(tubepress_app_media_provider_api_Constants::OPTION_GALLERY_SOURCE)->andReturn('x');

        $this->_mockHttpRequestParameterService->shouldReceive('getParamValueAsInt')->once()->with(tubepress_lib_http_api_Constants::PARAM_NAME_PAGE, 1)->andReturn(97);
        ...
        $this->_mockEventDispatcher->shouldReceive('dispatch')->once()->with(tubepress_app_media_provider_api_Constants::EVENT_NEW_MEDIA_PAGE, $mockEvent);
    ...
    public function testMultipleNoProvidersCouldHandle()
    {
        ...
        $this->_mockEventDispatcher->shouldReceive('newEventInstance')->once()->with(ehough_mockery_Mockery::on(function ($arg) {
            return $arg instanceof tubepress_app_media_provider_api_Page && count($arg->getItems()) === 0;
        ...
        $this->assertTrue($result instanceof tubepress_app_media_provider_api_Page);
