...
/**
 * @covers tubepress_app_media_provider_impl_ItemSorter<extended>
 */
class tubepress_test_app_media_provider_impl_ItemSorterTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_app_media_provider_impl_ItemSorter
     */
    private $_sut;
    ...
    {
        $this->_sut = new tubepress_app_media_provider_impl_ItemSorter();
        $this->_mockFirstItem = $this->mock('tubepress_app_media_item_api_MediaItem');
        $this->_mockSecondItem = $this->mock('tubepress_app_media_item_api_MediaItem');
    }
