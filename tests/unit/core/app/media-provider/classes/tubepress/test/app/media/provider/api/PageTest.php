...
/**
 * @covers tubepress_app_media_provider_api_Page
 */
class tubepress_test_app_media_provider_api_PageTest extends tubepress_test_TubePressUnitTest
{
    /**
    ...
    {
        $this->_sut = new tubepress_app_media_provider_api_Page();
    }
