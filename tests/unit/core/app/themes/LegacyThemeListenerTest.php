...
/**
 * @covers tubepress_app_theme_impl_listeners_options_LegacyThemeListener
 */
class tubepress_test_app_impl_listeners_options_LegacyThemeListenerTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_app_theme_impl_listeners_options_LegacyThemeListener
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_app_theme_impl_listeners_options_LegacyThemeListener(
