...
/**
 * @covers tubepress_app_theme_impl_ThemeBase
 */
class tubepress_test_app_theme_impl_ThemeBaseTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_app_theme_impl_ThemeBase
     */
    private $_sut;
    ...
    {
        $this->_sut = new tubepress_app_theme_impl_ThemeBase(
            'my/theme',
            '3.2.1',
            'my theme',
    ...
    public function testBadRootPath()
    {
        ...
        new tubepress_app_theme_impl_ThemeBase(
            'my/theme',
            '3.2.1',
            'my theme',
            array('name' => 'foo', 'url' => 'http://bar.com/hello'),
