...
/**
 * @covers tubepress_app_theme_ioc_compiler_ThemesPrimerPass<extended>
 */
class tubepress_test_app_theme_ioc_compiler_ThemesPrimerPassTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_app_theme_ioc_compiler_ThemesPrimerPass
     */
    private $_sut;
    ...
    {
        $this->_sut                  = new tubepress_app_theme_ioc_compiler_ThemesPrimerPass();
    ...
    public function testProcess()
    {
        ...
        $mockThemeFinder   = $this->mock(tubepress_platform_api_contrib_RegistryInterface::_);
        ...
        $this->_mockContainerBuilder->shouldReceive('findTaggedServiceIds')->once()->with(tubepress_platform_api_contrib_RegistryInterface::_)->andReturn(array(
            'x' => array(array('type' => tubepress_app_theme_api_ThemeInterface::_))
        ));

        $mockTheme  = $this->mock(tubepress_app_theme_api_ThemeInterface::_);
