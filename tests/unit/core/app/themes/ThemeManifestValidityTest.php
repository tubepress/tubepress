...
class tubepress_test_app_theme_ThemeManifestValidityTest extends tubepress_test_addon_AbstractManifestValidityTest
{
    ...
    {
        return TUBEPRESS_ROOT . '/src/core/app/themes/manifest.json';
    }
}