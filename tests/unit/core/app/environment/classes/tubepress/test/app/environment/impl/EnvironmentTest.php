...
/**
 * @covers tubepress_app_environment_impl_Environment<extended>
 */
class tubepress_test_app_environment_impl_EnvironmentTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_app_environment_impl_Environment
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut              = new tubepress_app_environment_impl_Environment($this->_mockUrlFactory, $this->_mockBootSettings);
    }

    public function testVersion()
    {
        $latest = tubepress_lib_version_api_Version::parse('9.9.9');
        $current = $this->_sut->getVersion();
        $this->assertTrue($current instanceof tubepress_lib_version_api_Version);
     ...
     * @expectedExceptionMessage Invalid argument to tubepress_app_environment_impl_Environment::setWpFunctionsInterface
     */
    ...
    public function testDetectUserContentUrlNonWp()
    {
        ...
        $mockContentUrl = $this->mock('tubepress_lib_url_api_UrlInterface');
