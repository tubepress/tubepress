...
class tubepress_test_app_log_LogManifestValidityTest extends tubepress_test_addon_AbstractManifestValidityTest
{
    ...
    {
        return TUBEPRESS_ROOT . '/src/core/app/log/manifest.json';
    }
}