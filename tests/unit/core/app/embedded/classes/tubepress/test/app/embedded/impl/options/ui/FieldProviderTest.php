...
/**
 * @covers tubepress_app_embedded_impl_options_ui_FieldProvider<extended>
 */
class tubepress_test_app_embedded_impl_options_ui_FieldProviderTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_app_embedded_impl_options_ui_FieldProvider
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_app_embedded_impl_options_ui_FieldProvider(
