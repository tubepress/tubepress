...
/**
 * @covers tubepress_app_player_impl_listeners_template_PlayerTemplateListener
 */
class tubepress_test_app_player_listeners_template_PlayerLocationCoreVariablesTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_app_player_impl_listeners_template_PlayerTemplateListener
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_app_player_impl_listeners_template_PlayerTemplateListener($this->_mockExecutionContext,
    ...
    public function testAlterTemplate()
    {
        ...
        $this->_mockExecutionContext->shouldReceive('get')->once()->with(tubepress_app_embedded_api_Constants::OPTION_EMBEDDED_WIDTH)->andReturn(668);
        ...
        $mockTemplate->shouldReceive('setVariable')->once()->with(tubepress_app_html_api_Constants::TEMPLATE_VAR_GALLERY_ID, 'gallery-id');
        ...
        $mockTemplate->shouldReceive('setVariable')->once()->with(tubepress_app_embedded_api_Constants::TEMPLATE_VAR_WIDTH, 668);
