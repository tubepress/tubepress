...
class tubepress_test_app_ioc_VendorManifestValidityTest extends tubepress_test_addon_AbstractManifestValidityTest
{
    public function testManifest()
    {
        ...
        $this->assertEquals('tubepress/core-vendor', $addon->getName());
        $this->assertEquals('1.0.0', $addon->getVersion());
        $this->assertEquals('TubePress Vendor Services', $addon->getTitle());
        ...
        $this->assertEquals('TubePress vendor services.', $addon->getDescription());
    }

    protected function getPathToManifest()
    {
        return TUBEPRESS_ROOT . '/src/core/app/vendor/manifest.json';
    }
}