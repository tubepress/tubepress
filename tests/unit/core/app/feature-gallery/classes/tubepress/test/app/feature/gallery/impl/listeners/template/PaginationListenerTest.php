...
/**
 * @covers tubepress_app_feature_gallery_impl_listeners_template_PaginationTemplateListener
 */
class tubepress_test_app_feature_gallery_impl_listeners_template_PaginationListenerTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_app_feature_gallery_impl_listeners_template_PaginationTemplateListener
     */
    private $_sut;

    /**
     * @var tubepress_app_media_provider_api_Page
     */
    ...
    public function onSetup()
    {
        ...
        $this->_mockCurrentUrlService           = $this->mock(tubepress_lib_url_api_UrlFactoryInterface::_);
        $messageService                         = $this->mock(tubepress_lib_translation_api_TranslatorInterface::_);
        ...
        $this->_mockUrlUtils                    = $this->mock('tubepress_lib_util_api_UrlUtilsInterface');
        $this->_mockThemeLibrary                = $this->mock(tubepress_app_theme_api_ThemeLibraryInterface::_);

        $this->_mockExecutionContext->shouldReceive('get')->once()->with(tubepress_app_feature_gallery_api_Constants::OPTION_PAGINATE_ABOVE)->andReturn(true);
        $this->_mockExecutionContext->shouldReceive('get')->once()->with(tubepress_app_feature_gallery_api_Constants::OPTION_PAGINATE_BELOW)->andReturn(true);
        $this->_mockExecutionContext->shouldReceive('get')->once()->with(tubepress_app_media_provider_api_Constants::OPTION_RESULTS_PER_PAGE)->andReturn(4);

        $this->_providerResult = new tubepress_app_media_provider_api_Page();
        $this->_providerResult->setTotalResultCount(500);

        $this->_mockTemplate = $this->mock('tubepress_lib_template_api_TemplateInterface');

        $this->_mockFullUrl = $this->mock('tubepress_lib_url_api_UrlInterface');
        $this->_mockFullQuery = $this->mock('tubepress_lib_url_api_QueryInterface');
        ...
        $this->_mockTemplate->shouldReceive('setVariables')->once()->with(array(
            ...
            'x' => 'z',
            tubepress_app_feature_gallery_api_Constants::TEMPLATE_VAR_PAGINATION_BOTTOM => 'pagination-html',
            tubepress_app_feature_gallery_api_Constants::TEMPLATE_VAR_PAGINATION_TOP    => 'pagination-html'
        ));

        $this->_sut = new tubepress_app_feature_gallery_impl_listeners_template_PaginationTemplateListener(
    ...
    public function testModern()
    {
        ...
        $this->_mockTemplateFactory->shouldReceive('fromFilesystem')->once()->with(array('pagination.tpl.php', TUBEPRESS_ROOT . '/web/themes/default/pagination.tpl.php'))->andReturn($mockTemplate);
        $expectedTemplateVars = array(

            tubepress_app_feature_gallery_api_Constants::TEMPLATE_VAR_PAGINATION_CURRENT_PAGE     => 25,
            tubepress_app_feature_gallery_api_Constants::TEMPLATE_VAR_PAGINATION_TOTAL_ITEMS      => 500,
            tubepress_app_feature_gallery_api_Constants::TEMPLATE_VAR_PAGINATION_HREF_FORMAT      => 'foobar',
            tubepress_app_feature_gallery_api_Constants::TEMPLATE_VAR_PAGINATION_RESULTS_PER_PAGE => 4,
            tubepress_app_feature_gallery_api_Constants::TEMPLATE_VAR_PAGINATION_TEXT_NEXT        => '##next##',
            tubepress_app_feature_gallery_api_Constants::TEMPLATE_VAR_PAGINATION_TEXT_PREV        => '##prev##',
        );
        ...
        $this->_mockEventDispatcher->shouldReceive('dispatch')->once()->with(tubepress_app_feature_gallery_api_Constants::EVENT_TEMPLATE_PAGINATION, $mockTemplateEvent);
        ...
        $this->_mockEventDispatcher->shouldReceive('dispatch')->once()->with(tubepress_app_feature_gallery_api_Constants::EVENT_HTML_PAGINATION, $mockHtmlEvent);

        $this->_mockHttpRequestParameterService->shouldReceive('getParamValueAsInt')->once()->with(tubepress_lib_http_api_Constants::PARAM_NAME_PAGE, 1)->andReturn(25);
    ...
    public function testLegacyHighPage()
    {
        ...
        $expectedHtml = file_get_contents(TUBEPRESS_ROOT . '/tests/unit/core/app/feature-gallery/fixtures/pagination/pagination/legacy-high.html');
    ...
    {
        $this->_mockThemeLibrary->shouldReceive('getAbsolutePathToTemplate')->once()->with('pagination.tpl.php')->andReturnNull();
        $expectedHtml = file_get_contents(TUBEPRESS_ROOT . '/tests/unit/core/app/feature-gallery/fixtures/pagination/pagination/legacy-middle.html');
        ...
        $this->_mockHttpRequestParameterService->shouldReceive('getParamValueAsInt')->once()->with(tubepress_lib_http_api_Constants::PARAM_NAME_PAGE, 1)->andReturn(12);
    ...
    {
        $this->_mockThemeLibrary->shouldReceive('getAbsolutePathToTemplate')->once()->with('pagination.tpl.php')->andReturnNull();
        $expectedHtml = file_get_contents(TUBEPRESS_ROOT . '/tests/unit/core/app/feature-gallery/fixtures/pagination/pagination/legacy-low.html');
