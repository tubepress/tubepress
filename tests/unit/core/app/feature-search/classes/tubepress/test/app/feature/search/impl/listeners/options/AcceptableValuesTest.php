...
/**
 * @covers tubepress_app_feature_search_impl_listeners_options_AcceptableValues
 */
class tubepress_test_app_feature_search_impl_listeners_options_AcceptableValuesTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_app_feature_search_impl_listeners_options_AcceptableValues
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_app_feature_search_impl_listeners_options_AcceptableValues();
