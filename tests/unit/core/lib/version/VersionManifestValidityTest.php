...
class tubepress_test_lib_version_VersionManifestValidityTest extends tubepress_test_addon_AbstractManifestValidityTest
{
    public function testManifest()
    {
        ...
        $this->assertEquals('tubepress/core-base-version', $addon->getName());
    ...
    {
        return TUBEPRESS_ROOT . '/src/core/lib/version/manifest.json';
    }
}