...
/**
 * @covers tubepress_lib_streams_impl_puzzle_FlexibleStream<extended>
 */
class tubepress_test_lib_streams_impl_puzzle_FlexibleStreamTest extends tubepress_test_TubePressUnitTest
{
    ...
    /**
     * @var tubepress_lib_streams_impl_puzzle_FlexibleStream
     */
    private $_sut;

    public function onSetup()
    {
        $this->_mock = $this->mock('tubepress_lib_streams_api_StreamInterface');
        $this->_sut  = new tubepress_lib_streams_impl_puzzle_FlexibleStream($this->_mock);
    }

    /**
     * @expectedException InvalidArgumentException
     * @expectedExceptionMessage tubepress_lib_streams_impl_puzzle_FlexibleStream must be constructed with instance of either puzzle_stream_StreamInterface or tubepress_lib_streams_api_StreamInterface
     *
     */
    public function testNonStreamArg()
    {
        new tubepress_lib_streams_impl_puzzle_FlexibleStream(array('foo'));
    }
