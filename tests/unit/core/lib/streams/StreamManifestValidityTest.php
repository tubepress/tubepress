...
class tubepress_test_lib_streams_StreamsManifestValidityTest extends tubepress_test_addon_AbstractManifestValidityTest
{
    public function testManifest()
    {
        ...
        $this->assertEquals('tubepress/core-base-streams', $addon->getName());
        $this->assertEquals('1.0.0', $addon->getVersion());
        $this->assertEquals('TubePress Streams Implementation', $addon->getTitle());
    ...
    {
        return TUBEPRESS_ROOT . '/src/core/lib/streams/manifest.json';
    }
}