...
class tubepress_test_lib_util_UtilManifestValidityTest extends tubepress_test_addon_AbstractManifestValidityTest
{
    public function testManifest()
    {
        ...
        $this->assertEquals('tubepress/core-base-util', $addon->getName());
    ...
    {
        return TUBEPRESS_ROOT . '/src/core/lib/util/manifest.json';
    }
}