...
class tubepress_test_lib_ioc_IocManifestValidityTest extends tubepress_test_addon_AbstractManifestValidityTest
{
    public function testManifest()
    {
        ...
        $this->assertEquals('tubepress/core-base-ioc', $addon->getName());
    ...
    {
        return TUBEPRESS_ROOT . '/src/core/lib/ioc/manifest.json';
    }
}