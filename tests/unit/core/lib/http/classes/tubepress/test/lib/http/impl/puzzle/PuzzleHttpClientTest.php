...
class tubepress_test_lib_http_impl_puzzle_http_PuzzleHttpClientTest extends tubepress_test_TubePressUnitTest
{
    ...
    public function onSetup()
    {
        ...
        $mockEmitter->shouldReceive('attach')->once()->with(ehough_mockery_Mockery::type('tubepress_lib_http_impl_puzzle_PuzzleHttpClient'));

        $mockEnvironment = $this->mock(tubepress_app_environment_api_EnvironmentInterface::_);
        $mockEnvironment->shouldReceive('getVersion')->once()->andReturn('1.0.0');

        $this->_sut = new tubepress_lib_http_impl_puzzle_PuzzleHttpClient(
    ...
    {
        $mockBody = $this->mock('tubepress_lib_streams_api_StreamInterface');
        ...
        try {
            ...
            $this->assertTrue($e->getRequest() instanceof tubepress_lib_http_api_message_RequestInterface);
            $this->assertTrue($e->getResponse() instanceof tubepress_lib_http_api_message_ResponseInterface);
            return;
        }
    ...
    public function tesjtSendNormal()
    {
        ...
        $this->assertInstanceOf('tubepress_lib_http_api_message_ResponseInterface', $response);
    ...
    public function tjestCreateRequest()
    {
        ...
        $this->assertInstanceOf('tubepress_lib_http_api_message_RequestInterface', $request);
