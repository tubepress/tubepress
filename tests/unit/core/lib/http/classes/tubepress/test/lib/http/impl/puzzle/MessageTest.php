 ...
 */ 
class tubepress_test_lib_http_impl_puzzle_message_MessageTest extends tubepress_test_TubePressUnitTest
{
    ...
    public function testHasBody()
    {
        ...
        $s = new tubepress_lib_streams_impl_puzzle_FlexibleStream(puzzle_stream_Stream::factory('test'));
        $m->setBody($s);
    ...
    {
        $m = new tubepress_test_lib_http_impl_puzzle_message_MessageTest__foo(new tubepress_test_lib_http_impl_puzzle_message_MessageTest__bar());
        $m->setBody(new tubepress_lib_streams_impl_puzzle_FlexibleStream(puzzle_stream_Stream::factory('foo')));
    ...
    public function testCastsToString()
    {
        $m = new tubepress_test_lib_http_impl_puzzle_message_MessageTest__foo(new tubepress_test_lib_http_impl_puzzle_message_MessageTest__bar());
        $m->setHeader('foo', 'bar');
        $m->setBody(new tubepress_lib_streams_impl_puzzle_FlexibleStream(puzzle_stream_Stream::factory('baz')));
...
class tubepress_test_lib_http_impl_puzzle_message_MessageTest__foo extends tubepress_lib_http_impl_puzzle_AbstractMessage
{
