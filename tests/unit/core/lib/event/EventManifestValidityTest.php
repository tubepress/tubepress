...
class tubepress_test_lib_event_EventManifestValidityTest extends tubepress_test_addon_AbstractManifestValidityTest
{
    public function testManifest()
    {
        ...
        $this->assertEquals('tubepress/core-base-event', $addon->getName());
    ...
    {
        return TUBEPRESS_ROOT . '/src/core/lib/event/manifest.json';
    }
}