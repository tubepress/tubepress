...
/**
 * @covers tubepress_lib_event_impl_tickertape_TickertapeEventWrapper
 */
class tubepress_test_lib_event_impl_tickertape_TickertapeEventWrapperTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_lib_event_impl_tickertape_TickertapeEventWrapper
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_lib_event_impl_tickertape_TickertapeEventWrapper($this->_mockEvent);
    }
    ...
    {
        $this->_sut = new tubepress_lib_event_impl_tickertape_TickertapeEventWrapper();
