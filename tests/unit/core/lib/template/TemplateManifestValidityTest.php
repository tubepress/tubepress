...
class tubepress_test_lib_template_TemplateManifestValidityTest extends tubepress_test_addon_AbstractManifestValidityTest
{
    public function testManifest()
    {
        ...
        $this->assertEquals('tubepress/core-base-template', $addon->getName());
    ...
    {
        return TUBEPRESS_ROOT . '/src/core/lib/template/manifest.json';
    }
}