...
/**
 * @covers tubepress_lib_template_impl_contemplate_Template
 */
class tubepress_test_lib_template_impl_contemplate_TemplateTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_lib_template_impl_contemplate_Template
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_mockLangUtils = $this->mock('tubepress_platform_api_util_LangUtilsInterface');

        $this->_sut = new tubepress_lib_template_impl_contemplate_Template(
            $this->_mockDelegate,
            $this->_mockLangUtils
        );
    }
     ...
     * @expectedExceptionMessage tubepress_lib_template_api_TemplateInterface::setContext() requires an associative array.
     */
