...
abstract class tubepress_test_internal_boot_helper_uncached_contrib_AbstractFactoryTest extends tubepress_api_test_TubePressUnitTest
{
    /**
     ...
     */
    protected abstract function buildSut(tubepress_api_log_LoggerInterface       $logger,
    ...
    public function testBasics()
    {
        ...
        $this->assertInstanceOf('tubepress_api_version_Version', $valid->getVersion());
        ...
        $this->assertInstanceOf('tubepress_api_collection_MapInterface', $firstAuthor);
        $this->assertTrue($firstAuthor->count() === 2);
        $this->assertEquals('author name', $firstAuthor->get('name'));
        $this->assertInstanceOf('tubepress_api_url_UrlInterface', $firstAuthor->get('url'));
        $this->assertEquals('http://author.com/foo', (string) $firstAuthor->get('url'));
        $secondAuthor = $authors[1];
        $this->assertInstanceOf('tubepress_api_collection_MapInterface', $secondAuthor);
        ...
        $url = $urls[0];
        $this->assertInstanceOf('tubepress_api_url_UrlInterface', $url);
