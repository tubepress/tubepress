 ...
 */
class tubepress_test_internal_boot_helper_uncached_contrib_AddonFactoryTest extends tubepress_test_internal_boot_helper_uncached_contrib_AbstractFactoryTest
{
     ...
     */
    protected function buildSut(tubepress_api_log_LoggerInterface $logger,
                                tubepress_api_url_UrlFactoryInterface $urlFactory,
                                tubepress_api_util_LangUtilsInterface $langUtils,
                                tubepress_api_util_StringUtilsInterface $stringUtils)
    {
        $this->_mockBootSettingsInterface = $this->mock(tubepress_api_boot_BootSettingsInterface::_);
