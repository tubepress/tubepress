...
/**
 * @covers tubepress_platform_impl_contrib_ContributableBase<extended>
 */
class tubepress_test_impl_contrib_ContributableBaseTest extends tubepress_test_TubePressUnitTest
{
    ...
    {
        $sut = new tubepress_platform_impl_contrib_ContributableBase(
    ...
    public function testInvalidNameBadChars()
    {
        ...
        new tubepress_platform_impl_contrib_ContributableBase(
    ...
    {
        $contrib = new tubepress_platform_impl_contrib_ContributableBase(
    ...
    {
        return new tubepress_platform_impl_contrib_ContributableBase(
