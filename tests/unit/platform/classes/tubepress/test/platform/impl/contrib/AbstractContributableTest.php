...
abstract class tubepress_test_platform_impl_contrib_AbstractContributableTest extends tubepress_test_TubePressUnitTest
{
    ...
    public function testBasics()
    {
        ...
        $author1 = $authors[0];
        $this->assertInstanceOf('tubepress_platform_api_collection_MapInterface', $author1);
        ...
        $author2 = $authors[1];
        $this->assertInstanceOf('tubepress_platform_api_collection_MapInterface', $author2);
