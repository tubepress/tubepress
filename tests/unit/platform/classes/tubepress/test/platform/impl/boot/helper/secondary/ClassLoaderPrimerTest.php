...
/**
 * @covers tubepress_platform_impl_boot_helper_secondary_ClassLoaderPrimer<extended>
 */
class tubepress_test_impl_boot_helper_secondary_ClassLoaderPrimerTest extends tubepress_test_TubePressUnitTest
{
    ...
    public function onSetup()
    {
        ...
        $this->_sut                    = new tubepress_platform_impl_boot_helper_secondary_ClassLoaderPrimer($this->_mockLogger);
