...
class tubepress_test_platform_impl_boot_helper_uncached_CompilerTest extends tubepress_test_TubePressUnitTest
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        require_once TUBEPRESS_ROOT . '/tests/unit/platform/fixtures/mock-classes/FakeCompilerPass.php';
        require_once TUBEPRESS_ROOT . '/tests/unit/platform/fixtures/mock-classes/FakeExtension.php';
    }
