...
/**
 * @covers tubepress_platform_impl_boot_helper_secondary_IocCompiler<extended>
 */
class tubepress_test_impl_boot_helper_secondary_IocCompilerTest extends tubepress_test_TubePressUnitTest
{
    /**
    ...
    public function onSetup()
    {
        ...
        $this->_sut              = new tubepress_platform_impl_boot_helper_secondary_IocCompiler($this->_mockLogger);
    }
    ...
    public static function setUpBeforeClass()
    {
        ...
        require_once TUBEPRESS_ROOT . '/tests/unit/platform/fixtures/classes/tubepress/test/impl/ioc/FakeCompilerPass.php';
        require_once TUBEPRESS_ROOT . '/tests/unit/platform/fixtures/classes/tubepress/test/impl/ioc/FakeExtension.php';
    }
    ...
    public function testCompile()
    {
        ...
        $mockAddon1 = $this->mock(tubepress_platform_api_addon_AddonInterface::_);
        $mockAddon2 = $this->mock(tubepress_platform_api_addon_AddonInterface::_);
