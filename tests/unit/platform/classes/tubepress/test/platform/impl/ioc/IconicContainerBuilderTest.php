...
class tubepress_test_impl_ioc_ContainerBuilderTest extends tubepress_test_TubePressUnitTest
{
    ...
    public function testSetDefinition()
    {
        ...
        $this->assertInstanceOf('tubepress_platform_api_ioc_DefinitionInterface', $result);
    }
    ...
    public function testMerge()
    {
        ...
        $mockContainer = $this->mock('tubepress_platform_api_ioc_ContainerBuilderInterface');
