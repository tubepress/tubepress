...
class tubepress_test_platform_scripts_BootTest extends tubepress_test_TubePressUnitTest
{
    ...
    {
        define('TUBEPRESS_CONTENT_DIRECTORY', TUBEPRESS_ROOT . '/tests/unit/platform/fixtures/scripts/boot');
    }
    ...
    private function _testBasics($result)
    {
        ...
        $this->assertTrue($container->has(tubepress_platform_api_log_LoggerInterface::_));
        ...
        $context = $container->get(tubepress_app_options_api_ContextInterface::_);
    }
