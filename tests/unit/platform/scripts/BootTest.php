 ...
 */
class tubepress_test_platform_scripts_BootTest extends tubepress_test_TubePressUnitTest
{
    public function onSetup()
    {
        define('TUBEPRESS_CONTENT_DIRECTORY', TUBEPRESS_ROOT . '/tests/unit/platform/fixtures/mock-user-content-dir');
    }
    ...
    {
        $this->assertInstanceOf('tubepress_platform_api_ioc_ContainerInterface', $result);

        /**
         * @var $container tubepress_platform_api_ioc_ContainerInterface
         */
        $container = $result;

        $this->assertTrue($container->has(tubepress_platform_api_log_LoggerInterface::_), 'Container does not contain a logger');

        $logger = $container->get(tubepress_platform_api_log_LoggerInterface::_);
    ...
    {
        if (file_exists(sys_get_temp_dir() . '/service-container/tubepress-service-container.php')) {

            $result = unlink(sys_get_temp_dir() . '/service-container/tubepress-service-container.php');
