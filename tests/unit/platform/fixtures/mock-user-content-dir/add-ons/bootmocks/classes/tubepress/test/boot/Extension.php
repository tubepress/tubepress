...
class tubepress_test_boot_Extension implements tubepress_platform_api_ioc_ContainerExtensionInterface
{
    ...
    public function load(tubepress_platform_api_ioc_ContainerBuilderInterface $containerBuilder)
    {
        $containerBuilder->register(
            ...
            'tubepress_test_boot_MockPersistence'
        );

        $containerBuilder->register(

            tubepress_lib_api_translation_TranslatorInterface::_,
            'tubepress_test_boot_MockTranslator'
        );
    }
}