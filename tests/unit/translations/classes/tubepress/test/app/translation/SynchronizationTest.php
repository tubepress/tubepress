...
class tubepress_test_app_translation_SynchronizationTest extends tubepress_test_TubePressUnitTest
{
    ...
    /**
     * @var tubepress_test_app_translation_support_AbstractTranslation
     */
    ...
    public function onSetup()
    {
        ...
        self::$_greppedCode = new tubepress_test_app_translation_support_GreppedCode();

        foreach (self::$_LOCALE_MAP as $glotPressLocale => $tubePressLocale) {

            $translation = new tubepress_test_app_translation_support_GlotPressTranslation($glotPressLocale);
            ...
            self::$_localPoFiles[] = new tubepress_test_app_translation_support_PoFileTranslation($poFile, $tubePressLocale);
        }
    }
    ...
    {
        $i18nRoot = TUBEPRESS_ROOT . '/src/translations/';
        $toReturn = array();
    ...
    private function _doMsgIdDiff(tubepress_test_app_translation_support_AbstractTranslation $collection1, tubepress_test_app_translation_support_AbstractTranslation $collection2)
    {
