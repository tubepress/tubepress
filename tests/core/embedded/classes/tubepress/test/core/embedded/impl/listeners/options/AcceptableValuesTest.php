...
/**
 * @covers tubepress_core_embedded_impl_listeners_options_AcceptableValues
 */
class tubepress_test_core_embedded_impl_listeners_options_AcceptableValuesTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_embedded_impl_listeners_options_AcceptableValues
     */
    private $_sut;
