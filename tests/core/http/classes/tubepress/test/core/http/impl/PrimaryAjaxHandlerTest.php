...
/**
 * @covers tubepress_core_http_impl_PrimaryAjaxHandler
 */
class tubepress_test_core_http_impl_PrimaryAjaxHandlerTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_http_impl_PrimaryAjaxHandler
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_mockHttpResponseCodeService     = $this->mock(tubepress_core_http_api_ResponseCodeInterface::_);
        $this->_mockLogger                      = $this->mock(tubepress_api_log_LoggerInterface::_);

        $this->_mockLogger->shouldReceive('isEnabled')->once()->andReturn(true);
        $this->_mockLogger->shouldReceive('debug')->atLeast(1)->andReturn(true);

        $this->_sut = new tubepress_core_http_impl_PrimaryAjaxHandler(
    ...
    {
        $mockHandler = $this->mock(tubepress_core_http_api_AjaxCommandInterface::_);
