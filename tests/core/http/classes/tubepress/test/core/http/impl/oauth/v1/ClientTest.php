...
/**
 * @covers tubepress_core_http_impl_oauth_v1_Client
 */
class tubepress_test_core_http_impl_oauth_v1_ClientTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_http_impl_oauth_v1_Client
     */
    private $_sut;

    public function onSetup()
    {
        $this->_sut = new tubepress_core_http_impl_oauth_v1_Client();
    }
    ...
    {
        return new tubepress_core_http_api_oauth_v1_Credentials('id', 'secret');
    }

    private function _createMockRequest($method, $url)
    {
        $urlFactory = new tubepress_core_url_impl_puzzle_UrlFactory();
