...
/**
 * @covers tubepress_core_http_impl_RequestParameters<extended>
 */
class tubepress_test_core_http_impl_RequestParametersTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_http_impl_RequestParameters
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_core_http_impl_RequestParameters($this->_mockEventDispatcher);
    }
    ...
    public function testGetParam()
    {
        ...
        $mockExternalEvent = $this->mock('tubepress_core_event_api_EventInterface');
        ...
        $this->_mockEventDispatcher->shouldReceive('dispatch')->once()->with(tubepress_core_options_api_Constants::EVENT_NVP_READ_FROM_EXTERNAL_INPUT, $mockExternalEvent);
        ...
        $this->_mockEventDispatcher->shouldReceive('dispatch')->once()->with(tubepress_core_options_api_Constants::EVENT_NVP_READ_FROM_EXTERNAL_INPUT . '.something', $mockSingleEvent);
