...
/**
 * @covers tubepress_core_url_impl_puzzle_UrlFactory<extended>
 */
class tubepress_test_core_url_impl_puzzle_UrlFactoryTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_url_impl_puzzle_UrlFactory
     */
    private $_sut;

    public function onSetup()
    {
        $this->_sut = new tubepress_core_url_impl_puzzle_UrlFactory(array());
    }

    public function testValid()
    {
        $u = $this->_sut->fromString('https://foo.bar/one/two.php?test=true#frag');
        $this->assertInstanceOf('tubepress_core_url_api_UrlInterface', $u);
        $this->assertEquals('https://foo.bar/one/two.php?test=true#frag', "$u");
    }

    /**
     * @expectedException InvalidArgumentException
     * @expectedExceptionMessage tubepress_core_url_impl_puzzle_UrlFactory::fromString() can only accept strings.
     */
    ...
    public function testCannotGetUrlBadServerVars()
    {
        ...
        $sut = new tubepress_core_url_impl_puzzle_UrlFactory($serverArray);
    ...
    {
        $sut = new tubepress_core_url_impl_puzzle_UrlFactory(array());
        $sut->fromCurrent();
    }
