...
class tubepress_test_wordpress_impl_WidgetTest extends tubepress_test_TubePressUnitTest
{
    ...
    public function testPrintWidgetControl()
    {
        ...
        $this->_mockTemplateBuilder->shouldReceive('fromFilesystem')->once()->with(array(TUBEPRESS_ROOT . '/src/core/wordpress/resources/templates/widget_controls.tpl.php'))->andReturn($mockTemplate);
