...
class tubepress_test_wordpress_resources_templates_OptionsPageTemplateTest extends tubepress_test_TubePressUnitTest
{
    ...
    private function _runTemplateTest($variables, $fileName)
    {
        ...
        ob_start();
        include TUBEPRESS_ROOT  .'/src/core/wordpress/resources/templates/options_page.tpl.php';
    ...
    {
        return file_get_contents(TUBEPRESS_ROOT . '/tests/core/wordpress/resources/templates/templates/' . $fileName);
    }
