...
class tubepress_test_vimeo_impl_listeners_video_VimeoVideoConstructionListenerTest extends tubepress_test_TubePressUnitTest
{
    ...
    {
        $serial_str = file_get_contents(TUBEPRESS_ROOT . '/tests/core/vimeo/resources/vimeo/vimeo-single-video.txt');
    ...
    {
        $serial_str = file_get_contents(TUBEPRESS_ROOT . '/tests/core/vimeo/resources/vimeo/vimeo-gallery.txt');
