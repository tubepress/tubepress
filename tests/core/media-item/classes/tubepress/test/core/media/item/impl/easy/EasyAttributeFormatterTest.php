...
/**
 * @covers tubepress_core_media_item_impl_easy_EasyAttributeFormatter<extended>
 */
class tubepress_test_core_media_item_impl_easy_EasyAttributeFormatterTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_media_item_impl_easy_EasyAttributeFormatter
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_mockMediaItem     = $this->mock('tubepress_core_media_item_api_MediaItem');

        $this->_sut = new tubepress_core_media_item_impl_easy_EasyAttributeFormatter(
            $this->_mockTimeUtils,
            $this->_mockContext
        );
    }
    ...
    public function testTruncate()
    {
        ...
        $this->_sut->truncateString('source', 'dest', tubepress_core_media_item_api_Constants::OPTION_DESC_LIMIT);
        $this->_mockContext->shouldReceive('get')->once()->with(tubepress_core_media_item_api_Constants::OPTION_DESC_LIMIT)->andReturn(2);
    ...
    {
        $this->_mockContext->shouldReceive('get')->once()->with(tubepress_core_media_item_api_Constants::OPTION_DATEFORMAT)->andReturn('date format');
        $this->_mockContext->shouldReceive('get')->once()->with(tubepress_core_media_item_api_Constants::OPTION_RELATIVE_DATES)->andReturn(true);
    ...
    private function _setupForRun($expectedProviderName, $actualProviderName)
    {
        ...
        $this->_mockMediaItem->shouldReceive('getAttribute')->once()->with(tubepress_core_media_item_api_Constants::ATTRIBUTE_PROVIDER)
