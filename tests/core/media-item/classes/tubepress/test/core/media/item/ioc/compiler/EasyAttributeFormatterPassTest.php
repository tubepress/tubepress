...
/**
 * @covers tubepress_core_media_item_ioc_compiler_EasyAttributeFormattersPass
 */
class tubepress_test_core_media_item_ioc_compiler_EasyAttributeFormatterPassTest extends tubepress_test_core_options_ioc_compiler_AbstractEasyPassTest
{
    ...
    public function testFullProcess()
    {
        ...
        $this->_expectRefArg($mockDefinition, tubepress_core_util_api_TimeUtilsInterface::_);
        $this->_expectRefArg($mockDefinition, tubepress_core_options_api_ContextInterface::_);
        ...
        $this->getMockContainer()->shouldReceive('register')->once()->with('easy_attributes_formatter_for_foo',
            'tubepress_core_media_item_impl_easy_EasyAttributeFormatter')->andReturn($mockDefinition);
    ...
    {
        return new tubepress_core_media_item_ioc_compiler_EasyAttributeFormattersPass();
    }
