...
/**
 * @covers tubepress_core_template_impl_contemplate_Template
 */
class tubepress_test_core_template_impl_contemplate_TemplateTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_template_impl_contemplate_Template
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_core_template_impl_contemplate_Template(
            $this->_mockDelegate,
            $this->_mockLangUtils
        );
    }
     ...
     * @expectedExceptionMessage tubepress_core_template_api_TemplateInterface::setContext() requires an associative array.
     */
