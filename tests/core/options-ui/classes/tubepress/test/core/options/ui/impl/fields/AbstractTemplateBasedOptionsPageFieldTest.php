...
/**
 * @covers tubepress_core_options_ui_impl_fields_AbstractTemplateBasedOptionsPageField
 */
abstract class tubepress_test_core_options_ui_impl_fields_AbstractTemplateBasedOptionsPageFieldTest extends tubepress_test_core_options_ui_impl_fields_AbstractOptionsPageFieldTest
{
    /**
    ...
    protected function onAfterOptionsPageFieldSetup()
    {
        ...
        $this->_mockTemplateFactory = $this->mock('tubepress_core_template_api_TemplateFactoryInterface');
    ...
    public function testGetWidgetHtmlWithTemplate()
    {
        ...
        $this->_mockEventDispatcher->shouldReceive('dispatch')->once()
            ->with(tubepress_core_options_ui_api_Constants::EVENT_OPTIONS_UI_FIELD_TEMPLATE, $mockTemplateEvent);
    ...
    /**
     * @return tubepress_core_options_ui_impl_fields_AbstractTemplateBasedOptionsPageField
     */
