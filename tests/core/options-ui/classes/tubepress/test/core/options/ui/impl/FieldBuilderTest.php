...
/**
 * @covers tubepress_core_options_ui_impl_FieldBuilder<extended>
 */
class tubepress_test_core_options_ui_impl_FieldBuilderTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_options_ui_impl_FieldBuilder
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_mockPersistence = $this->mock(tubepress_core_options_api_PersistenceInterface::_);
        $this->_mockRequestParams = $this->mock(tubepress_core_http_api_RequestParametersInterface::_);
        ...
        $this->_sut = new tubepress_core_options_ui_impl_FieldBuilder(
    ...
    {
        $field = $this->_sut->newInstance('t', 'gallerySourceRadio', array('additionalField' => $this->mock('tubepress_core_options_ui_api_FieldInterface')));

        $this->assertInstanceOf('tubepress_core_options_ui_impl_fields_GallerySourceRadioField', $field);
    }
    ...
    public function testTheme()
    {
        ...
        $this->assertInstanceOf('tubepress_core_options_ui_impl_fields_provided_ThemeField', $field);
    }
    ...
    public function getDataSimpleTypes()
    {
        return array(
            ...
            array('bool',     'tubepress_core_options_ui_impl_fields_provided_BooleanField'),
            array('boolean',  'tubepress_core_options_ui_impl_fields_provided_BooleanField'),
            array('dropdown', 'tubepress_core_options_ui_impl_fields_provided_DropdownField'),
            array('hidden',   'tubepress_core_options_ui_impl_fields_provided_HiddenField'),
        );
    }
    ...
    public function testSpectrum($options)
    {
        ...
        $this->assertInstanceOf('tubepress_core_options_ui_impl_fields_provided_SpectrumColorField', $field);
    }
    ...
    public function testTextField()
    {
        ...
        $this->assertInstanceOf('tubepress_core_options_ui_impl_fields_provided_TextField', $field);
    }
