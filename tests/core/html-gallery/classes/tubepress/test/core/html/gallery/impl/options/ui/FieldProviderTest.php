...
/**
 * @covers tubepress_core_html_gallery_impl_options_ui_FieldProvider<extended>
 */
class tubepress_test_core_html_gallery_impl_options_ui_FieldProviderTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_html_gallery_impl_options_ui_FieldProvider
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_core_html_gallery_impl_options_ui_FieldProvider(
    ...
    public function testBasics()
    {
        ...
        $this->assertEquals('thumbnails-category', $id);
