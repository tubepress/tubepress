...
/**
 * @covers tubepress_core_html_gallery_impl_listeners_html_GalleryMaker
 */
class tubepress_test_core_html_gallery_impl_listeners_html_ThumbGalleryCommandTest extends tubepress_test_TubePressUnitTest
{
    /**
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_core_html_gallery_impl_listeners_html_GalleryMaker(
