...
/**
 * @covers tubepress_core_html_gallery_impl_listeners_html_GalleryInitJsBaseParams
 */
class tubepress_test_core_html_gallery_impl_listeners_html_GalleryInitJsBaseParamsTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_html_gallery_impl_listeners_html_GalleryInitJsBaseParams
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_core_html_gallery_impl_listeners_html_GalleryInitJsBaseParams(
