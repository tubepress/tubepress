...
class tubepress_test_core_media_search_ioc_SearchExtensionTest extends tubepress_test_core_ioc_AbstractIocContainerExtensionTest
{
    ...
    {
        return new tubepress_core_html_search_ioc_SearchExtension();
    }
    ...
    protected function getExpectedExternalServicesMap()
    {
        return array(
            ...
            'tubepress_core_html_gallery_impl_listeners_html_GalleryMaker' => 'tubepress_core_html_gallery_impl_listeners_html_GalleryMaker'
        );
    }
}