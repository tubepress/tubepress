...
/**
 * @covers tubepress_core_html_search_impl_listeners_template_SearchInputCoreVariables
 */
class tubepress_test_core_html_search_impl_listeners_template_SearchInputCoreVariablesTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_html_search_impl_listeners_template_SearchInputCoreVariables
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_core_html_search_impl_listeners_template_SearchInputCoreVariables(
    ...
    {
        $this->_mockExecutionContext->shouldReceive('get')->once()->with(tubepress_core_html_search_api_Constants::OPTION_SEARCH_RESULTS_URL)->andReturn('');
