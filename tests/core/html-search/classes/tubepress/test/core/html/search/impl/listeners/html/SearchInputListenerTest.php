...
/**
 * @covers tubepress_core_html_search_impl_listeners_html_SearchInputListener
 */
class tubepress_test_core_html_search_impl_listeners_html_SearchInputCommandTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_html_search_impl_listeners_html_SearchInputListener
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_core_html_search_impl_listeners_html_SearchInputListener(
    ...
    public function testExecute()
    {
        ...
        $this->_mockTemplateFactory->shouldReceive('fromFilesystem')->once()->with(array('search/search_input.tpl.php', TUBEPRESS_ROOT . '/core/themes/web/default/search/search_input.tpl.php'))->andReturn($mockTemplate);
        ...
        $this->_mockEventDispatcher->shouldReceive('dispatch')->once()->with(tubepress_core_html_search_api_Constants::EVENT_TEMPLATE_SEARCH_INPUT, $mockTemplateEvent);
        ...
        $this->_mockEventDispatcher->shouldReceive('dispatch')->once()->with(tubepress_core_html_search_api_Constants::EVENT_HTML_SEARCH_INPUT, $mockHtmlEvent);
