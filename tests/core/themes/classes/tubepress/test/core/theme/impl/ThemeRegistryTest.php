...
class tubepress_test_core_theme_impl_ThemeRegistryTest extends tubepress_test_TubePressUnitTest
{
    ...
    private function _setupSystemThemeMocks()
    {
        ...
        $mockSystemThemeSplFileInfo->shouldReceive('getPathname')->twice()->andReturn(TUBEPRESS_ROOT . '/src/core/themes/web/default/theme.json');
        ...
        $mockSystemFinder->shouldReceive('in')->once()->with(TUBEPRESS_ROOT . '/src/core/themes/web')->andReturn($mockSystemFinder);
    ...
    private function _setupUserThemeMocks()
    {
        ...
        $fs->copy(TUBEPRESS_ROOT . '/src/core/themes/web/youtube.com-clone/theme.json', $this->_mockUserThemeDirectory . '/themes/something/theme.json');
