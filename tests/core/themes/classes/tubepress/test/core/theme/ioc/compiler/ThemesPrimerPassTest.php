...
/**
 * @covers tubepress_core_theme_ioc_compiler_ThemesPrimerPass<extended>
 */
class tubepress_test_core_theme_ioc_compiler_ThemesPrimerPassTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_theme_ioc_compiler_ThemesPrimerPass
     */
    private $_sut;
    ...
    {
        $this->_sut                  = new tubepress_core_theme_ioc_compiler_ThemesPrimerPass();
    ...
    public function testProcess()
    {
        ...
        $this->_mockContainerBuilder->shouldReceive('get')->once()->with('tubepress_impl_log_BootLogger')->andReturn($mockLogger);
        $this->_mockContainerBuilder->shouldReceive('findTaggedServiceIds')->once()->with(tubepress_api_contrib_RegistryInterface::_)->andReturn(array(
            'x' => array(array('type' => tubepress_core_theme_api_ThemeInterface::_))
        ));
