...
class tubepress_test_youtube_impl_listeners_video_YouTubeVideoConstructionListenerTest extends tubepress_test_TubePressUnitTest
{
    ...
    {
        return file_get_contents(TUBEPRESS_ROOT . '/tests/core/youtube/resources/youtube/youtube-single-video.xml');
    }

    public function galleryXml()
    {
        return file_get_contents(TUBEPRESS_ROOT . '/tests/core/youtube/resources/youtube/youtube-gallery.xml');
    }
