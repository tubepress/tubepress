...
/**
 * @covers tubepress_core_event_impl_tickertape_EventDispatcher
 */
class tubepress_test_core_event_impl_tickertape_EventDispatcherTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_event_impl_tickertape_EventDispatcher
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_core_event_impl_tickertape_EventDispatcher($this->_mockDispatcher);
    }
    ...
    public function testDispatchNonTickertapeEvent()
    {
        ...
        $this->_mockDispatcher->shouldReceive('dispatch')->once()->with('some event', ehough_mockery_Mockery::on(function ($event) {
            ...
            return $event instanceof tubepress_core_event_impl_tickertape_TickertapeEventWrapper;
    ...
    {
        $event = new tubepress_core_event_impl_tickertape_EventBase();

        $this->_mockDispatcher->shouldReceive('dispatch')->once()->with('some event', ehough_mockery_Mockery::on(function ($event) {

            return $event instanceof tubepress_core_event_impl_tickertape_EventBase;
        }))->andReturn(array('x'));
    ...
    public function testNewEventInstance()
    {
        ...
        $this->assertInstanceOf('tubepress_core_event_impl_tickertape_EventBase', $result);
