...
/**
 * @covers tubepress_core_util_impl_UrlUtils
 */
class tubepress_test_core_util_impl_UrlUtilsTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_util_impl_UrlUtils
     */
    private $_sut;

    public function onSetup()
    {
        $this->_sut = new tubepress_core_util_impl_UrlUtils();
    }
    
    public function testStripAuthorityAndScheme()
    {
        $url    = $this->mock('tubepress_core_url_api_UrlInterface');
