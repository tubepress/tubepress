...
/**
 * @covers tubepress_core_html_impl_HtmlGenerator
 */
class tubepress_test_core_html_impl_HtmlGeneratorTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_html_impl_HtmlGenerator
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_mockThemeHandlerInterface       = $this->mock(tubepress_core_theme_api_ThemeLibraryInterface::_);
        $this->_mockShortcodeParser             = $this->mock(tubepress_core_shortcode_api_ParserInterface::_);

        $this->_sut = new tubepress_core_html_impl_HtmlGenerator(
    ...
    public function testCssHtml()
    {
        ...
        $mockPreStylesheetsEvent = $this->mock('tubepress_core_event_api_EventInterface');
        ...
        $this->_mockEventDispatcher->shouldReceive('dispatch')->once()->with(tubepress_core_html_api_Constants::EVENT_STYLESHEETS_PRE, $mockPreStylesheetsEvent);

        $mockStylesUrlsEvent = $this->mock('tubepress_core_event_api_EventInterface');
        ...
        $this->_mockEventDispatcher->shouldReceive('dispatch')->once()->with(tubepress_core_html_api_Constants::EVENT_STYLESHEETS, $mockStylesUrlsEvent);

        $mockPostStylesheetsEvent = $this->mock('tubepress_core_event_api_EventInterface');
...
")->andReturn($mockPostStylesheetsEvent);
        $this->_mockEventDispatcher->shouldReceive('dispatch')->once()->with(tubepress_core_html_api_Constants::EVENT_STYLESHEETS_POST, $mockPostStylesheetsEvent);
    ...
    public function testJsHtml()
    {
        ...
        $mockPreScriptsheetsEvent = $this->mock('tubepress_core_event_api_EventInterface');
        ...
        $this->_mockEventDispatcher->shouldReceive('dispatch')->once()->with(tubepress_core_html_api_Constants::EVENT_SCRIPTS_PRE, $mockPreScriptsheetsEvent);

        $mockScriptsUrlsEvent = $this->mock('tubepress_core_event_api_EventInterface');
        ...
        $this->_mockEventDispatcher->shouldReceive('dispatch')->once()->with(tubepress_core_html_api_Constants::EVENT_SCRIPTS, $mockScriptsUrlsEvent);

        $mockPostScriptsheetsEvent = $this->mock('tubepress_core_event_api_EventInterface');
...
")->andReturn($mockPostScriptsheetsEvent);
        $this->_mockEventDispatcher->shouldReceive('dispatch')->once()->with(tubepress_core_html_api_Constants::EVENT_SCRIPTS_POST, $mockPostScriptsheetsEvent);
    ...
    public function testOneHandlerCouldHandle()
    {
        ...
        $this->_mockEventDispatcher->shouldReceive('dispatch')->once()->with(tubepress_core_html_api_Constants::EVENT_PRIMARY_HTML, $mockEvent);
    ...
    {
        $mockPrimaryEvent = $this->mock('tubepress_core_event_api_EventInterface');
        ...
        $this->_mockEventDispatcher->shouldReceive('dispatch')->once()->with(tubepress_core_html_api_Constants::EVENT_PRIMARY_HTML, $mockPrimaryEvent);

        $mockErrorEvent = $this->mock('tubepress_core_event_api_EventInterface');
        ...
        $this->_mockEventDispatcher->shouldReceive('dispatch')->once()->with(tubepress_core_html_api_Constants::EVENT_EXCEPTION_CAUGHT, $mockErrorEvent);
