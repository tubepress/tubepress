...
/**
 * @covers tubepress_core_media_provider_impl_listeners_page_Blacklister
 */
class tubepress_test_core_media_provider_impl_listeners_page_VideoBlacklistTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_media_provider_impl_listeners_page_Blacklister
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_sut = new tubepress_core_media_provider_impl_listeners_page_Blacklister($this->_mockLogger, $this->_mockExecutionContext);
    }
