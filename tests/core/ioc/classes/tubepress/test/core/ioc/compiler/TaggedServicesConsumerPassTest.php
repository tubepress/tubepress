...
/**
 * @covers tubepress_core_ioc_compiler_TaggedServicesConsumerPass<extended>
 */
class tubepress_test_core_impl_ioc_compiler_TaggedServicesConsumerPassTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_ioc_compiler_TaggedServicesConsumerPass
     */
    private $_sut;
    ...
    {
        $this->_sut           = new tubepress_core_ioc_compiler_TaggedServicesConsumerPass();
    ...
    public function testProcessMultiple()
    {
        ...
        $this->_mockContainer->shouldReceive('findTaggedServiceIds')->once()->with(tubepress_core_ioc_api_Constants::TAG_TAGGED_SERVICES_CONSUMER)
