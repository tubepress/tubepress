...
class tubepress_test_core_shortcode_impl_ParserTest extends tubepress_test_TubePressUnitTest
{
    ...
    public function testMixedCommasWithAllSortsOfQuotes()
    {
        ...
        $expected = array(
            ...
            tubepress_core_media_provider_api_Constants::OPTION_RESULT_COUNT_CAP                => 200,
    ...
    public function testNoCommasWithAllSortsOfQuotes()
    {
        ...
        $expected = array(tubepress_core_media_provider_api_Constants::OPTION_GALLERY_SOURCE => tubepress_youtube_api_Constants::GALLERYSOURCE_YOUTUBE_PLAYLIST,
            tubepress_youtube_api_Constants::OPTION_YOUTUBE_PLAYLIST_VALUE => 'foobar',
            tubepress_core_media_item_api_Constants::OPTION_AUTHOR => 'true',
            tubepress_core_media_provider_api_Constants::OPTION_RESULT_COUNT_CAP => 200,
            tubepress_core_media_provider_api_Constants::OPTION_RESULTS_PER_PAGE => 3
        );
