...
/**
 * @covers tubepress_core_options_impl_Persistence<extended>
 */
class tubepress_test_core_options_impl_PersistenceTest extends tubepress_test_core_options_impl_internal_AbstractOptionReaderTest
{
    /**
     * @var tubepress_core_options_impl_Persistence
     */
    private $_sut;
    ...
    public function doSetup()
    {
        ...
        $this->_mockBackend         = $this->mock(tubepress_core_options_api_PersistenceBackendInterface::_);

        $this->_sut = new tubepress_core_options_impl_Persistence(
