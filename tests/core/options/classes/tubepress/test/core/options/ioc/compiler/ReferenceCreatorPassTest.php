...
/**
 * @covers tubepress_core_options_ioc_compiler_ReferenceCreatorPass<extended>
 */
class tubepress_test_core_options_ioc_compiler_ReferenceCreatorPassTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_options_ioc_compiler_ReferenceCreatorPass
     */
    private $_sut;
    ...
    {
        $this->_sut           = new tubepress_core_options_ioc_compiler_ReferenceCreatorPass();
    ...
    public function testCreate()
    {
        ...
        $mockReference1 = $this->mock(tubepress_core_options_api_ReferenceInterface::_);
        ...
        $mockReference2 = $this->mock(tubepress_core_options_api_ReferenceInterface::_);
        ...
        $mockDefinition->shouldReceive('addArgument')->once()->with(ehough_mockery_Mockery::on(function ($arg) {
            ...
            return $arg instanceof tubepress_api_ioc_Reference && "$arg" === strtolower(tubepress_core_event_api_EventDispatcherInterface::_);
        }))->andReturn($mockDefinition);

        $this->_mockContainer->shouldReceive('findTaggedServiceIds')->once()->with(tubepress_core_options_api_ReferenceInterface::_)->andReturn($services);
