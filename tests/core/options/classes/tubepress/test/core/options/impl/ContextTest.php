...
/**
 * @covers tubepress_core_options_impl_Context<extended>
 */
class tubepress_test_core_options_impl_ContextTest extends tubepress_test_core_options_impl_internal_AbstractOptionReaderTest
{
    /**
