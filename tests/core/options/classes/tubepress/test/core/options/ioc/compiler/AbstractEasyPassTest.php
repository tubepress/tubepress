...
abstract class tubepress_test_core_options_ioc_compiler_AbstractEasyPassTest extends tubepress_test_TubePressUnitTest
{
    /**
     * @var tubepress_core_options_ioc_compiler_AbstractEasyPass
     */
    private $_sut;
    ...
    public function onSetup()
    {
        ...
        $this->_mockLogger      = $this->mock('tubepress_impl_log_BootLogger');

        $this->_mockContainer->shouldReceive('get')->once()->with(tubepress_api_util_StringUtilsInterface::_)->andReturn($this->_mockStringUtils);
        $this->_mockContainer->shouldReceive('get')->once()->with(tubepress_api_util_LangUtilsInterface::_)->andReturn($this->_mockLangUtils);
        $this->_mockContainer->shouldReceive('get')->once()->with('tubepress_impl_log_BootLogger')->andReturn($this->_mockLogger);
