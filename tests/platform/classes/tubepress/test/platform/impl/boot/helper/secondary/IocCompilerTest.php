...
class tubepress_test_impl_boot_helper_secondary_IocCompilerTest extends tubepress_test_TubePressUnitTest
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        require_once TUBEPRESS_ROOT . '/tests/platform/fixtures/classes/tubepress/test/impl/ioc/FakeCompilerPass.php';
        require_once TUBEPRESS_ROOT . '/tests/platform/fixtures/classes/tubepress/test/impl/ioc/FakeExtension.php';
    }
