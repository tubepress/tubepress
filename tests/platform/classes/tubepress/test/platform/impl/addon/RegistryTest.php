...
class tubepress_test_impl_addon_RegistryTest extends tubepress_test_TubePressUnitTest
{
    ...
    public function onSetup()
    {
        ...
        $this->_fakeAddonRoot           = realpath(TUBEPRESS_ROOT . '/tests/platform/fixtures/classes/tubepress/test/impl/addon/registrytests');
    ...
    public function testBadManifest()
    {
        ...
        $this->_mockLogger->shouldReceive('error')->once()->with(sprintf('Decoded manifest at %s/tests/platform/fixtures/classes/tubepress/test/impl/addon/registrytests/bad_manifestsyntax/b.json? no', TUBEPRESS_ROOT));
    ...
    {
        $this->_mockBootSettings->shouldReceive('getAddonBlacklistArray')->twice()->andReturn(array());
        $this->_mockLogger->shouldReceive('error')->once()->with(sprintf('Decoded manifest at %s/tests/platform/fixtures/classes/tubepress/test/impl/addon/registrytests/bad_name/b.json? no', TUBEPRESS_ROOT));
